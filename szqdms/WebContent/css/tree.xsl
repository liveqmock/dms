...
<xsl:template match="R">
	...
	<div><xsl:attribute name="id">p<xsl:value-of select="@c"/></xsl:attribute>
		...
		<xsl:if test="$HasImage='false'">
			<xsl:choose>
				<xsl:when test="$leaf='1'"><img align="absbottom" type="tree" src="/szqdms/images/trees/file.gif"/></xsl:when>
				<xsl:otherwise>
					<xsl:choose>
					<xsl:when test="$exp='1'">
						<img align="absbottom" type="tree" src="/szqdms/images/trees/foldericon.gif" onClick='g_xDic.imgClick(this);'/>
					</xsl:when>
					<xsl:when test="$exp='2'">
						<img align="absbottom" type="tree" src="/szqdms/images/trees/openfoldericon.gif" onClick='g_xDic.imgClick(this);'/>
					</xsl:when>
					<xsl:when test="$exp='3'">
						<img align="absbottom" type="tree" src="/szqdms/images/trees/openfoldericon.gif" onClick='g_xDic.imgClick(this);'/>
					</xsl:when>
		...
		<xsl:choose>
			<xsl:when test="$exp='1'">
				<img align="middle" type="tree" src="/szqdms/images/trees/buzhong.gif" style="margin:0 5 0 5;" onClick='g_xDic.checkClick(this);'/>
			</xsl:when>
			<xsl:when test="$exp='2'">
				<img align="middle" type="tree" src="/szqdms/images/trees/jubuzhong.gif" style="margin:0 5 0 5;" onClick='g_xDic.checkClick(this);'/>
			</xsl:when>
			<xsl:when test="$exp='3'">
				<img align="middle" type="tree" src="/szqdms/images/trees/quanzhong.gif" style="margin:0 5 0 5;" onClick='g_xDic.checkClick(this);'/>
			</xsl:when>
			<xsl:otherwise>
				<img align="middle" type="tree" src="/szqdms/images/trees/buzhong.gif" style="margin:0 5 0 5;" onClick='g_xDic.checkClick(this);'/>
			</xsl:otherwise>
