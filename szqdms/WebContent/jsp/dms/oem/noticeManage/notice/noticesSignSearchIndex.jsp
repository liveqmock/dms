...
<title>通知通告签收查询</title>
<script type="text/javascript">
var searchUrl = "<%=request.getContextPath()%>/service/noticeManage/NoticeManageAction/noticeSignedSearch.ajax";
//查询按钮响应方法
$(function(){
	//查询方法
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/noticeManage/notice/noticeArchiveEdit.jsp?flag=1"+"&action="+2, "noticeManage", "通知通告归档", options,true);
}
//删除回调方法
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：通知通告管理&gt;通知通告管理&gt;通告签收情况查询</h4>
		<div class="page">
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="noticeManageTable">
						...
						<tr>
							...
							<td><input type="text" id="orgCode" name="orgCode" datasource="TG.CODE" datatype="1,is_null,100" value=""  operation="like" /></td>
						</tr>
					</table>
					<div class="subBar">
						<ul>
			...
			<table style="display:none;width:100%;" layoutH="250" id="noticeManagelb" name="noticeManage" ref="noticeManage" refQuery="noticeManageTable" >
					<thead>
						<tr>
							...
							<th fieldname="SIGN_DATE" >通告签收时间</th>
							<th fieldname="PERSON_NAME" >通告签收人</th>
