...
var searchUrl = "<%=request.getContextPath()%>/service/noticeManage/NoticeManageAction/noticeArchiveSearch.ajax";
//查询按钮响应方法
$(function(){
	//查询方法
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：通知通告管理&gt;通知通告管理&gt;通告归档</h4>
		<div class="page">
			...
			<table style="display:none;width:100%;" layoutH="250" id="noticeManagelb" name="noticeManage" ref="noticeManage" refQuery="noticeManageTable" >
					<thead>
						<tr>
							...
							<th type="link"  title="[归档]" action="doUpdate">操作</th>
							...
							<th fieldname="SEND_DATE" >发布时间</th>
