...
<title>售前检修与培训单车费用维护</title>
<script type="text/javascript">
//查询按钮响应方法
$(function(){
	$("#search").click(function(){
		if($("#sqjxfylb").is(":hidden")){
			$("#sqjxfylb").show();
			$("#sqjxfylb").jTable();
		}
	});
...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jcsjgl/ywcsgl/sqjxfyxg.jsp", "sqjxfyxg", "售前检修费用编辑", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：基础数据管理&gt;业务参数管理&gt;售前检修费用维护</h4>
		<div class="page">
		<div class="pageHeader">
			<form id="sqjxfywhform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="sqjxfywhTable">
						<tr>
		...
		<div class="pageContent">
			<div id="sqjxfy">
				<table width="100%" id="sqjxfylb" name="sqjxfylb" style="display: none" >
					<thead>
						<tr>
