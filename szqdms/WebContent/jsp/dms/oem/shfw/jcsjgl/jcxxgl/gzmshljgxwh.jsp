...
function doUpdate(){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jcsjgl/jcxxgl/gzmshpjgx.jsp", "gzmshpjgx", "故障模式和零件关系维护", options,true);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：基础数据管理&gt;基础信息管理&gt;故障模式和零件关系维护</h4>
	<div class="page">
