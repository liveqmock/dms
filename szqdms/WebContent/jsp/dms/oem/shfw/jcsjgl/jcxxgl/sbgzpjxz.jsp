...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="di_sbgzpj" style="width:100%;">
	<div class="page">
	<div class="pageHeader">
		<form id="di_sbgzpjxz" method="post">
			<div class="searchBar" align="left">
				<table class="searchContent" id="di_sbgzpjTable">
					<tr>
	...
	<div class="pageContent">
		<div id="di_sbgzpj">
			<table width="100%" id="di_sbgzpjlb" name="di_sbgzpjlb" style="display: none" >
				<thead>
					<tr>
...
//弹出窗体
var dialog = $("body").data("sbgzpj");
$(function()
{
	$("#di_searchPart").click(function(){
		if($("#di_sbgzpjlb").is(":hidden")){
			$("#di_sbgzpjlb").show();
			$("#di_sbgzpjlb").jTable();
		}
		$("#opBtnPart").show();
