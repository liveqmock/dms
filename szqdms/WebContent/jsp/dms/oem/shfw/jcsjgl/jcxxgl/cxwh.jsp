...
function doAdd(){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jcsjgl/jcxxgl/cxxxxz.jsp?action=1", "cxxx", "车型信息新增", options);
}
function doUpdate(rowobj){
	$("td input:first",$(rowobj)).attr("checked",true);
	var options = {max:false,width:450,height:220,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jcsjgl/jcxxgl/cxxxxz.jsp?action=2", "cxxx", "车型信息编辑", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="cxwhform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="cxwhTable">
						<tr>
		...
		<div class="pageContent">
			<div id="cx">
				<table width="100%" id="cxlb" name="cxlb" style="display: none" >
					<thead>
						<tr>
