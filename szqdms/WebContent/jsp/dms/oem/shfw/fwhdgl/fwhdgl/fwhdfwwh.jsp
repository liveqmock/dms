...
<title>服务活动范围维护</title>
<script type="text/javascript">
//查询按钮响应方法
$(function(){
	$("#search").click(function(){
		if($("#fwhdfwlb").is(":hidden")){
			$("#fwhdfwlb").show();
			$("#fwhdfwlb").jTable();
		}
	});
...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/fwhdgl/fwhdgl/fwhdfwxg.jsp", "fwhdwfxg", "服务活动修改", options,true);
}
function doDetail(){
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：服务活动管理&gt;服务活动管理&gt;服务活动范围维护</h4>
		<div class="page">
		<div class="pageHeader">
			<form id="fwhdfwform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="fwhdfwTable">
						<tr>
		...
		<div class="pageContent">
			<div id="fwhdfw">
				<table width="100%" id="fwhdfwlb" name="fwhdfwlb" style="display: none" >
					<thead>
						<tr>
