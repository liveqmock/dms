...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="di_fwhdpj" style="width:100%;">
	<div class="page">
	<div class="pageHeader">
		<form id="di-fwhdpj" method="post">
			<div class="searchBar" align="left">
				<table class="searchContent" id="di_fwhdpjTable">
					<tr>
	...
	<div class="pageContent">
		<div id="di_fwhdpj">
			<table width="100%" id="di_fwhdpjlb" name="di_fwhdpjlb" style="display: none" >
				<thead>
					<tr>
...
//弹出窗体
var dialog = $("body").data("fwhdpj");
$(function()
{
	$("#di_searchPart").click(function(){
		if($("#di_fwhdpjlb").is(":hidden")){
			$("#di_fwhdpjlb").show();
			$("#di_fwhdpjlb").jTable();	
		}
		$("#opBtnPart").show();
