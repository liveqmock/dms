...
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="spjsform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="spjsTable">
						<tr>
				...
				<table width="100%" id="jsdlb" name="jsdlb" style="display: none" >
					<thead>
						<tr>
							...
							<th colwidth="85" type="link"  title="[结算]" action="doUpdate">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td>0</td>
							<td>400</td>
							<td><a href="#" onclick="doUpdate()" class="op">[结算]</a></td>
						</tr>
						<tr>
							<td>2</td>
							<td>服务商代码1</td>
