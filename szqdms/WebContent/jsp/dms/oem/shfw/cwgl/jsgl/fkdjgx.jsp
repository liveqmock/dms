...
function doUpdate(){
	var options = {max:false,width:760,height:300,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/cwgl/jsgl/fkdjmx.jsp", "fkdjmx", "付款单据更新", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="fkdjform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="fkdjTable">
						<tr>
				...
				<table width="100%" id="jsdlb" name="jsdlb" style="display: none" >
					<thead>
						<tr>
							...
							<th align="right">索赔总金额(元)</th>
							<th colwidth="85" type="link"  title="[结果更新]" action="doUpdate">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td>0</td>
							<td>400</td>
							<td><a href="#" onclick="doUpdate()" class="op">[结果更新]</a></td>
						</tr>
						<tr>
							<td>2</td>
							<td>服务商代码1</td>
