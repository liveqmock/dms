...
function doUpdate(){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jjgl/jjgl/jjshmx.jsp", "jjshmx", "旧件审核", options,true);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="jjzsform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="jjzsTable">
						<tr>
						    <td><label>服务商代码：</label></td>
							<td><input type="text" id="FWSDM" name="FWSDM" datatype="1,is_null,100" value=""/></td>
							<td><label>服务商名称：</label></td>
							<td><input type="text" id="FWSMC" name="FWSMC" datatype="1,is_null,100" value="" /></td>
					 	</tr>
						<tr>
		...
		<div class="pageContent">
			<div id="jjzs">
				<table width="100%" id="jjzslb" name="jjzslb" style="display: none" >
					<thead>
						<tr>
