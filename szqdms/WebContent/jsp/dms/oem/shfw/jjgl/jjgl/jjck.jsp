...
function doUpdate(rowobj){
	...
	var options = {max:false,width:710,height:260,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps+"/jsp/dms/oem/shfw/jjgl/jjgl/jjckmx.jsp", "jjkcmx", "旧件出库", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="jjckform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="jjckTable">
						<tr>
				...
				<table width="100%" id="jjcklb" name="jjcklb" style="display: none" >
					<thead>
						<tr>
							...
							<th>配件名称</th>
							<th>库存数量</th>
							<th colwidth="85" type="link" title="[出库]"  action="doUpdate">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td>配件名称1</td>
							<td>7</td>
							<td ><a href="#" onclick="doUpdate()" class="op">[出库]</a></td>
						</tr>
						<tr>
							<td>2</td>
							<td>供应商代码2</td>
