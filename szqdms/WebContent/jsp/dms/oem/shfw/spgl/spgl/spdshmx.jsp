					...
					<div class="pageContent">
						<form method="post" id="dia-fm-wxdawh" class="editForm" style="width: 99%;">
							...
							<tr>
							    ...
							    <td ><input type="text" id="dia-in-dzzfy" value="3000" readonly="readonly"/></td>
							    <td><label>材料费(汇总)：</label></td>
							    <td ><input type="text" id="dia-in-cly" value="1000" readonly="readonly"/></td>
							    <td><label>非材料费(汇总)：</label></td>
							    <td ><input type="text" id="dia-in-fclif" value="1000" readonly="readonly"/></td>
							</tr>	
							<tr>
								<td><label>外出总费：</label></td>
							    <td ><input type="text" id="dia-in-wczfy" value="1000" readonly="readonly"/></td>
							    <td><label>一次外出费：</label></td>
							    <td ><input type="text" id="dia-in-ycfy" value="600" readonly="readonly"/></td>
							    <td><label>二次外出费：</label></td>
							    <td ><input type="text" id="dia-in-ecfy" value="400" readonly="readonly"/></td>
							</tr>	
							<tr>
							    <td><label>在途餐补：</label></td>
							    <td><input type="text" id="dia-in-ztcb"  name="dia-in-ztcb"  value="300" readonly="readonly"/></td>
								<td><label>服务车费：</label></td>
							    <td><input type="text" id="dia-in-fwcf"  name="dia-in-fwcf" value="300" readonly="readonly"/></td>
							    <td><label>车船费：</label></td>
							    <td><input type="text" id="dia-in-ccf"  name="dia-in-ccf"   value="0" readonly="readonly"/></td>
							</tr>
							<tr>
							    <td><label>差旅费：</label></td>
								<td><input type="text" id="dia-in-clf"  name="dia-in-clf"  value="0" readonly="readonly"/></td>
								<td ><label>其他费：</label></td>
								<td ><input type="text" id="dia-in-qtf"  name="dia-in-qtf"   value="0" readonly="readonly" /></td>
							    <td><label>服务车费(二次)：</label></td>
							    <td><input type="text" id="dia-in-ecfwcf"  name="dia-in-ecfwcf" value="400" readonly="readonly"/></td>
							</tr> 
							<tr>
							    <td><label>其他费（二次）：</label></td>
								<td colspan="5"><input type="text" id="dia-in-ecqtf"  name="dia-in-ecqtf"  value="0" readonly="readonly"/></td>
							</tr>
							<tr>
							    <td><label>工时费（汇总）：</label></td>
								<td ><input type="text" id="dia-in-gsf"  name="dia-in-gsf"  value="1000" readonly="readonly"/></td>
								<td><label>首保费：</label></td>
								<td ><input type="text" id="dia-in-sbfy"  name="dia-in-sbf"  value="0" readonly="readonly"/></td>
								<td><label>服务活动费：</label></td>
								<td ><input type="text" id="dia-in-fwhdfy"  name="dia-in-fwhdfy"  value="0" readonly="readonly"/></td>
							</tr> 
							<tr>
							    <td><label>安全检查费：</label></td>
								<td ><input type="text" id="dia-in-gsf"  name="dia-in-aujcf"  value="0" readonly="readonly"/></td>
								<td><label>售前培训费：</label></td>
								<td colspan="3"><input type="text" id="dia-in-sqpxfy"  name="dia-in-sqpxfy"  value="0" readonly="readonly"/></td>
							</tr>       							
							</table>
					        </div>
					        <div align="left">
						...
						<div class="formBar">
							<ul>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-save"  onclick="doCheck('审核通过');">审核通过</button></div></div></li>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-bohui" onclick="doCheck('审核驳回');">审核驳回</button></div></div></li>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-jujue" onclick="doCheck('审核拒绝');">审核拒绝</button></div></div></li>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-zldsh" onclick="doCheck('转领导审批');">转领导审批</button></div></div></li>
			...
			<div class="page" id="dia-div-wcxxlb" style="overflow:auto;">
				<div class="pageContent">
					 ...
					 <div class="tabsContent" >
						...
						<div class="formBar">
							<ul>
							    <li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-save"  onclick="doCheck('弹出查询GPS信息页面');">查询GPS信息</button></div></div></li>
