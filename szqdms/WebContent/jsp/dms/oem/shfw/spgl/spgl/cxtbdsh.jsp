...
function doDetail(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/shfw/spgl/spgl/cxtbshmx.jsp", "cxtbshmx", "重新提报单审核明细", options,true);
}
function selectDealer()
{
	alertMsg.info("选择服务站树");
	return true;
}
</script>
</head>
			...
			<table style="display:none;width:100%;" id="tab-spdlb" name="tablist" ref="page_spdlb" refQuery="fm-sbdcx" >
					<thead>
						<tr>
							...
							<th fieldname="DEALER_CODE"  colwidth="80">服务站代码</th>
							<th fieldname="DEALER_NAME"  colwidth="80">服务站名称</th>
							<th fieldname="DISPATCH_NO"  colwidth="60">派工单号</th>
							<th fieldname="CLAIM_NO"  colwidth="60">索赔单号</th>
							<th fieldname="CLAIM_STATUS"  colwidth="60">索赔单状态</th>
							<th fieldname="REPORT_DATE"  colwidth="80">提报时间</th>
							<th fieldname=""  colwidth="40">申请原因</th>
							<th colwidth="60" type="link" title="[审批]"  action="doDetail" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>因.....</div></td>
							<td><a href="#" onclick="doDetail()" class="op">[审批]</a></td>
						</tr>
						<tr>
