...
function doDetail(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/shfw/spgl/spgl/spdbhmx.jsp", "spdbhmx", "索赔单驳回明细", options,true);
}
			...
			<table style="display:none;width:100%;" id="tab-spdlb" name="tablist" ref="page_spdlb" refQuery="fm-sbdcx" >
					<thead>
						<tr>
							...
							<th colwidth="105" type="link" title="[驳回]"  action="doDetail" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><a href="#" onclick="doDetail()" class="op">[驳回]</a></td>
						</tr>
						<tr>
