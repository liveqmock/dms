...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/shfw/spgl/ysqgl/ysqshmx.jsp", "ysqxx", "预授权信息审核", options,true);
}
</script>
</head>
<body>
			...
			<table style="display:none;width:100%;" id="tab-ysqlb" name="tablist" ref="page_ysqlb" refQuery="fm-ysqcx" >
					<thead>
						<tr>
							...
							<th fieldname="VIN" colwidth="60">VIN</th>
							<th fieldname="" colwidth="60">发动机号</th>
							<th fieldname="" colwidth="60">车辆型号</th>
							<th fieldname="" colwidth="40">车牌号</th>
							<th fieldname="" colwidth="80">销售日期</th>
							<th fieldname="" colwidth="80">提报日期</th>
							<th colwidth="60" type="link" title="[审核]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
