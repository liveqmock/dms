...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/ArmyPartOrderReportAction/searchImportPart.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/ArmyPartOrderReportAction/insertImportPart.ajax?tmpNo="+rowStrNo+"&flag="+<%=flag%>;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/salesMng/orderMng/ArmyPartOrderReportAction/expData.do?seqs="+rowStrNo);
