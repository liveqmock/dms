...
<div id="dia-layout">
    ...
    <div class="pageContent">
        ...
        <div id="page_edit">
            <table style="display:none;width:99%;" id="dia-tab-edit" name="tablist" ref="page_edit" refQuery="diaPartListTab">
                <thead>
                    <tr>
...
<script type="text/javascript">
    var checkCount = 0;
    var doCheckPassUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportMngAction";
    $(function(){
...
//                         alertMsg.warn("审核数量不能大于可用库存.");
        ...
        $("#dia-doCheckReturn").click(function(){
            ...
            var doCheckReturnUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportMngAction/partOrderCheckApproveBack.ajax";
            var $f = $("#dia-fm-edit");
            var sCondition = {};
