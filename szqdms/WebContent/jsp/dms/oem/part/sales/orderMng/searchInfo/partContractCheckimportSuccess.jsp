...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/salesMng/search/ContractPartCheckMngAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/salesMng/search/ContractPartCheckMngAction/purchaseOrderPartImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/salesMng/search/ContractPartCheckMngAction/expData.do?seqs="+rowStrNo);
