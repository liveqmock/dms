...
<script type="text/javascript">
    ...
    function searchDirectBusinessOrder() {
        var url = "<%=request.getContextPath()%>/part/salesMng/orderMng/DirectBusinessOrderMngAction/searchDirectBusinessOrder.ajax?flag=true";
        var $f = $("#fm-index");
        var sCondition = {};
    ...
    function doUpdate(row) {
        ...
        $.pdialog.open(webApps + "/jsp/dms/oem/part/sales/orderMng/directBusinessOrderCheckEdit.jsp", "directBusinessOrderCheckEdit", "直营订单审核明细", options);
    }
</script>
</head>
<body>
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 销售管理  &gt; 订单管理   &gt; 直营订单审核</h4>
    <div class="page" >
            ...
            <div class="searchBar" align="left" >
                <table class="searchContent" id="tab-ddcx">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="orgCode" name="orgCode" datasource="ORG_ID" datatype="1,is_null,10000" readOnly hasBtn="true" callFunction="showOrgTree('orgCode',1,1)" operation="IN"/></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select type="text" id="delayCount" name="delayCount" kind="dic" src="SF" datasource="IF_DELAY_ORDER" filtercode="" datatype="1,is_null,30" operation="=">
                                <option value="-1" selected>--</option>
                            </select>
                        </td>
                        <td><label>延期次数：</label></td>
                        <td><input type="text" id="delayCount" name="delayCount" datasource="SUBSTR(ORDER_NO, -1)" datatype="1,is_digit_letter,30" operation="like" /></td>
                    </tr>
                </table>
                <div class="subBar">
                    <ul>
