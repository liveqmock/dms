...
<script type="text/javascript">
    var partSearchUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportCCMngAction/searchPart.ajax";
    // 弹出窗体
    ...
    $(function() {
        ...
        $('#btn-confirmPart').bind('click',function(){
            // 添加预测配件明细URL
            var insertPromPartUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportCCMngAction/insertSaleOrderDetail.ajax";
            ...
            if (!partIds) {
            	...
            	if (planPriceCheck.length>0) {
            		var errorMsg = "请联系管理员维护配件计划价:"+planPriceCheck;
