...
<script type="text/javascript">
    ...
    function searchDirectBusinessOrder() {
        var url = "<%=request.getContextPath()%>/part/salesMng/orderMng/claimCyclOrderReportMngAction/searchClaimCyclOrder.ajax?flag=true";
        var $f = $("#fm-index");
        var sCondition = {};
    ...
    function doUpdate(row) {
        ...
        $.pdialog.open(webApps + "/jsp/dms/oem/part/sales/orderMng/claimCyclOrderCheckEdit.jsp", "directBusinessOrderCheckEdit", "三包订单审核明细", options);
    }
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 销售管理  &gt; 订单管理   &gt; 三包订单审核</h4>
    <div class="page" >
            ...
            <div class="searchBar" align="left" >
                <table class="searchContent" id="tab-ddcx">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="sbVin" name="sbVin" datasource="B.SB_VIN" datatype="1,is_digit_letter,30" operation="like" /></td>
                        <td><label>故障日期：</label></td>
                        <td>
                            <input type="text" group="in-kscjrq1,in-jscjrq1"  id="in-kscjrq1"  name="in-kscjrq1" operation=">="  dataSource="B.SB_FAULT_DATE" style="width:75px;"  kind="date" datatype="1,is_date,30" onclick="WdatePicker()" />
                            <span style="float:left;margin-left:-50px;margin-top:5px;">至</span>
                            <input type="text" group="in-kscjrq1,in-jscjrq1"  id="in-jscjrq1"  name="in-jscjrq1" operation="<=" dataSource="B.SB_FAULT_DATE" style="width:75px;margin-left:-30px;" kind="date" datatype="1,is_date,30" onclick="WdatePicker()" />
                        </td>
                    </tr>
                </table>
                <div class="subBar">
            ...
            <table style="display:none;width:100%;" id="tab-index" name="tablist" ref="page_index" refQuery="fm-pjcx" >
                    <thead>
                        <tr>
                            ...
                            <th fieldname="ORDER_NO" ordertype='local' class="desc" refer=showLink>订单编号</th>
                            <th fieldname="SB_VIN" colwidth="130">VIN</th>
                            ...
                            <th fieldname="ORDER_AMOUNT" refer="formatAmount" align="right">订单总金额(元)</th>
<!--                             <th fieldname="EXPECT_DATE" >期望到货日期</th> -->
                            <th fieldname="SB_FAULT_ANALYSE_NAME">故障分析</th>
                            <th fieldname="SB_FAULT_DATE" colwidth="130">故障日期</th>
                            <th fieldname="APPLY_DATE" colwidth="130">申请日期</th>
