...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#btn-search-index").trigger("click");
    });
    ...
    function searchReturnPurchaseApply() {
        var searchUrl = "<%=request.getContextPath()%>/part/salesMng/returnPurchaseMng/ReturnPurchaseCheckMngAction/searchReturnPurchaseApplyCar.ajax";
        var $f = $("#fm-index");
        var sCondition = {};
    ...
    function doUpdate(row) {
        ...
        $.pdialog.open(webApps + "/jsp/dms/oem/part/sales/returnPurchaseMng/returnPurchaseCheckEdit.jsp", "returnPurchaseCheckEdit", "退件审核明细", options);
    }
</script>
</head>
<body>
            ...
            <div class="searchBar" align="left" >
                <table class="searchContent" id="tab-ddcx">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="applyOrgCode-index" name="applyOrgCode-index" datasource="APPLY_ORG_CODE" datatype="1,is_digit_letter,30" operation="like" /></td>
                        <td><label>渠道名称：</label></td>
                        <td><input type="text" id="applyOrgName-index" name="applyOrgName-index" datasource="APPLY_ORG_NAME" datatype="1,is_null,30" operation="like" /></td>
