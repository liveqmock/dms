                ...
                <table style="display:none;width:100%;" id="tab-fileList" multivals="div-selectedPart" name="tablist" ref="div-partList"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th colwidth="140" type="link" title="[下载]|[删除]"  action="doFjdownLoad|doFjDelete" >操作</th>
                       </tr>
                    </thead>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    var furl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAppendixManageAction";
