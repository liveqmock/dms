	...
	<div class="pageContent" style="" >
		...
		<input type="hidden" id="dia-CONTRACT_ID" name="dia-CONTRACT_ID" datasource="CONTRACT_ID" />
		  <div align="left">
				...
				<form method="post" id="dia-fm-aduit" class="editForm" style="width:99%;">
					  ...
					  <fieldset>
							...
							<div style="text-align:center;">
								<span>审核意见：</span><input type="text" id="CHECK_REMARKS" name="CHECK_REMARKS" datasource="CHECK_REMARKS" datatype="0,is_null,1000" style="height:18px;width:50%;" ></input>
							</div>
					  </fieldset>
					</div>
				</form>	
			<div class="formBar">
				<ul>
					<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="btn-pass" >通&nbsp;&nbsp;过</button></div></div></li>
					<li ><div class="buttonActive"><div class="buttonContent"><button type="button" id="btn-rejected">驳&nbsp;&nbsp;回</button></div></div></li>
...
$(function(){
	...
	$("#btn-pass").bind("click", function(event){
		...
		var passUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAduitManageAction/contractPass.ajax";
	...
	$("#btn-rejected").bind("click", function(event){
		...
		var sCondition = {};
		sCondition = $("#dia-fm-aduit").combined(1) || {};
		var rejectedUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAduitManageAction/contractRejected.ajax";
