...
var searchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAppendixAduitManageAction/contractSearch.ajax";
var reportUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAppendixAduitManageAction/appendixAduit.ajax";
...
function doAudit(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/purchase/purchaseContract/auditAppendixDetail.jsp?action=2", "dialog-viewAttachment", "合同资料审核", diaAddOptions,true);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购合同管理   &gt; 合同资料审核</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-htcx">
					...
					<tr>
					    ...
					    <td><input type="text" id="CONTRACT_NO" name="CONTRACT_NO" datatype="1,is_digit_letter,300" dataSource="CONTRACT_NO" operation="like" /></td>
			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th colwidth="105" type="link" title="[审核]"  action="doAudit" >操作</th>
						</tr>
					</thead>
			</table>
		</div>
