...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractOperationManageAction/closeContractSearch.ajax";
...
{
	$row = $(rowobj);
	var reportUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractOperationManageAction/contractClose.ajax";
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购合同管理   &gt; 合同关闭</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th colwidth="50" type="link" title="[关闭]"  action="doClose" >操作</th>
						</tr>
					</thead>
			</table>
		</div>
