...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/ContractAduitManageAction/contractSearch.ajax";
...
function doAduit(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/purchase/purchaseContract/contractAduitEdit.jsp?action=2", "合同审核", "合同审核", diaAddOptions);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购合同管理   &gt; 合同审核</h4>
	<div class="page" >
		...
		<form method="post" id="fm-searchContract">
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-htcx">
					<!-- 定义查询条件 -->
					<tr>
						<td><label>厂家编码：</label></td>
					    <td ><input type="text" id="SUPPLIER_CODE" name="SUPPLIER_CODE" datatype="1,is_null,300" dataSource="T.SUPPLIER_CODE" operation="like" /></td>
					    <td><label>厂家名称：</label></td>
					    <td ><input type="text" id="SUPPLIER_NAME" name="SUPPLIER_NAME" datatype="1,is_null,300" dataSource="T.SUPPLIER_NAME" operation="like" /></td>
					    
					</tr>
					<tr>
						<td><label>合同编号：</label></td>
					    <td><input type="text" id="CONTRACT_NO" name="CONTRACT_NO" datatype="1,is_digit_letter,30" dataSource="T.CONTRACT_NO" operation="like" /></td>
						<td><label>创建日期：</label></td>
					    <td >
				    		<input type="text" group="in-kscjrq,in-jscjrq"  id="in-kscjrq"  name="in-kscjrq" operation=">="  dataSource="T.CREATE_TIME" style="width:75px;"  kind="date" datatype="1,is_date,30" onclick="WdatePicker()" />
				    		<span style="float:left;margin-left:-50px;margin-top:5px;">至</span>
							<input type="text" group="in-kscjrq,in-jscjrq"  id="in-jscjrq"  name="in-jscjrq" operation="<=" dataSource="T.CREATE_TIME" style="width:75px;margin-left:-30px;" kind="date" datatype="1,is_date,30" onclick="WdatePicker()" />
				   		 </td>
					</tr>
				</table>
				<div class="subBar">
			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th colwidth="50" type="link" title="[审核]"  action="doAduit" >操作</th>
						</tr>
					</thead>
			</table>
		</div>
