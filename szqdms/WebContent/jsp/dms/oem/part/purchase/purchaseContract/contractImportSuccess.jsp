        ...
        <div class="tabsContent" >
            <div class="page">
                <form id="fm-fileImport" method="post" >
                    <input type="hidden" id="tmpNo" name="tmpNo" datasource="TMP_NO" operation="not in"/>
                </form>
                <form id="exportFm" method="post" >
                    <input type="hidden" id="seqs" name="seqs" datasource="TMP_NO" operation="in"/>
                </form>
                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
                                    ...
                                    <th fieldname="UNIT_PRICE">采购价格</th>
                                    <th fieldname="DELIVER_CYCLE">供货周期</th>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/PurchaseContractManageAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/PurchaseContractManageAction/insertImport.ajax?tmpNo="+rowStrNo;
                sendPost(insertUrl+"&forcastMonth="+<%=bParams%>, "", "", doConfirmCallBack, "true");
            }catch(e){}
        });
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/purchaseMng/purchaseContract/PurchaseContractManageAction/expData.do?seqs="+rowStrNo);
