...
$(function()
{
	...
	$("#btn-add").bind("click", function(event){
		...
		$.pdialog.open(webApps + "/jsp/dms/oem/part/purchase/purchaseOrder/purchaseOrderAdd.jsp?action=1", "addContract", "新增订单", diaAddOptions);
	});
});
function doUpdate(rowobj)
{
	$("td input[type=radio]",$(rowobj)).attr("checked",true);
	$.pdialog.open(webApps+"/jsp/dms/oem/part/purchase/purchaseOrder/purchaseOrderAdd.jsp?action=2", "addContract", "修改订单", diaAddOptions);
}
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-orderSearch">
					...
					<tr>
					    ...
					    <td><select type="text" class="combox" id="PURCHASE_TYPE" name="PURCHASE_TYPE" kind="dic" src="CGDDLX" datasource="PURCHASE_TYPE" filtercode="<%=DicConstant.CGDDLX_01%>|<%=DicConstant.CGDDLX_02%>|<%=DicConstant.CGDDLX_03%>|<%=DicConstant.CGDDLX_06%>|<%=DicConstant.CGDDLX_07%>" datatype="1,is_null,6" readonly="readonly">
			...
			<table style="display:none;width:100%;" id="tab-order_info" name="tablist" ref="page_order" refQuery="fm-searchPchOrder" >
					<thead>
						<tr>
							...
							<th colwidth="140" type="link" title="[提报]|[编辑]"  action="doReport|doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
                    </tbody>
