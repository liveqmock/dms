...
var orgCode = "<%=orgCode%>";
$(function(){
	$("#div-partOrderDetaillist").height(document.documentElement.clientHeight-150);
...
function partOrderDetailSearch(){
    ...
    var sCondition = {};
    sCondition = $f.combined() || {};
    var detailSearchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseOrder/DirectOrderSearchAction/partOrderDetailSearch.ajax?&orderId="+ORDER_ID;  
...
<!--                 <input type="hidden" id="planProduceNos" datasource="PLAN_PRODUCE_NOS"/> -->
            ...
            <div class="formBar" style="width:98%;">
                <ul>
                    ...
                    <li><div class="button" id = "btn-export1"><div class="buttonContent" ><button type="button" id="btn-export" >导&nbsp;&nbsp;出</button></div></div></li>
                </ul>
            </div>
