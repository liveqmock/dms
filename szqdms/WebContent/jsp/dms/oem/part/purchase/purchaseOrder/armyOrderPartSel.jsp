...
<script type="text/javascript">
    ...
    var url = "<%=request.getContextPath()%>/part/purchaseMng/purchaseOrder/ArmyPurchaseOrderMngAction";
    $(function () {
        ...
        $("#btn-searchPart").bind("click", function (event) {
            //查询配件URL
            var searchPartUrl = url+"/searchPart.ajax?PURCHASE_ID="+$("#dia-PURCHASE_ID").val()+"&SUPPLIER_ID="+$("#dia-SUPPLIER_ID").val();
