                ...
                <table style="display:none;width:100%;" id="tab-partList" multivals="div-selectedPart" name="tablist" ref="div-partList"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th fieldname="PCH_CYCLE">供货周期(天)</th>
...
<script type="text/javascript">
    ...
    var url = "<%=request.getContextPath()%>/part/purchaseMng/purchaseOrder/ArmyPurchaseOrderModifyAction";
    $(function () {
        ...
        $("#btn-searchPart").bind("click", function (event) {
            //查询配件URL
            var searchPartUrl = url+"/searchPart.ajax?SPLIT_ID="+$("#dia-SPLIT_ID").val()+"&SUPPLIER_ID="+$("#dia-SUPPLIER_ID").val()+"&DELIVERY_CYCLE="+$("#dia-DELIVERY_CYCLE").val();
            var $f = $("#fm-searchPart");
            var sCondition = {};
    ...
    function doMyInputBlur(obj){
        ...
        $tr.find("td").eq(6).html("<div>"+s+"</div>");
