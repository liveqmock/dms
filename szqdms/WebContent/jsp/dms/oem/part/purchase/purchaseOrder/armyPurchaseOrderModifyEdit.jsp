			  ...
			  <fieldset>
						<table class="editTable" id="dia-tab-order">
							...
							<tr>
							    ...
							    <td>
							    	<input type="text" id="dia-SUPPLIER_NAME" name="dia-SUPPLIER_NAME" datasource="SUPPLIER_NAME" datatype="0,is_null,30" readonly="true"/>
							    </td>
...
/* 取父页面传过的参数确定新增或者修改 */
    ...
    function addParts() {
        ...
        $.pdialog.open(webApps + "/jsp/dms/oem/part/purchase/purchaseOrder/amryOrderModifyPartSel.jsp", "partSelWin", "配件信息查询", options);
    }
    //采购订单配件删除
    var $row;
