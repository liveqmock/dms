			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th colwidth="180" type="link" title="[审核]|[认领人附件信息]|[删除]"  action="doAudit|doDownLoad|dodelete" >操作</th>
							<th fieldname="SQSL" >未审核数量</th>
							<th fieldname="SHSL" >审核数量</th>
