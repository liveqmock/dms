...
/* 取父页面传过的参数确定新增或者修改 */
    ...
    var diaUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseReturn/PurchaseOrderReturnInspectionAction";
    var flag = true;
    $(function () {
        ...
        $("#btn-comfirm").bind("click", function(event){
    		...
    		var reportUrl = diaUrl + "/purchaseOrderReturnInspectConfirm.ajax?RETURN_ID="+RETURN_ID;
