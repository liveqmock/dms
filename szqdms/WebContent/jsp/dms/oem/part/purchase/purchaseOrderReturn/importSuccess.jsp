...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseReturn/PurchaseOrderReturnMngAction/searchImport.ajax?tmpNo="+rowStrNo;
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseReturn/PurchaseOrderReturnMngAction/insertImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/purchaseMng/purchaseReturn/PurchaseOrderReturnMngAction/expData.do?seqs="+rowStrNo);
