...
var mngUrl = "<%=request.getContextPath()%>/part/purchaseMng/purchaseReturn/PurchaseOrderReturnCloseAction";
$(function()
{
...
function doClose(rowobj){
    $row = $(rowobj);
    var  reportUrl= mngUrl + "/purchaseOrderClose.ajax?RETURN_ID="+$(rowobj).attr("RETURN_ID");
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购退货管理   &gt; 采购退货关闭</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-order_info" name="tablist" ref="page_order" refQuery="fm-searchPchOrder" >
					<thead>
						<tr>
							...
							<th fieldname="RETURN_NO" refer="showLink" colwidth="150px">退货单号</th>
							<th fieldname="SUPPLIER_CODE" >供应商代码</th>
							<th fieldname="SUPPLIER_NAME" >供应商名称</th>
							<th fieldname="ORDER_DATE" >制单日期</th>
							<th fieldname="ORDER_USER" >制单人</th>
							<th colwidth="45" type="link" title="[关闭]"  action="doClose" >操作</th>
						</tr>
					</thead>
					<tbody>
                    </tbody>
