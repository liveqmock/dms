...
<script type="text/javascript">
    // URL
    var dtlSearchUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastCarTotalMngAction/searchForecastDetail.ajax";
    // 弹出窗体
    var dialog = $("body").data("totalDetail");
    // 初始化方法
    $(function(){
    	$("#tab-grid-detail").attr("layoutH",document.documentElement.clientHeight-270);
