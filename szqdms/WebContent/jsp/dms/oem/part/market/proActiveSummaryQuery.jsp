...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = mngUrl+"/searchQuery.ajax";
...
function dodetail(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/market/programActiveSummaryCheckAdd.jsp?action=3", "编辑活动总结审核", "编辑活动总结审核", diaAddOptions);
}
