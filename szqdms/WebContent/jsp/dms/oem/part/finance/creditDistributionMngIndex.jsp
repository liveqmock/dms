...
var mngUrl = "<%=request.getContextPath()%>/part/financeMng/creditMng/CreditDistributionMngAction";
$(function()
{
	...
	$("#btn-add").bind("click", function(event){
		$.pdialog.open(webApps+"/jsp/dms/oem/part/finance/creditDistributionEdit.jsp?action=1", "creditWin", "额度分配", diaAddOptions);
	});
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/finance/creditDistributionEdit.jsp?action=2", "额度分配", "额度分配", diaAddOptions);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 财务管理  &gt; 信用账户管理   &gt; 额度分配</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-creditSearch">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="STATUS"  name="STATUS" datasource="T.STATUS" kind="dic" src="YXBS" datatype="1,is_null,30" operation="=">
			...
			<table style="display:none;width:100%;" id="tab-credit_info" name="tablist" ref="page_credit" refQuery="fm-searchCredit" >
					<thead>
						<tr>
							...
							<!-- <th colwidth="45" type="link" title="[分配]"  action="doUpdate" >操作</th> -->
						</tr>
					</thead>
					<tbody>
                    </tbody>
