...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/financeMng/cashAccountMng/CashAccountMngAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/financeMng/cashAccountMng/CashAccountMngAction/insertImport.ajax?tmpNo="+rowStrNo;
                sendPost(insertUrl+"&amountType="+<%=bParams%>, "", "", doConfirmCallBack, "true");
            }catch(e){}
        });
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/financeMng/cashAccountMng/CashAccountMngAction/expData.do?seqs="+rowStrNo);
