...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = mngUrl+"/saleInvioceSearch.ajax";
	...
	$("#btn-export").click(function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/part/financeMng/invoiceNotice/SupInoviceSearchMngAction/saleExportExcel.do");
		$("#exportFm").submit();
	})
});
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-invoiceSearch">
					<tr>
                        ...
                        <td>
                            <input type="text" id="ORG_CODE" name="ORG_CODE" datasource="T.ORG_CODE" datatype="1,is_null,300000" kind="dic" src="T#TM_ORG:CODE:ONAME{ORG_ID,CODE,ONAME}:1=1 AND ORG_TYPE = 200005 AND STATUS='100201' ORDER BY CODE" readonly="true" operation="in"/>
                        </td>
                        <td><label>渠道名称：</label></td>
                        <td>
                            <input type="text" id="ORG_NAME" name="ORG_NAME" datasource="T.ORG_NAME"  operation="like"/>
                        </td>
					</tr>
					<tr>
