...
<title>服务站入库记录汇总表</title>
</head>
<body>
<div id="layout" style="width:100%;">
	<div id='background1' class='background'></div>
	<div id='progressBar1' class='progressBar'>loading...</div>
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 信息查询  &gt; 财务相关&gt; 服务站入库记录汇总表</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-searchContract" >
					<thead>
						<tr>
							...
							<th fieldname="ALCGJE" refer="formatAmount" align="right" colwidth="95">A类配件金额(元)</th>
							...
							<th fieldname="IN_DATES" colwidth="170" style="display:none">出库时间段</th>
						</tr>
					</thead>
					<tbody>
                    </tbody>
...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = mngUrl+"/inAmountSearch.ajax";
	...
	$("#btn-export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/part/financeMng/searchInfo/DealerInAmountSearchMngAction/download.do?JD="+jd);
		$("#exportFm").submit();
	});
	// 重置
