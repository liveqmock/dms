...
$(function()
{
	$("#btn-search").bind("click", function(event){
		var searchUrl = mngUrl+"/supplierInvioceSearch.ajax";
	...
	$("#btn-export").click(function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/part/financeMng/invoiceNotice/SupInoviceSearchMngAction/supExportExcel.do");
		$("#exportFm").submit();
	})
});
			...
			<table style="display:none;width:100%;" id="tab-invoice_info" name="tablist" ref="page_invoice" refQuery="fm-searchInvioce" >
					<thead>
						<tr>
							...
							<th fieldname="SPLIT_NO" refer="showLink">采购订单号</th>
