...
<head>
    ...
    <script type="text/javascript">
        var searchUrl = "<%=request.getContextPath()%>/part/financeMng/invoiceMng/InvoiceMngAction/searchSaleOrder.ajax";
        //定义弹出窗口样式
        ...
        function doInvoice(rowobj) {
            ...
            $.pdialog.open(webApps + "/jsp/dms/oem/part/finance/invoiceMng/invoiceMngEdit.jsp", "editWin", "开票信息", diaEditOptions);
        }
                ...
                <div class="searchBar" align="left">
                    <table class="searchContent" id="tab-searchSaleOrder">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="ORG_CODE" name="ORG_CODE" datasource="ORG_CODE" datatype="1,is_null,30" operation="like"/></td>
            ...
            <div id="div-saleOrderList">
                <table style="display:none;width:100%;" id="tab-saleOrderList" name="tablist" ref="div-saleOrderList" refQuery="tab-searchSaleOrder">
                    ...
                    <tr>
                        ...
                        <th colwidth="45" type="link" title="[开票]" action="doInvoice">操作</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
