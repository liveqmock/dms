    ...
    <div style="height:auto;overflow:hidden;">
                ...
                <fieldset>
                    ...
                    <table class="editTable" id="tab-invoiceInfo">
                        ...
                        <tr>
                            ...
                            <td>
                                <input  type="text" name="INVOICE_DATE" id="INVOICE_DATE" datasource="INVOICE_DATE" readOnly="true" value=""/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dia-EXPRESS_COMPANY" name="dia-EXPRESS_COMPANY" datasource="EXPRESS_COMPANY" datatype="0,is_null,30"/>
                            </td>
                            <td><label>快递单号：</label></td>
                            <td>
                                <input type="text" id="dia-EXPRESS_NO" name="dia-EXPRESS_NO" datasource="EXPRESS_NO" datatype="0,is_null,300"/>
                            </td>
                            <td><label>收件人：</label></td>
                            <td>
                                 <input  type="text" name="RECIVE_USER" id="RECIVE_USER" datasource="RECIVE_USER" datatype="0,is_null,300"/>
                            </td>
                        </tr>
                        <tr>
                            <td><label>电话：</label></td>
                            <td>
                                <input type="text" id="dia-TEL" name="dia-TEL" datasource="TEL" datatype="0,is_null,30"/>
                            </td>
                            <td><label>地址：</label></td>
                            <td>
                                <input type="text" id="dia-ADDRESS" name="dia-ADDRESS" datasource="ADDRESS" datatype="0,is_null,300"/>
                            </td>
                            <td><label>邮寄人：</label></td>
                            <td>
                                <input type="text" id="dia-SENDER" name="dia-SENDER" datasource="SENDER" datatype="0,is_null,300"/>
                            </td>
                        </tr>
                        <tr>
                            <td><label>邮寄备注：</label></td>
                            <td colspan="6"><textarea class="" rows="3" id="dia-EXPRESS_REMARKS" name="dia-EXPRESS_REMARKS" datasource="EXPRESS_REMARKS" style="width:500px;" datatype="1,is_null,500"></textarea></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
        ...
        <div class="formBar">
            <ul>
                ...
                <li id="send" style="display:none">
                    <div class="button">
                        <div class="buttonContent">
                            <button type="button" id="btn-send" >邮&nbsp;&nbsp;寄</button>
                        </div>
                    </div>
                </li>
                <li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#btn-send').bind('click', function () {
            ...
            var expressUrl = diaSaveAction + "/expressInvoice.ajax?SUM_ID="+$("#dia-SUM_ID").val();
        ...
        $('#btn-save').bind('click', function () {
            ...
            //将需要提交的内容拼接成json
            sCondition = $f.combined(1) || {};
            var expressUrl = diaSaveAction + "/updateExpressInvoice.ajax";
            doNormalSubmit($f, expressUrl, "btn-save", sCondition, diaSaveCallBack);
        });
        var selectedRows = $("#tab-saleOrderList").getSelectedRows();
        setEditValue("fm-invoiceInfo", selectedRows[0].attr("rowdata"));
        var EXPRESS_NO = selectedRows[0].attr("EXPRESS_NO");
		if(EXPRESS_NO){
			$("#send").show();
		}
    })
