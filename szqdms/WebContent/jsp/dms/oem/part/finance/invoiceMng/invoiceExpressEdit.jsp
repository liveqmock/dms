                ...
                <fieldset>
                    ...
                    <table class="editTable" id="tab-invoiceInfo">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dia-EXPRESS_NO" name="dia-EXPRESS_NO" datasource="EXPRESS_NO" datatype="0,is_null,30"/>
                            </td>
                            <td><label>收件人：</label></td>
                            <td>
                                 <input  type="text" name="RECIVE_USER" id="RECIVE_USER" datasource="RECIVE_USER" datatype="0,is_null,30"/>
                            </td>
                        </tr>
                        <tr>
                            <td><label>电话：</label></td>
                            <td>
                                <input type="text" id="dia-TEL" name="dia-TEL" datasource="TEL" datatype="0,is_phone,11"/>
                            </td>
                ...
                <li>
                    <div class="buttonActive">
                        <div class="buttonContent">
                            <button type="button" id="btn-save">邮&nbsp;&nbsp;寄</button>
                        </div>
                    </div>
                </li>
                <li>
...
<script type="text/javascript">
    ...
    var diaSaveAction = "<%=request.getContextPath()%>/part/financeMng/invoiceMng/InvoiceExpressAction";
    ...
    $(function () {
        ...
        $('#btn-save').bind('click', function () {
            ...
            var expressUrl = diaSaveAction + "/expressInvoice.ajax";
