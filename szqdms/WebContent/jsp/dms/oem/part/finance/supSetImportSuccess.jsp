                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
		                            ...
		                            <th fieldname="SELECT_MONTH">结算月份</th>
		                            <th fieldname="SETTLE_AMOUNT">结算金额</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/financeMng/settlement/SupplierSettlementAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/financeMng/settlement/SupplierSettlementAction/insertImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/financeMng/settlement/SupplierSettlementAction/expData.do?tmpNo="+rowStrNo);
