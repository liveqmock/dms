  				...
  				<fieldset>
					<table class="editTable" id="dia-tab-order">
						...
						<tr>
						    ...
						    <td><div id="amounts"></div></td>
						</tr>
						<tr>
							<td><label>发票号：</label></td>
						    <!-- <td colspan="4" ><div id="nos" style="width:450px;height:40px" nowrap="false"></div></td> -->
							<td colspan="4">
							  <textarea id="nos" style="width:450px;height:40px;" name="NO" datasource="NO" datatype="1,is_null,1000" readonly="reaonly"></textarea>
						    </td>
						</tr>
						<tr>
						    ...
						    <td colspan="4">
							  <textarea id="remark" style="width:450px;height:40px;" name="remark" datasource="REMARK" datatype="1,is_null,1000" readonly="reaonly"></textarea>
						    </td>
						</tr>
						<tr>
						    ...
						    <td colspan="5">
							  ...
							  <textarea id="dia-ADUIT_REMARKS" style="width:450px;height:40px;" name="dia-ADUIT_REMARKS" datasource="ADUIT_REMARKS" datatype="1,is_null,1000"></textarea>
						    </td>
						</tr>
					</table>
  				</fieldset>
...
/* 取父页面传过的参数确定新增或者修改 */
    var id = "<%=SUM_ID%>"
    var diaUrl = "<%=request.getContextPath()%>/part/financeMng/invoiceNotice/InvoiceConfirmMngAction";
  $(function () {
	  	//关闭按钮响应
	  	...
	  	$("#btn-pass").bind("click", function(event){
			...
			var aduitUrl = diaUrl + "/invoicePass.ajax";
	  	...
	  	$("#btn-rejected").bind("click", function(event){
			...
			var sCondition = {};
			sCondition = $("#dia-fm-confirmEdit").combined(1) || {};
			var aduitUrl = diaUrl + "/invoiceRejected.ajax";
	...
	//修改页面赋值
        ...
        var searchUrl = mngUrl+"/invioceOrderSearch.ajax?SUM_ID="+id;
  		...
  		var accountSearchUrl = mngUrl + "/invioceInfo.ajax?&SUM_ID="+id;
