...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/partClaimMng/claimCycl/ClaimCyclSetMngAction/searchImport.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/partClaimMng/claimCycl/ClaimCyclSetMngAction/insertImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/partClaimMng/claimCycl/ClaimCyclSetMngAction/expData.do?seqs="+rowStrNo);
