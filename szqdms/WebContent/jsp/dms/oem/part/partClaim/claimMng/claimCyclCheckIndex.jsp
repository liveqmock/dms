...
<script type="text/javascript">
    ...
    function searchApply() {
        var searchclaimCyclApply = "<%=request.getContextPath()%>/part/partClaimMng/claimCycl/ClaimCyclCheckMngAction/searchClaimCyclApply.ajax?flag='oem'";
        var $f = $("#fm-index");
        var sCondition = {};
    ...
    function doAudit(rowobj){
        ...
        $.pdialog.open(webApps+"/jsp/dms/oem/part/partClaim/claimMng/claimCyclCheckEdit.jsp", "claimCyclCheckEdit", "配件三包审核", options);
    }
</script>
</head>
<body>
            ...
            <div class="searchBar" align="left">
                <table class="searchContent" id="pjsbshTable">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="applyDate-index" name="applyDate-index" datatype="1,is_null,100" datasource="APPLY_DATE" onclick="WdatePicker({isShowWeek:true,doubleCalendar:false,dateFmt:'yyyy-MM-dd'})"  /></td>
                    </tr>
                </table>
                <div class="subBar">
                    <ul>
