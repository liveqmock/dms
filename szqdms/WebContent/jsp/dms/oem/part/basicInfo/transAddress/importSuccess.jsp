                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
									...
									<th fieldname="PROVINCE_CODE" >省代码</th>
									<th fieldname="CITY_CODE" >市代码</th>
									<th fieldname="COUNTRY_CODE" >县区代码</th>
									<th fieldname="LINK_MAN" >联系人</th>
									<th fieldname="PHONE" >电话</th>
									<th fieldname="FAX" >传真</th>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/TransAddressAction/searchImport.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/TransAddressAction/transAddressImport.ajax?rowNum="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/TransAddressAction/expSafeStockTmpErrorData.do?errorDataRowNum="+rowStrNo);
