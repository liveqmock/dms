...
<title>配件零售价格管理</title>
<script type="text/javascript">
//查询提交方法
var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/searchRetailPrice.ajax";
//定义弹出窗口样式
...
$(function(){
    ...
    $("#btn-export-index").click(function(){
        ...
        var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/retailPriceDownload.do");
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/basicInfo/ptbaretailprice/ptbaretailpriceAdd.jsp?action=2", "editPjda", "修改配件零售价格", diaAddOptions);
}
//金额格式化
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 基础数据管理  &gt; 基础信息管理   &gt; 配件零售价格管理</h4>
	<div class="page" >
