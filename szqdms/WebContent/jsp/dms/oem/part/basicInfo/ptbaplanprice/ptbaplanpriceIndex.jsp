...
<title>配件计划价格管理</title>
<script src="<%=request.getContextPath() %>/lib/plugins/mine.filestore.js" type="text/javascript"></script>
<script src="<%=request.getContextPath() %>/lib/plugins/importXls.js" type="text/javascript"></script>
<script type="text/javascript">
//变量定义
//查询提交方法
var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/searchPlanPrice.ajax";
//定义弹出窗口样式
...
$(function(){
    ...
    $("#btn-export-index").click(function(){
        ...
        var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/planPriceDownload.do");
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/basicInfo/ptbaplanprice/ptbaplanpriceAdd.jsp?action=2", "editPjda", "修改配件计划价格", diaAddOptions);
}
//金额格式化
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 基础数据管理  &gt; 基础信息管理   &gt; 配件计划价格管理</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_yhlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="CKJG" refer="amountFormat" align="right">最高采购价格参考</th>
