			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-searchSupplierInfo">
					...
					<tr>
					    ...
					    <td><input type="text" id="supplierCode" name="supplierCode" datasource="A.SUPPLIER_CODE" kind="dic" src="T#PT_BA_SUPPLIER:SUPPLIER_CODE:SUPPLIER_NAME{SUPPLIER_CODE,SUPPLIER_NAME}:1=1 AND STATUS=<%=DicConstant.YXBS_01 %>" datatype="1,is_null,30"/></td>
						<td><label>是否有效：</label></td>
					    <td>
					    	<select  type="text" id="STATUS" name="STATUS" datasource="A.STATUS" kind="dic" class="combox" src="YXBS"  datatype="1,is_null,6" value="" >
