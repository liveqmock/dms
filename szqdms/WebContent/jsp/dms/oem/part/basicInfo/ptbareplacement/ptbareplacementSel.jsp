			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-orderSearch">
					...
					<tr>
					    ...
					    <td><input type="text" id="PART_CODE" name="PART_CODE" datatype="1,is_digit_letter,300" dataSource="PART_CODE" operation="like" /></td>
...
//查询提交方法
var flag = '<%=flag%>'
var mngUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaReplacementAction";
$(function()
{
...
var dialog2 = $("body").data("ptbareplacementSel");
