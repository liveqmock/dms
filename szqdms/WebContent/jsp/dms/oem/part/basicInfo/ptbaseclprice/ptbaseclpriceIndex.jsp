...
var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/searchSeClPrice.ajax";
//定义弹出窗口样式
...
$(function(){
	...
	$('#btn-importExcel').bind('click',function(){
        importXls("SE_BA_CL_PRICE_TMP","",4,3,"/jsp/dms/oem/part/basicInfo/ptbaseclprice/importSuccess.jsp");
	});   
	...
	$("#btn-downLoad").click(function(){
        ...
        $("#exportFm").attr("action","<%=request.getContextPath()%>/service/basicinfomng/ServicePriceAction/expSeClPrice.ajax");
        $("#exportFm").submit();
    });
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/part/basicInfo/ptbaseclprice/ptbaseclpriceAdd.jsp?action=2", "editPjda", "修改服务索赔价格", diaAddOptions);
}
//金额格式化
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 基础数据管理  &gt; 基础信息管理   &gt; 服务索赔价格管理</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_yhlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="SE_CLPRICE" refer="amountFormat" align="right">服务索赔价格</th>
