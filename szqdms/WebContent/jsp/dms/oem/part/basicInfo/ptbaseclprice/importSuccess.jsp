                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
									...
									<th fieldname="SE_CLPRICE" >服务索赔价格</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/ServicePriceAction/searchSeBaClPriceTmpImport.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/service/basicinfomng/ServicePriceAction/seBaClPriceImport.ajax?rowNum="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/ServicePriceAction/expSeClPriceTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
