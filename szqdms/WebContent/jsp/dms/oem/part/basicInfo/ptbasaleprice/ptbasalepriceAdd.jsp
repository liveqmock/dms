...
<div id="dia-layout">
	...
	<div class="pageContent" style="" >
		<form method="post" id="dia-fm-pjdawh" class="editForm" >
			...
			<div align="left">
				<fieldset>
				<legend align="right"><a onclick="onTitleClick('dia-tab-pjxx')">&nbsp;配件销售价格编辑&gt;&gt;</a></legend>
				<table class="editTable" id="dia-tab-pjxx">		
					...
					<tr>						
					    ...
					    <td><input type="text" id="dia-sale_price"  name="dia-sale_price" datasource="SALE_PRICE" datatype="0,is_digit_letter,30" value=""/></td>
					</tr>
				</table>
				</fieldset>	
			</div>
...
$(function(){
	...
	$("#btn-save").bind("click", function(event){
		...
		var original_price=selectedRows[0].attr("SALE_PRICE");
		var now_price=$('#dia-sale_price').val();
		if(now_price==original_price){
       	alert("价格未做任何调整");
       }else{
       	var updateUrl = diaSaveAction + "/updateSalePrice.ajax?original_price="+original_price+"&now_price="+now_price;
