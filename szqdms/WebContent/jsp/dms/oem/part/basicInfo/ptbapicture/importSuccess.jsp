                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
									...
									<th fieldname="PICTURE_NAME" >图片名称</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaPictureAction/searchImport.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaPictureAction/confirmImport.ajax?rowNum="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBaPictureAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
