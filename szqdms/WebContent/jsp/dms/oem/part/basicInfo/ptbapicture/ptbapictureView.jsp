			...
			<div align="left">
				...
				<table class="editTable" id="dia-tab-pjxx">			
					<tr>
					    ...
					    <td><input type="text" id="dia-part_name"  name="dia-part_name" datasource="PART_NAME" datatype="0,is_null,300" value=""/></td>
					    <td><label>配件代码：</label></td>
					    <td><input type="text" id="dia-part_code"  name="dia-part_code" datasource="PART_CODE" datatype="0,is_digit_letter,300" value=""/></td>					   			    
					</tr>
				</table>
				</fieldset>	
			</div>
...
$(function(){
	...
	$("#addAtt").bind("click",function(){
		var PICTURE_ID = $("#dia-picture_id").val();
		$.filestore.open(PICTURE_ID,{"folder":"true","holdName":"true","uploadLimit":4,"fileSizeLimit":0,"fileTypeDesc":"All Files","fileTypeExts":"*.*"});
	});
