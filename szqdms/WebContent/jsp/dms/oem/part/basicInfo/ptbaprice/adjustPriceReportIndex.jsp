...
<body>
	<div id="layout" style="width: 100%;">
		...
		<h4 class="contentTitle" align="left">
			<img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置： 信息查询 &gt;财务相关 &gt; 调价记录查询
		</h4>
		<div class="page">
							...
							<tr>
								...
								<td>
									...
									<select class="combox" id="PRICE_TYPE" name="PRICE_TYPE" kind="dic" src="PJJGLX" datasource="A.PRICE_TYPE" operation="=" datatype="0,is_null,10"
										filtercode="<%=DicConstant.PJJGLX_01%>|<%=DicConstant.PJJGLX_02%>|<%=DicConstant.PJJGLX_04%>|<%=DicConstant.PJJGLX_05%>"
									>
					...
					<table style="display: none; width: 100%;" id="tab-grid-index" name="tablist" ref="page_grid" refQuery="fm-partPriceChange">
						<thead>
							<tr>
								...
								<th fieldname="USABLE_STOCK">库存数量</th>
								<th fieldname="IN_STRANS_STOCK">在途数量</th>
