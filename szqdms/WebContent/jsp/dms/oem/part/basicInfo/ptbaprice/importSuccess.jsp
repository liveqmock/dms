...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/searchPriceTmp.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/PtBaPriceImport.ajax?rowNum="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBaInfoAction/expThirdPriceTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
