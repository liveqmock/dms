			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-orderSearch">
					...
					<tr>
					    ...
					    <td><input type="text" id="PART_CODE" name="PART_CODE" datatype="1,is_digit_letter,30" dataSource="T.PART_CODE" operation="like" /></td>
					    <td><label>配件名称：</label></td>
					    <td><input type="text" id="PART_NAME" name="PART_NAME" datatype="1,is_digit_letter,30" dataSource="T.PART_NAME" operation="like" /></td>
					</tr>
				</table>
				<div class="subBar">
					<ul>
...
$(function()
{
		var searchUrl = mngUrl+"/partsupplierrlSearch.ajax"; 
