                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
                                    ...
                                    <th fieldname="PART_STATUS">配件标识</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaPartSupplierRlAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBaPartSupplierRlAction/insertImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBaPartSupplierRlAction/expData.do?seqs="+rowStrNo);
