...
$(function(){
	...
	$('#btn-importExcel').bind('click',function(){
        importXls("SE_BA_RE_PRICE_TMP","",4,3,"/jsp/dms/oem/part/basicInfo/ptbareprice/importSuccess.jsp");
	});   
	...
	$("#btn-downLoad").click(function(){
        ...
        $("#exportFm").attr("action","<%=request.getContextPath()%>/service/basicinfomng/ServicePriceAction/expSeRePrice.ajax");
        $("#exportFm").submit();
    });
