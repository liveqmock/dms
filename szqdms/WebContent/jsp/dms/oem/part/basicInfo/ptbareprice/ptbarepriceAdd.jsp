...
<div id="dia-layout">
	...
	<div class="pageContent" style="" >
		<form method="post" id="dia-fm-pjdawh" class="editForm" >
			...
			<div align="left">
				<fieldset>
				<legend align="right"><a onclick="onTitleClick('dia-tab-pjxx')">&nbsp;服务追偿价格编辑&gt;&gt;</a></legend>
				<table class="editTable" id="dia-tab-pjxx">		
					...
					<tr>						
					    <td><label>服务追偿价格：</label></td>
					    <td><input type="text" id="dia-se_reprice"  name="dia-se_reprice" datasource="SE_REPRICE" datatype="0,is_digit_letter,30" value=""/></td>
					</tr>
				</table>
				</fieldset>	
			</div>
...
//修改操作
	if(diaAction != "1")
	{
		...
		if(!$("#dia-se_reprice").val()){
			 $('#dia-se_reprice').val("0.00");
		}
...
$(function(){
	...
	$("#btn-save").bind("click", function(event){
		...
		var se_reprice = $("#dia-se_reprice").val();	
		if (!pattern.test(se_reprice)) {
			alert("服务追偿价格必须符合财务数字，如12.65或12");
			return false;
		}
		var original_price=selectedRows[0].attr("SE_REPRICE");
		var now_price=$('#dia-se_reprice').val();
		if(now_price==original_price){
       	alert("价格未做任何调整");
       }else{
       	var updateUrl = diaSaveAction + "/updateSeRePrice.ajax?original_price="+original_price+"&now_price="+now_price;
