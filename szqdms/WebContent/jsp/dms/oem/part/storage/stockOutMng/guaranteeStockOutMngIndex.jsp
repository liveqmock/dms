...
<head>
    ...
    <script type="text/javascript">
        var searchUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/GuaranteeStockOutMngAction/searchOutBill.ajax";
        var deleteUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/GuaranteeStockOutMngAction/deleteOutBill.ajax";
        var stockOutUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/GuaranteeStockOutMngAction/partStockOutInIndex.ajax";
        //定义弹出窗口样式
        ...
        $(function () {
            ...
            $("#btn-add").bind("click", function (event) {
                $.pdialog.open(webApps + "/jsp/dms/oem/part/storage/stockOutMng/guaranteeStockOutMngEdit.jsp?action=1", "editWin", "新增出库单", diaEditOptions);
            });
        ...
        function doUpdate(rowobj) {
            ...
            $.pdialog.open(webApps + "/jsp/dms/oem/part/storage/stockOutMng/guaranteeStockOutMngEdit.jsp?action=2", "editWin", "三包订单出库明细", diaEditOptions);
        }
        ...
        function doDelete(rowobj) {
            $row = $(rowobj);
            var url = deleteUrl + "?outId=" + $(rowobj).attr("OUT_ID");
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif"/>&nbsp;当前位置：配件管理 &gt; 仓储管理 &gt; 出库管理 &gt; 三包急件出库</h4>
                ...
                <div class="searchBar" align="left">
                    <table class="searchContent" id="tab-searchOutBill">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="orgCode" name="orgCode" datasource="A.APPLY_ORG_ID" datatype="1,is_null,10000" readOnly hasBtn="true" callFunction="showOrgTree('orgCode',1,1)" operation="IN"/></td>
                        </tr>
                    </table>
                    <div class="subBar">
                        <ul>
            ...
            <div id="div-outBillList">
                <table style="display:none;width:100%;" id="tab-outBillList" name="tablist" ref="div-outBillList" refQuery="tab-searchOutBill">
                    ...
                    <tr>
                        ...
                        <th fieldname="ISSUE_NO" colwidth="135">发料单号</th>
                        <th fieldname="ORDER_NO" colwidth="135">三包急件单号</th>
                        ...
                        <th fieldname="CHECK_DATE" colwidth="135">审核日期</th>
