...
<head>
    ...
    <script type="text/javascript">
        var searchUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/SaleStockOutMngAction/searchSaleOrder.ajax";
        var deleteUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/SaleStockOutMngAction/deleteOutBill.ajax";
        var stockOutUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/SaleStockOutMngAction/partStockOutInIndex.ajax";
        //定义弹出窗口样式
        ...
        function doUpdate(rowobj) {
            ...
            $.pdialog.open(webApps + "/jsp/dms/oem/part/storage/stockOutMng/saleStockOutMngEdit.jsp?action=2", "editWin", "配件出库", diaEditOptions);
        }
                ...
                <div class="searchBar" align="left">
                    <table class="searchContent" id="tab-searchOutBill">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="combox" id="ORDER_TYPE" name="ORDER_TYPE" kind="dic" src="DDLX" datasource="A.ORDER_TYPE" filtercode="203701|203702|203703|203704|203706|203711" datatype="1,is_null,10">
            ...
            <div id="div-outBillList">
                <table style="display:none;width:100%;" id="tab-outBillList" name="tablist" ref="div-outBillList" refQuery="tab-searchOutBill">
                    ...
                    <tr>
                        ...
                        <th colwidth="50" type="link" title="[出库]"  action="doUpdate" >操作</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
