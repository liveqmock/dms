...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btn-searchSale").bind("click", function (event) {
            var searchSaleUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/SaleStockOutMngAction/searchSale.ajax?WAREHOUSE_ID="+$('#dia-WAREHOUSE_ID').val()+"&WAREHOUSE_TYPE="+$('#dia-WAREHOUSE_TYPE').val();
            var $f = $("#fm-searchSale");
            var sCondition = {};
