                    ...
                    <table style="display:none;width:100%;" id="tab-partList" multivals="div-selectedPart" name="tablist" ref="div-partList" refQuery="tab-searchPart">
                        <thead>
                            <tr>
                                ...
                                <th fieldname="AVAILABLE_AMOUNT" refer="myOutAmountInput" colwidth="60">出库数量</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#btn-dia-confirmPart').bind('click',function(){
            //添加配件URL
            var insertPromPartUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/OtherStockOutMngAction/insertOutBillPart.ajax?account="+$("#PERSON_NAME").attr("code");
    ...
    function searchPart() {
        //查询配件URL
        var searchPartUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/OtherStockOutMngAction/searchPart.ajax?outId="+$('#dia-OUT_ID').val()+"&warehouseId="+$('#dia-WAREHOUSE_ID').val();
        var $f = $("#fm-searchPart");
        var sCondition = {};
