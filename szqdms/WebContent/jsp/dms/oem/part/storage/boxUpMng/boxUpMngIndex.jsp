...
<head>
    ...
    <script type="text/javascript">
        var searchUrl = "<%=request.getContextPath()%>/part/storageMng/boxUpMng/BoxUpMngAction/searchSaleOrder.ajax";
        //定义弹出窗口样式
        ...
        //装箱清单维护链接
        function doBoxUp(rowobj) {
            $("td input[type=radio]", $(rowobj)).attr("checked", true);
            $.pdialog.open(webApps + "/jsp/dms/oem/part/storage/boxUpMng/boxUpMngEdit.jsp", "editWin", "装箱清单维护", diaEditOptions);
        }
            ...
            <div id="div-saleOrderList">
                <table style="display:none;width:100%;" id="tab-saleOrderList" name="tablist" ref="div-saleOrderList"
                    ...
                    <tr>
                        ...
                        <th fieldname="ORDER_NO" colwidth="150" refer="showLink">订单编号</th>
                        ...
                        <th colwidth="85" type="link" title="[装箱清单维护]"  action="doBoxUp" >操作</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
