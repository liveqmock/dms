                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
		                            ...
		                            <th fieldname="COUNT" colwidth="70">数量</th>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/storageMng/boxUpMng/BoxUpMngAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/storageMng/boxUpMng/BoxUpMngAction/confirmImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/storageMng/boxUpMng/BoxUpMngAction/expData.do?tmpNo="+rowStrNo+"&orderId="+<%=bParams%>);
