                    ...
                    <tr>
                        ...
                        <td>
                        	<select id="APPLY_STATUS" name="APPLY_STATUS" datasource="APPLY_STATUS" datatype="1,is_digit_letter,30" operation="=" kind="dic" src="JYJSQZT"
	                        	filtercode="<%=DicConstant.JYJSQZT_02%>|<%=DicConstant.JYJSQZT_03%>|<%=DicConstant.JYJSQZT_04%>|<%=DicConstant.JYJSQZT_05%>|<%=DicConstant.JYJSQZT_06%>" >
...
$(function(){
	$("#btn-search").click(function(){
		var seachActionURL = "<%=request.getContextPath()%>/part/storageMng/overstockParts/DealerOverstockPartApplyAction/queryOverstockApplyAuditAll.ajax";
		var $f = $("#fm-index");
		var sCondition = {};
