                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
									...
									<th fieldname="MATERIAL_COUNT" >实物数量</th>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryDtlAction/searchTmp.ajax?ID="+<%=bParams%>;
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryDtlAction/dtlImport.ajax?rowNum="+rowStrNo+"&ID="+<%=bParams%>;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryDtlAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
