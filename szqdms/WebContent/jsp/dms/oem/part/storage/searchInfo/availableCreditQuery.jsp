...
<body>
	<div id="layout" style="width: 100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 信息查询  &gt; 财务相关   &gt; 可用额度查询</h4>
		<div class="page">
					...
					<table style="display:none;width:100%;" id="invertoryTable" name="tablist" ref="page_contract" refQuery="fm-searchContract" >
							<thead>
								<tr>
									...
									<th fieldname="LINE_OF_CREDIT" refer="amountFormat" align="right">授信额度</th>
									<th fieldname="BEGIN_AMOUNT" refer="amountFormat" align="right">期初结转</th>
									<th fieldname="CLOSE_ORDER_AMOUNT" refer="amountFormat" align="right">已关闭订单</th>
									<th fieldname="NOT_CLOSE_ORDER_AMOUNT" refer="amountFormat" align="right">未关闭订单</th>
									<!-- <th fieldname="RETURN_ORDER_AMOUNT" refer="amountFormat" align="right">退库金额</th> -->
									<th fieldname="BACK_AMOUNT" refer="amountFormat" align="right">回款合计</th>
									<th fieldname="RECEIVABLES" refer="amountFormat" align="right">应收账款</th>
									<th fieldname="AVAILABLE_CREDIT" refer="amountFormat" align="right">可用额度</th>
								</tr>
							</thead>
							<tbody>
		                    </tbody>
...
$(function(){
	...
	$("#btn-search").click(function(){
		var queryAction = "<%=request.getContextPath()%>/part/storageMng/search/AvailableCreditQueryAction/queryListInfo.ajax";
