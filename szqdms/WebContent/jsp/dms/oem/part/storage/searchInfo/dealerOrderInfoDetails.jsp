				...
				<div class="pageContent" >
						...
						<fieldset>
							...
							<table id="amountInfoTable" align="left" style="display: none;">
									<thead>
										<tr>
											<th fieldname="ACCOUNT_TYPE" colwidth="60px">账户类型</th>
											<th fieldname="ACCOUNT_TYPE_NAME" colwidth="60px">账户类型名称</th>
											<th fieldname="AVAILABLE_AMOUNT"  refer="amountFormat" colwidth="120px">可用余额（元）</th>
											<th fieldname="PAY_AMOUNT"  refer="amountFormat"colwidth="120px" >本次使用金额（元）</th>
										</tr>
									</thead>
									<tbody>
				                    </tbody>
						...
						<table id="partInfoTable"  align="left" width="98%" style="display: none;">
								<thead>
									<tr>
										...
										<th fieldname="UNIT_PRICE" refer="amountFormat" colwidth="80px">单价</th>
										<th fieldname="PLAN_PRICE" refer="amountFormat" colwidth="80px">计划价</th>
										<th fieldname="PLAN_UNIT" colwidth="60px">计量单位</th>
										<th fieldname="ORDER_COUNT" colwidth="60px">订购数量</th>
										<th fieldname="DELIVERY_COUNT" colwidth="60px">发运数量</th>
										<th fieldname="SIGN_COUNT" colwidth="60px">签收数量</th>
										<th fieldname="AMOUNT" refer="amountFormat" colwidth="80px" >金额</th>
										<th fieldname="REMARKS">备注</th>
									</tr>
								</thead>
								<tbody>
...
$(function(){
	...
	function showInfo(jsonObj){
 		...
 		onTitleClick('amountInfoTable');
 		
 		onTitleClick('checkInfoTable');
