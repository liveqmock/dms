...
<body>
	<div id="layout" style="width: 100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 信息查询  &gt; 仓储相关   &gt; 本部库存查询</h4>
		<div class="page">
...
$(function(){
	$("#btn-search").click(function(){
		if(checkAmountNum({maxId:'AMOUNT_E'},$("#AMOUNT_B")) && checkAmountNum({minId:'AMOUNT_B'},$("#AMOUNT_E"))){
			var queryAction = "<%=request.getContextPath()%>/part/storageMng/search/StocksCountQueryAction/queryListInfo.ajax";
	...
	$("#btn-export").click(function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/part/storageMng/search/StocksCountQueryAction/exportExcel.do");
		$("#exportFm").submit();
	})
})
