...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 信息查询  &gt; 仓储相关   &gt; 渠道配件出入库查询</h4>
	<div class="page" >
...
$(function()
{
	...
	$("#btn-search").bind("click", function(event){
		var searchUrl = mngUrl+"/dealerStockSearch.ajax";
