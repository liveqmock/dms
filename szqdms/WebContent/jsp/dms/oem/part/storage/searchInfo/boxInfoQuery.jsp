...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置： 信息查询 &gt;仓储相关&gt;装箱清单查询</h4>
    <div class="page">
...
<script type="text/javascript">
    // URL
    var searchUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/BoxInfoQueryAction/queryListInfo.ajax";
    // 初始化方法
     $(function(){
     ...
     function openDetailPage(orderId){
         ...
         $.pdialog.open(webApps+"/jsp/dms/oem/part/storage/searchInfo/boxInfoQueryForDetails.jsp?id="+orderId, "forDetailsPage", "订单明细", options);
     }
