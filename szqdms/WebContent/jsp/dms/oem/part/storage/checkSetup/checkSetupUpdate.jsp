			...
			<table class="editTable" id="dia-tab-pjxx">
				<tr>					
				    ...
				    <td>
				    	...
				    	<input type="hidden" id="dia-warehouse_code" name="dia-warehouse_code" kind="dic" 
				    	src="T#PT_BA_WAREHOUSE:WAREHOUSE_CODE:WAREHOUSE_NAME{WAREHOUSE_ID,WAREHOUSE_NAME}:1=1 AND WAREHOUSE_TYPE NOT IN(100106) AND STATUS=<%=DicConstant.YXBS_01 %> ORDER BY WAREHOUSE_CODE" 
				    	datasource="WAREHOUSE_CODE" datatype="1,is_null,300"  readonly/>				   
				    </td>				    
				</tr>
				<tr>
					<td><label>盘点类型：</label></td>
				    <td>
<!--				    	<input type="hidden" id="dia-inventory_type" name="dia-inventory_type" kind="dic" src="PDLX" datasource="INVENTORY_TYPE" datatype="1,is_null,300" readonly/>-->
				...
				<tr>
					...
					<td colspan="5">
						<textarea id="dia-bz" name="dia-remarks" style="width:460px;" datasource="REMARKS" datatype="1,is_null,500" readonly></textarea>
					</td>
				</tr>
			</table>
			</fieldset>	
