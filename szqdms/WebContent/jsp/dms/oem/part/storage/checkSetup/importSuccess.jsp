...
<script type="text/javascript">
    ...
    var bParams=<%=bParams%>;
    var searchUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryAction/searchCheckTmpImport.ajax";
    $(function(){
    	if (errorflag=="0") {
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryAction/checkImport.ajax?rowNum="+rowStrNo+"&inventory_id="+bParams;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/basicInfoMng/PtBuInventoryAction/expCheckTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
