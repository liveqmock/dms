...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/storageMng/shipMng/ShipOutAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/storageMng/shipMng/ShipOutAction/confirmImport.ajax?tmpNo="+rowStrNo;
                sendPost(insertUrl+"&ID="+'<%=bParams%>', "", "", doConfirmCallBack, "true");
            }catch(e){
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/storageMng/shipMng/ShipOutAction/expData.do?tmpNo="+rowStrNo+"&id="+<%=bParams%>);
