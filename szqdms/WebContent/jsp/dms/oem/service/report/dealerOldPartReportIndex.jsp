...
$(function(){
	...
	$("#search").bind("click",function(event){
    	...
    	var url =searchUrl+"/oldPartCountSearch.ajax";
	...
	$("#export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/reportForms/partRepairAmountReportAction/oldPartCountDownload.do");
		$("#exportFm").submit();
	});
});
</script>
