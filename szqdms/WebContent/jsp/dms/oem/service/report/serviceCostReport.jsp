 ...
 * .ajax表示请求为ajax请求
 */
var searchUrl = "<%=request.getContextPath()%>/service/reportForms/ServiceCostReportAction/search.ajax";
//初始化
$(function()
{
	//查询按钮响应
    ...
    $("#btn-export-index").click(function(){
        ...
        var url = encodeURI("<%=request.getContextPath()%>/service/reportForms/ServiceCostReportAction/download.do");
...
<div id="layout" style="width:100;" >
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：报表管理&gt;网络终审同比环比</h4>
	<div class="page">
			...
			<div class="searchBar" align="left">
				<table class="searchContent" id="tab-search">
				   <tr>
                        ...
                        <td><input type="text" id="settle_date" name="settle_date" datasource="SETTLE_DATE" datatype="0,is_null,100" value=""  onclick="WdatePicker({isShowWeek:true,doubleCalendar:false,dateFmt:'yyyy-MM'})" /></td>
			...
			<table width="100%" id="tab-list" name="tab-list" style="display: none" ref="page-list" refQuery="tab-search" pageRows="10">
				<thead>
					<tr>
								...
								<th fieldname="A1"  >当前结算月</th>					
								<th fieldname="A2"  >上个结算月</th>
								<th fieldname="A3"  >去年当前结算月</th>
								<th fieldname="A5"  >同比%</th>
								<th fieldname="A4"   >环比%</th>
					</tr>
				</thead>
				<tbody>
				</tbody>
