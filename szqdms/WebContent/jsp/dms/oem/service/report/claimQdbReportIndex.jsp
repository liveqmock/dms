...
$(function(){
	...
	$("#search").bind("click",function(event){
    	...
    	var url =searchUrl+"/claimQdbSearch.ajax";
	...
	$("#export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/reportForms/partRepairAmountReportAction/qdbDownload.do");
		$("#exportFm").submit();
	});
});
//vin连接
