...
<title>办事处维修响应时间统计表</title>
<script type="text/javascript">

var searchUrl = "<%=request.getContextPath()%>/service/reportForms/ServiceHourMngAction/search_bsc.ajax";
...
$(function()
{
	...
	$("#btn-expExcel").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/reportForms/ServiceHourMngAction/download_bsc.do");
		$("#exportFm").submit();
	});
});
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：报表管理&gt;办事处维修响应时间</h4>
		<div class="page">
