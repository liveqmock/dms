...
$(function(){
	...
	$("#search").bind("click",function(event){
    	...
    	var url =searchUrl+"/claimXjjlSearch.ajax";
	...
	$("#export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/reportForms/partRepairAmountReportAction/jljeDownload.do");
		$("#exportFm").submit();
	});
});
//vin连接
			...
			<table style="display:none;width:100%;" layoutH="250" id="claimSearchlist" name="claimSearchlist" ref="preAuth" refQuery="claimSearchTable" >
					<thead>
						<tr>
							...
							<th fieldname="XJJE" >星级金额</th>
							<th fieldname="JLJE" >激励金额</th>
