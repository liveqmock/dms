...
$(function(){
	...
	$("#search").bind("click",function(event){
    	...
    	var url =searchUrl+"/oldPartReturnCountSearch.ajax";
	...
	$("#export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/reportForms/partRepairAmountReportAction/oldPartReturnCountDownload.do");
		$("#exportFm").submit();
	});
});
</script>
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：售后管理&gt;报表管理&gt;服务商激励金额统计</h4>
		<div class="page">
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="claimSearchTable">
						...
						<tr>
							...
							<td><input type="text" id="produceDate" name="produceDate" datasource="RO.PRODUCE_DATE" style="width:75px;"   onclick="WdatePicker({maxDate:'<%=date%>',dateFmt:'yyyy-MM'})" datatype="1,is_null,30" /></td>
						</tr>
					</table>
					<div class="subBar">
						<ul>
			...
			<table style="display:none;width:100%;" layoutH="250" id="claimSearchlist" name="claimSearchlist" ref="preAuth" refQuery="claimSearchTable" >
					<thead>
						<tr>
							...
							<th fieldname="WAREHOUSE_NAME" >所属库房</th>
							<th fieldname="BSCMC" >办事处名称</th>
							<th fieldname="JZDMC" >集中点名称</th>
							<th fieldname="FWZDM" >渠道商代码</th>
							<th fieldname="FWZJC" >渠道商简称</th>
							<th fieldname="FWZMC" >渠道商名称</th>
