...
<script type="text/javascript">
    ...
    var bParams=<%=bParams%>;
    var searchUrl = "<%=request.getContextPath()%>/service/serviceactivity/ServiceActivityTypeMngAction/searchImport.ajax";
    ...
    $(function(){
        ...
        $("#doConfirm").click(function() {
            //点击确定按钮，提交后台请求
            try{
            	 var url =diaSaveAction+"/serviceActivityVinImport.ajax?activityId="+bParams+"&tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            //点击确定按钮，提交后台请求
            try{
                var url = encodeURI("<%=request.getContextPath()%>/service/serviceactivity/ServiceActivityTypeMngAction/expData.do?seqs="+rowStrNo);
