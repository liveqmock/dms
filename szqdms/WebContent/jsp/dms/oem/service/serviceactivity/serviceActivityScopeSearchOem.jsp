...
//查询按钮响应方法
var searchUrl = "<%=request.getContextPath()%>/service/serviceactivity/ServiceActivityScopeMngAction/OemSearch.ajax";
$(function(){
	//查询按钮响应
					...
					<table class="searchContent" id="serviceActivityScopeTable">
						...
						<tr>
							 <td><label>活动日期：</label></td>
							    <td colspan="5">
						    		<input kind="date" operation = ">=" type="text" id="in-ckrq" group="in-ckrq,in-jsrq"  style="width:75px;" name="in-ckrq" datasource="START_DATE" datatype="1,is_date,30" onclick="WdatePicker()" />
						    		<span style="float:left;margin-left:-50px;margin-top:5px;">至</span>
									<input kind="date" operation = "<=" type="text" id="in-jsrq" group="in-ckrq,in-jsrq"  style="width:75px;margin-left:-30px;" name="in-ckrq" datasource="END_DATE" datatype="1,is_date,30" onclick="WdatePicker()" />
						   	   </td>
						</tr>
					</table>
					<div class="subBar">
