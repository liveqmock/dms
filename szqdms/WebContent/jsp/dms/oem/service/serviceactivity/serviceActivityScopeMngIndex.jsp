...
//查询按钮响应方法
var searchUrl = "<%=request.getContextPath()%>/service/serviceactivity/ServiceActivityScopeMngAction/search.ajax";
$(function(){
	//查询按钮响应
...
function doUpdate(rowobj){
	...
	activityName=$(rowobj).attr("ACTIVITY_NAME");
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：服务活动管理&gt;服务活动范围维护</h4>
		<div class="page">
