...
var searchUrl = "<%=request.getContextPath()%>/service/qualityretroaction/QualityretroactionMngAction/qualityretroactionOemSearch.ajax";
//查询按钮响应方法
$(function(){
  //查询方法
...
function detail(rowobj){
  ...
  $.pdialog.open(webApps+"/jsp/dms/oem/service/qualityretroaction/qualityRetroactionSearchDetail.jsp?", "qualityRetroactionOemDetail", "质量反馈明细", options,true); 
}
</script>
</head>
<body>
