...
$(function() 
{
	...
	{	
		parent.$.pdialog.close("qualityRetroactionOemDetail");
		return false;
	});
	//上一步
	...
	<div class="tabs" eventType="click" id="tabs">
		...
		<div class="tabsContent" >
			...
			<div class="pageContent">
				<div id="sbjjpj">
					<table width="100%" id="sbjjpjlb" name="sbjjpjlb" multivals="partDeleteVal" ref="sbjjpj"  style="display: none"  refQuery="fm-sbjjpjTable">
						<thead>
							<tr>
