...
<div id="dia-layout">
	...
	<div class="pageContent" style="" >
		<form method="post" id="fm-militaryVehicleSaleDateSetCheckInfo" class="editForm" >
			<!-- 隐藏域 -->			
			...
			<div align="left">
			<fieldset>
			<table class="editTable" id="tab-militaryVehicleSaleDateSetCheckInfo">
				<tr>
...
$(function(){
	//给弹出框赋值
	var selectedRows = $("#tab-militaryVehicleSaleDateSetCheckList").getSelectedRows();
	setEditValue("fm-militaryVehicleSaleDateSetCheckInfo",selectedRows[0].attr("rowdata"));
	...
	$("#btn-check").bind("click", function(event){
		...
		var $f = $("#fm-militaryVehicleSaleDateSetCheckInfo");
		//submitForm($f)方法：点击保存前，校验输入框内容是否符合输入规则
		if (submitForm($f) == false) return false;
		var sCondition = {};
		//将需要提交的内容拼接成json
		sCondition = $("#fm-militaryVehicleSaleDateSetCheckInfo").combined(1) || {};
