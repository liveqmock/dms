...
$(function()
{
	...
	$("#btn-search").bind("click", function(event){
		var $f = $("#fm-searchMilitaryVehicleSaleDateSetCheck");//获取页面提交请求的form对象
		var sCondition = {};//定义json条件对象
		//combined()：实现将页面条件按规则拼接成json
    	sCondition = $f.combined() || {};
    	var searchUrl = diaSearchAction + "/searchCheck.ajax?userType="+'<%=DicConstant.CLYHLX_02%>';
		doFormSubmit($f,searchUrl,"btn-search",1,sCondition,"tab-militaryVehicleSaleDateSetCheckList");
	});
	
	//车厂端修改日期按钮响应
	$("#btn-oemUpdate").bind("click", function(event){
		$.pdialog.open(webApps + "/jsp/dms/oem/service/serviceparamng/militaryvehiclesaledate/militaryVehicleSaleDateIndex.jsp", "oemUpdate", "军车销售日期更改", diaUpdateOptions);
	});
});
...
function doCheck(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/service/serviceparamng/militaryvehiclesaledate/militaryVehicleSaleDateSetCheck.jsp", "check", "军车销售日期更改审批", diaCheckOptions);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="fm-searchMilitaryVehicleSaleDateSetCheck" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="tab-searchMilitaryVehicleSaleDateSet">
						<tr>
		...
		<div class="pageContent">
			<div id="page_militaryVehicleSaleDateSetCheckList">
				<table style="display:none;width:100%;" id="tab-militaryVehicleSaleDateSetCheckList" name="tablist" ref="page_militaryVehicleSaleDateSetCheckList" refQuery="tab-searchMilitaryVehicleSaleDateSet">					
					<thead>
						<tr>
