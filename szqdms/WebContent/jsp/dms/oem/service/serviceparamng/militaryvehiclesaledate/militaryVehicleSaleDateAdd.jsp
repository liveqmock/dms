...
<div id="dia-layout">
	...
	<div class="pageContent" style="" >
		<form method="post" id="fm-militaryVehicleSaleDateInfo" class="editForm" >
			<!-- 隐藏域 -->
			...
			<div align="left">
			<fieldset>
			<table class="editTable" id="tab-militaryVehicleSaleDateInfo">
				<tr>
...
$(function(){
	...
	$("#btn-save").bind("click", function(event){
		//获取需要提交的form对象
		var $f = $("#fm-militaryVehicleSaleDateInfo");
		//submitForm($f)方法：点击保存前，校验输入框内容是否符合输入规则
		if (submitForm($f) == false) return false;
		var sCondition = {};
		//将需要提交的内容拼接成json
		sCondition = $("#fm-militaryVehicleSaleDateInfo").combined(1) || {};
		
		var updateUrl = diaSaveAction + "/update.ajax";
		doNormalSubmit($f,updateUrl,"btn-save",sCondition,diaUpdateCallBack);
	});
		//初始化
		var selectedRows = $("#tab-militaryVehicleSaleDateList").getSelectedRows();
		setEditValue("fm-militaryVehicleSaleDateInfo",selectedRows[0].attr("rowdata"));
...
function diaUpdateCallBack(res)
{
	try
	{
		var selectedIndex = $("#tab-militaryVehicleSaleDateList").getSelectedIndex();
		$("#tab-militaryVehicleSaleDateList").updateResult(res,selectedIndex);
		//关闭当前窗口
