...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="dia_oldPartOutDetail" style="width:100%;">
	<div class="page">
	<div class="pageContent" style="" >
		<form method="post" id="dia_oldPartOutForm" class="editForm" >
			...
			<div align="left">
				<table class="editTable" id="dia_oldPartOutTable">
					<tr>
						<td><label>供应商代码：</label></td>
						<td><input type="text" id="dia_supplierCode" name="dia_supplierCode" datasource="SUPPLIER_CODE" value="" readonly="readonly"></td>
						<td><label>供应商名称：</label></td>
						<td><input type="text" id="dia_supplierName" name="dia_supplierName" datasource="SUPPLIER_NAME" value="" readonly="readonly"></td>
					</tr>
					<tr>
						<td><label>库区名称：</label></td>
						<td><input type="text" id="warehouseName" name="warehouseName" datasource="WAREHOUSE_NAME"   value="" readonly="readonly"/></td>
						<td><label>库区代码：</label></td>
						<td><input type="text" id="warehouseCode" name="warehouseCode" datasource="WAREHOUSE_CODE" value="" readonly="readonly"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><select type="text" id="dia_outType" name="dia_outType"  class="combox" kind="dic" src="JJCKLX" datasource="OUT_TYPE" datatype="0,is_null,6" value="" >
...
var diaSaveAction = "<%=request.getContextPath()%>/service/oldpartMng/OldPartOutAction";
//弹出窗体
var dialog = $("body").data("oldPartOut");
$(function()
{
	var selectedRows = $("#oldPartOutList").getSelectedRows();
	setEditValue("dia_oldPartOutForm",selectedRows[0].attr("rowdata"));
	$("#dia_getAmount").val(selectedRows[0].attr("SURPLUS_AMOUNT"));
	
	$("#dia_save").bind("click",function(){
		var $f = $("#dia_oldPartOutDetail");
        ...
        var url =diaSaveAction+"/oldPartOutSave.ajax";
