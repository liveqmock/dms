...
var searchUrl = "<%=request.getContextPath()%>/service/oldpartMng/OldPartUpdateApplyAction/oldPartCheckSearch.ajax";
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/service/oldpart/oldUpdateCheckDetail.jsp", "olpPartUpdate", "旧件修改审核", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 旧件管理  &gt; 旧件管理   &gt; 旧件修改审核</h4>
	<div class="page" >
