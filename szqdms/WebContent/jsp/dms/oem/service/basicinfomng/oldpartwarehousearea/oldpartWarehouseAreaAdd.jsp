		...
		<form method="post" id="fm-oldpartWarehouseAreaInfo" class="editForm" >
			...
			<table class="editTable" id="tab-oldpartWarehouseAreaInfo">
				<tr>
					...
					<td><input type="text" id="dia-areaCode" name="dia-areaCode" datasource="AREA_CODE" datatype="0,is_digit_letter,30" /></td>
...
function diaInsertCallBack(res)
{
	...
	{
		//第二个参数0表示插入到第几行
		$("#tab-oldpartWarehouseArealist").insertResult(res,0);
	}catch(e)
	{
		alertMsg.error(e);
		return false;
