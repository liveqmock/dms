                ...
                <div class="pageContent">
                    <div  style="width:100%;height:300px;overflow:auto;" id="div-fileImportResult">
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
							...
							<th fieldname="TYPE_CODE" >发动机代码</th>
							<th fieldname="TYPE_NAME" >发动机名称</th>
							<th fieldname="COEFFICIENT_TYPE" >激励类型</th>							
							<th fieldname="COEFFICIENT_TYPE_NA" >激励类型名称</th>
							<th fieldname="COEFFICIENT_RADIO" >激励系数</th>
							<th fieldname="STATUS_NA" >状态</th> 
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/ExcitationCoefficientMngAction/searchImport.ajax";
...
$(function(){
    ...
    $("#doConfirm").click(function() {
        try{
            ...
            var url = "<%=request.getContextPath()%>/service/basicinfomng/ExcitationCoefficientMngAction/insertImport.ajax?errorDataRowNum="+rowStrNo;
    ...
    $("#btn-importSuccessClose").click(function() {
        try{
            ...
            var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/ExcitationCoefficientMngAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
...
<%-- function doConfirm()
{
	//点击确定按钮，提交后台请求
	try{
		var url = "<%=request.getContextPath()%>/service/basicinfomng/ExcitationCoefficientMngAction/insertImport.ajax";
		sendPost(url,"delete","",deleteCallBack,"true");
	}catch(e){}
}
 --%>
