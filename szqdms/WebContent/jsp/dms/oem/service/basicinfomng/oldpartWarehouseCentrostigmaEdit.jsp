		...
		<form method="post" id="fm-oldpartWarehouseAreaInfo" class="editForm" >
			...
			<table class="editTable" id="tab-oldpartWarehouseAreaInfo">
			    <tr>
					...
					<td><input type="text" id="dia_orgName" name="dia_orgName" datasource="ONAME" kind="dic" src="T#TM_ORG:CODE:ONAME{ORG_ID}:1=1 AND STATUS='100201' AND IS_IC = 100101" operation="like"  datatype="1,is_null,100" value="" />
			    		<input type="hidden" id="dia-orgId" name="dia-orgId" datasource="ORG_ID"/></td>
...
$(function(){
	...
	$("#btn-save").bind("click", function(event){
		...
		if(diaAction == 1)	//插入动作
		{
			var addUrl = diaSaveAction + "/insertOrg.ajax";
			doNormalSubmit($f,addUrl,"btn-save",sCondition,diaInsertCallBack);
		}else	//更新动作
		{
			var updateUrl = diaSaveAction + "/updateOrg.ajax";
