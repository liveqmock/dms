                    ...
                    <div  style="width:100%;height:300px;overflow:auto;" id="div-fileImportResult">
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
								...
								<th fieldname="ORG_ID" >服务商主键</th>
						<th fieldname="ORG_CODE" >服务商代码</th>
						<th fieldname="ORG_NAME" >服务商名称</th>						
						<th fieldname="TIME_TYPE_NA" >时间类型</th>
...
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/ClaimCodeMngAction/searchImport.ajax";
...
$(function(){
    ...
    $("#doConfirm").click(function() {
        try{
            ...
            var url = "<%=request.getContextPath()%>/service/basicinfomng/ClaimCodeMngAction/insertImport.ajax?errorDataRowNum="+rowStrNo;
    ...
    $("#btn-importSuccessClose").click(function() {
        try{
            ...
            var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/ClaimCodeMngAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
...
<%-- function doConfirm()
{
	//点击确定按钮，提交后台请求
	try{
		var url = "<%=request.getContextPath()%>/service/basicinfomng/ClaimCodeMngAction/insertImport.ajax";
		sendPost(url,"delete","",deleteCallBack,"true");
	}catch(e){}
}
 --%>
