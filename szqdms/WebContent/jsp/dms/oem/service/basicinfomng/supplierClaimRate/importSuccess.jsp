...
<script type="text/javascript">
    ...
    var errorflag = "<%=errorflag%>";
 	<%-- var bParams=<%=bParams%>; --%>
    var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/SupplierClaimDateAction/partImpSearch.ajax";
    ...
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
           	 	var url =diaSaveAction+"/oldPartManageImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            ...
            try{
            	...
            	sCondition = $f.combined() || {};
            	$("#seqs").val(sCondition); */
                var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/SupplierClaimDateAction/expData.do?rowStrNo="+rowStrNo);
