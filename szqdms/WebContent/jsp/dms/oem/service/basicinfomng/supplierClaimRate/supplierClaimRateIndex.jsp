...
<title>供应商索赔承担系数</title>
<script type="text/javascript">
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/SupplierClaimDateAction/supplierPartSearch.ajax";
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/service/basicinfomng/supplierClaimRate/supplierClaimRateEdit.jsp", "edit", "供应商索赔承担系数设置", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：基础数据管理&gt;基础信息管理&gt;供应商索赔承担系数</h4>
		<div class="page">
				...
				<table style="display:none;width:100%;" id="supplierList" name="supplierList" ref="supplier" refQuery="supplierTable" >
					<thead>
						<tr>
							...
							<th fieldname="CLAIM_RATE">索赔承担系数</th>
