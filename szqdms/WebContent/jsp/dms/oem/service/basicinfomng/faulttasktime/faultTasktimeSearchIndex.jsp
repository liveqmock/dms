			...
			<div class="searchBar" align="left">
				<table class="searchContent" id="tab-search">
					<tr>
						...
						<td><input type="text" id="FAULT_PATTERN_CODE" name="FAULT_PATTERN_CODE" datasource="T.FAULT_PATTERN_CODE" operation="right_like"  datatype="1,is_null,100" value="" /></td>
						<td><label>故障模式名称：</label></td>
						<td><input type="text" id="FAULT_PATTERN_NAME" name="FAULT_PATTERN_NAME" datasource="T.FAULT_PATTERN_NAME" operation="right_like"  datatype="1,is_null,100" value="" /></td>
						<td><label>部位名称：</label></td>
						<td><input type="text" id="dia-positionName" name="dia-positionName" datasource="B.POSITION_NAME" operation="like"  datatype="1,is_null,100" value="" /></td>
					</tr>
					<tr>
						<td><label>工时代码：</label></td>
						<td><input type="text" id="dia-timeCode" name="dia-timeCode" datasource="T.TIME_CODE" operation="like"  datatype="1,is_null,100" value="" /></td>
						<td><label>工时名称：</label></td>
						<td><input type="text" id="dia-timeName" name="dia-timeName" datasource="T.TIME_NAME" operation="like"  datatype="1,is_null,100" value="" /></td>
					</tr>
				</table>
				<div class="subBar">
					<ul>
