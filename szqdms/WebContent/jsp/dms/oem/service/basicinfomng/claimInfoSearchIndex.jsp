 ...
 * .ajax表示请求为ajax请求
 */
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/FaultTasktimeMngAction/claimSearch.ajax";
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：基础数据管理&gt;基础信息管理&gt;车辆强保定保查询</h4>
	<div class="page">
			...
			<div class="searchBar" align="left">
				<table class="searchContent" id="tab-search">
					<tr>
						...
						<td><input type="text" id="dia-VIN" name="VIN" datasource="M.VIN" operation="like"  datatype="0,is_null,100" value="" /></td>
					</tr>
				</table>
				<div class="subBar">
					<ul>
