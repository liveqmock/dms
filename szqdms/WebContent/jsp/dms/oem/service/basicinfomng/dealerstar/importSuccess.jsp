...
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/DealerStarMngAction/searchImport.ajax";
...
function doConfirm()
{
	//点击确定按钮，提交后台请求
	try{
		var url = "<%=request.getContextPath()%>/service/basicinfomng/DealerStarMngAction/dealerStarImport.ajax";
		sendPost(url,"doConfirm","",callBack,"true");
	}catch(e){}
}
				...
				<table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
					<thead>
						<tr>
							...
							<th fieldname="DEALER_STAR" >服务站星级代码</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
