...
<title>库管与旧件仓库关系</title>
<script type="text/javascript">
    var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/OldpartWarehouseAreaMngAction/WarehouseSearch.ajax";
	var deleteUrl = "<%=request.getContextPath()%>/service/basicinfomng/OldpartWarehouseAreaMngAction/deleteUser.ajax";
    // 定义弹出窗口样式
    ...
    $(function () {
        ...
        $("#btn-add").bind("click", function (event) {
			$.pdialog.open(webApps + "/jsp/dms/oem/service/basicinfomng/oldpartWarehouseUserEdit.jsp?action=1", "add", "新增仓库与库管关系", diaAddOptions);
        });
    });
    // 列表编辑连接
    function doUpdate(rowobj) {
        $("td input[type=radio]", $(rowobj)).attr("checked", true);
        $.pdialog.open(webApps+"/jsp/dms/oem/service/basicinfomng/oldpartWarehouseUserEdit.jsp?action=2", "update", "修改仓库与库管关系", diaAddOptions);
    }
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif"/>&nbsp;当前位置：基础数据管理 &gt; 基础信息管理 &gt; 库管与旧件仓库关系</h4>
                ...
                <div class="searchBar" align="left">
                    <table class="searchContent" id="tab-searchOldpartWarehouseArea">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="ACCOUNT" name="ACCOUNT" datasource="T.ACCOUNT" datatype="1,is_null,30" operation="like"/></td>
                            <td><label>仓库代码：</label></td>
                            <td><input type="text" id="warehouseCode" name="warehouseCode" datasource="W.WAREHOUSE_CODE" datatype="1,is_null,30" operation="like"/></td>
                            <td><label>仓库名称：</label></td>
                            <td><input type="text" id="warehouseName" name="warehouseName" datasource="W.WAREHOUSE_NAME" datatype="1,is_null,30" operation="like"/></td>
                        </tr>
                    </table>
                    <div class="subBar">
                        <ul>
            ...
            <div id="page_oldpartWarehouseArealist">
                <table style="display:none;width:100%;" id="tab-oldpartWarehouseArealist" name="tablist" ref="page_oldpartWarehouseArealist" refQuery="tab-searchOldpartWarehouseArea">
                    ...
                    <tr>
                        ...
                        <th fieldname="PERSON_NAME">库管姓名</th>
