                    ...
                    <div  style="width:100%;height:300px;overflow:auto;" id="div-fileImportResult">
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
								...
								<th fieldname="OFFICE_ID" >办事处主键</th>
							<th fieldname="VEHICLE_TYPE_NA" >备车类型</th>
							<th fieldname="COST" >费用</th>
							<th fieldname="COSTS_TYPE_NA" >费用类型</th>
							<th fieldname="ORG_CODE" >服务商代码</th>
							<th fieldname="ORG_NAME" >服务商名称</th>
							<th fieldname="END_MILES" >结束里程</th>
							<th fieldname="START_MILES" >开始里程</th>
							<th fieldname="TRAVEL_TIMES_NA" >外出次数</th>
							<th fieldname="TRAVEL_DATE_NA" >外出时间范围</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/TravelCostMngAction/searchImport.ajax";
...
$(function(){
    ...
    $("#doConfirm").click(function() {
        try{
            ...
            var url = "<%=request.getContextPath()%>/service/basicinfomng/TravelCostMngAction/insertImport.ajax?errorDataRowNum="+rowStrNo;
    ...
    $("#btn-importSuccessClose").click(function() {
        try{
            ...
            var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/TravelCostMngAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
...
<%-- function doConfirm()
{
	//点击确定按钮，提交后台请求
	try{
		var url = "<%=request.getContextPath()%>/service/basicinfomng/TravelCostMngAction/insertImport.ajax";
		sendPost(url,"delete","",deleteCallBack,"true");
	}catch(e){}
}
 --%>
