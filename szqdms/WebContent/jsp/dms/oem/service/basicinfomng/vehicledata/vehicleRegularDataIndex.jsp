...
$(function(){
	...
	$("#btn-add").bind("click",function(event){
		...
		$.pdialog.open(webApps+"/jsp/dms/oem/service/basicinfomng/vehicledata/vehicleRegularDataDetail.jsp?action=1", "vehicleEdit", "车辆数据维护", options); 
	});
});
//导入回调方法
function impCall(){
...
function doUpdate(rowobj){
	...
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/oem/service/basicinfomng/vehicledata/vehicleRegularDataDetail.jsp?action=2", "vehicleEdit", "车辆数据维护", options);
}
