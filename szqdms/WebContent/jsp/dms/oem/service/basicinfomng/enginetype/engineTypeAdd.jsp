			...
			<div align="left">
				...
				<input type="hidden" id="dia-status" name="dia-STATUS" datasource="STATUS" value="100201" />			
					<tr>
						...
						<td><input type="text" id="dia-typeCode" name="dia-typeCode"  datasource="TYPE_CODE" datatype="0,is_null,30"  /></td>
				   		<td><label>型号名称：</label></td>
						<td><input type="text" id="dia-typeName" name="dia-typeName"  datasource="TYPE_NAME" datatype="0,is_null,30"  /></td>
				    </tr>	
				</table>
				</fieldset>
			</div>
...
var diaSaveAction = "<%=request.getContextPath()%>/service/basicinfomng/EngineTypeMngAction";
