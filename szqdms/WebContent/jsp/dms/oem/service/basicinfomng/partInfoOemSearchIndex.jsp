 ...
 * .ajax表示请求为ajax请求
 */
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/FaultTasktimeMngAction/partSearch.ajax";
		...
		<div id="gzms">
			<table width="100%" id="tab-list" name="tab-list" style="display: none" ref="gzms" refQuery="tab-search" pageRows="10">
					...
					<tr>
							...
							<th fieldname="F_POSITION_CODE" >部位代码</th>			
							<th fieldname="F_POSITION_NAME" >部位名称</th>
							<th fieldname="SE_CLPRICE" >索赔单价</th>
