...
var searchUrl = "<%=request.getContextPath()%>/service/basicinfomng/TaskAmountMngAction/searchImport.ajax";
...
$(function(){
    ...
    $("#doConfirm").click(function() {
        try{
            ...
            var url = "<%=request.getContextPath()%>/service/basicinfomng/TaskAmountMngAction/insertImport.ajax?errorDataRowNum="+rowStrNo;
    ...
    $("#btn-importSuccessClose").click(function() {
        try{
            ...
            var url = encodeURI("<%=request.getContextPath()%>/service/basicinfomng/TaskAmountMngAction/expTmpErrorData.ajax?errorDataRowNum="+rowStrNo);
...
<%-- function doConfirm()
{
	//点击确定按钮，提交后台请求
	try{
		var url = "<%=request.getContextPath()%>/service/basicinfomng/TaskAmountMngAction/insertImport.ajax";
		sendPost(url,"delete","",deleteCallBack,"true");
	}catch(e){}
}
 --%>
