...
//变量定义
//查询提交方法
var searchUrl = "<%=request.getContextPath()%>/service/preauthMng/PreAuthSearchAction/preAuthOemSearch.ajax";
...
function doDetail(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/service/preauth/preAuthDetail.jsp", "preAuthApply", "预授权明细", options,true);
}
</script>
</head>
<body>
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-preAuth">
					...
					<tr>
						...
						<td>
							<select type="text" id="authorStatus" name="authorStatus" datasource="AU.AUTHOR_STATUS" kind="dic" src="YSQZT" filtercode="300402|300403|300404" datatype="1,is_null,30" value="">
