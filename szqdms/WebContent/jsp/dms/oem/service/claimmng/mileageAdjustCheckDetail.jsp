  			...
  			<div class="page">
				    ...
				    <div id="dia-shgj">
						<table width="100%" id="diaDetailTable" name="diaDetailTable" style="" class="editTable" >
				       		...
				       		<tr>
								...
								<td><a id="diaClaimNo" href="###" style="color: red" onclick="doDetail()"  class="op"></a></td>
							...
							<tr>
								...
								<td colspan="3"><input type="text" id="diaGuaranteeNo" name="diaGuaranteeNo"  datasource="GUARANTEE_NO" value="" readonly="readonly"  /> </td>
							</tr>
							<tr>
								<td><label>原行驶里程：</label></td>
								<td><input type="text" id="diaMileage" name="diaMileage"  datasource="MILEAGE" value=""  readonly="readonly" /></td>
								<td><label>新行驶里程：</label></td>
								<td colspan="3"><input type="text" id="diaMileage" name="diaEnsureMileage"  datasource="ENSURE_MILEAGE" value=""  readonly="readonly" /></td>
							</tr>
							<tr>
								<td><label>申请原因：</label></td>
								<td colspan="5"><textarea id="diaMileageApplyReason" style="width:450px;height:40px;" name="diaMileageApplyReason" datasource="MILEAGE_APPLY_REASON"  datatype="1,is_null,1000"  readonly="readonly"></textarea></td>
							</tr>
						</table>
					</div>
				 	</fieldset>
			        	...
			        	<div align="left">
							...
							<table class="editTable" id="dia-in-DetailTable">
								<tr>
									...
									<td ><textarea id="diaMileageCheckReason" style="width:450px;height:40px;" name="diaMileageCheckReason" datasource="MILEAGE_CHECK_OPINION"  datatype="1,is_null,1000"></textarea></td>
								</tr>
							</table>
				       	 </div>
					</form>		
				...
				<div class="formBar">
					<ul>
						...
						<li><div class="button"><div class="buttonContent"><button type="button" id="dia_reject" >审核驳回</button></div></div></li>
...
var diaSaveAction = "<%=request.getContextPath()%>/service/claimmng/MileageAdjustCheckAction";
var $true=true;
$(function(){
	...
	$("#dia_pass").bind("click",function(){
		...
		var reason =$("#diaMileageCheckReason").val();
		if(reason.length==0){
