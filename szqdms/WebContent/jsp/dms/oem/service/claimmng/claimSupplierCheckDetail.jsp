...
$(function() 
{
	...
	//供应商审核同意
	$("#dia-ty").bind("click",function(){
		//var reason=$("#diaCheckRemarks").val();
		var $f = $("#dia-fm-partInfo");
		var sCondition = {};
		sCondition =$f.combined(1) || {};
		var checkUrl = diaSaveAction + "/claimUpdate.ajax";
		doNormalSubmit($f,checkUrl,"dia-ty",sCondition,diaCheckCallBack);
	});
	
	//意见
	$("#dia-yj").bind("click",function(){
		var reason=$("#diaCheckRemarks").val();
		var $f = $("#dia-fm-partInfo");
		if(reason.length==0){
		...
		var sCondition = {};
		sCondition =$f.combined(1) || {};
		var checkUrl = diaSaveAction + "/claimOptionUpdate.ajax";
		doNormalSubmit($f,checkUrl,"dia-save",sCondition,diaCheckCallBack);
	});
	//上一 步
			...
			<div class="page" >
				<div class="pageContent" id="dia-partInfo" style="overflow-y:auto;overflow-x:hidden">
					<form method="post" id="dia-fm-partInfo" class="editForm" style="width: 99%;">
						...
						<!-- <input type="hidden" id="diaClaimDtlId" name="diaClaimDtlId" datasource="CLAIM_DTL_ID"/> -->
             		...
             		<div class="formBar">
					<ul>
						<li><div class="button"><div class="buttonContent"><button type="button" id="dia-yj">意&nbsp;&nbsp;见</button></div></div></li>
						<li><div class="button"><div class="buttonContent"><button type="button" id="dia-ty">同&nbsp;&nbsp;意</button></div></div></li>
