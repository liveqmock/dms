...
$(function(){
	...
	$("#search").bind("click",function(event){
    	...
    	var url =searchUrl1+"/claimOemOutSearchInfo.ajax?&claimNo="+claimNo;
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="claimOutBuyTable">
						<tr>
							...
							<td><input type="text" id="bscCode" name="bscCode" datasource="G.CODE" datatype="1,is_null,30" value=""  operation="like" /></td>
							...
							<td><input type="text" id="claimNo" name="claimNo"  datatype="1,is_null,30" value="" /></td>
						</tr>	
						<tr>
							<td><label>办事处名称：</label></td>
							<td><input type="text" id="bscName" name="bscName" datasource="G.ONAME" datatype="1,is_null,30" value=""  operation="like" /></td>
						    ...
						    <td >
								...
								<input type="text" id="in-jsrq"  group="in-ckrq,in-jsrq" style="width:75px;margin-left:-30px;" name="in-ckrq" datasource="B.BUY_DATE" datatype="1,is_date,30" kind="date" onclick="WdatePicker()" operation = "<=" />
					   		 </td>
						</tr>
					</table>
					<div class="subBar">
			...
			<table style="display:none;width:100%;" layoutH="250" id="claimOutBuylist" name="claimOutBuylist" ref="preAuth" refQuery="claimOutBuyTable" >
					<thead>
						<tr>
							...
							<th fieldname="BSCCODE" >办事处代码</th>
							<th fieldname="BSCNAME" >办事处名称</th>
							<th fieldname="CODE" >渠道商代码</th>
							<th fieldname="ONAME" >渠道商名称</th>
							<th fieldname="CLAIM_NO" >索赔单号</th>
							<th fieldname="CLAIM_STATUS" >索赔单号</th>
