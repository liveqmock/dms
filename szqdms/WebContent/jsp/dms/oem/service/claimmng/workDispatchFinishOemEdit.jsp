	...
	<div class="pageContent" style="" >
		<form method="post" id="dia-fm-option" class="editForm" style="width:100%;">
			...
			<table class="editTable" id="dia-tb-option">
				<tr>
					...
					<td colspan="3"><input type="text" id="dia-APPLY_USER" name="dia-APPLY_USER" datasource="APPLY_USER" datatype="1,is_null,300" style="width:87%" readonly="readonly"/></td>
				</tr>
				<tr>
				...
				<tr id="out1">
					...
					<td><input type="text"  id="dia-GO_DATE"  name="dia-GO_DATE"   dataSource="GO_DATE" width="30px"  kind="date" datatype="0,is_null,30"  onclick="WdatePicker({isShowWeek:false,doubleCalendar:false,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/></td>
					<td><label>到达时间：</label></td>
					<td><input type="text"  id="dia-ARRIVE_DATE"  name="dia-ARRIVE_DATE"   dataSource="ARRIVE_DATE"   kind="date" datatype="0,is_null,30"   onclick="WdatePicker({isShowWeek:false,doubleCalendar:false,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/></td>
				</tr>
				<tr>
				...
				<tr id="out2">
				    ...
				    <td><input type="text" id="dia-START_LONGITUDE" name="dia-START_LONGITUDE" datasource="START_LONGITUDE" datatype="1,is_null,30"/></td>
					 <td><label>到达经度：</label></td>
				     <td><input type="text" id="dia-END_LONGITUDE" name="dia-END_LONGITUDE" datasource="END_LONGITUDE" datatype="1,is_null,30"/></td>
				</tr>
				<tr id="out3">
				    <td><label>出发纬度：</label></td>
					<td><input type="text" id="dia-START_LATITUDE" name="dia-START_LATITUDE" datasource="START_LATITUDE" datatype="1,is_null,30"/></td>
				    <td><label>到达纬度：</label></td>
				    <td><input type="text" id="dia-END_LATITUDE" name="dia-END_LATITUDE" datasource="END_LATITUDE" datatype="1,is_null,30"/></td>
				</tr>
			</table>
			</fieldset>
			</div>
		...
		<div class="formBar">
			<ul>
				...
				<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-pg">维修完成</button></div></div></li>
