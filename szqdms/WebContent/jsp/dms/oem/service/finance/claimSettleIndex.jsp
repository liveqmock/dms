...
var searchUrl = "<%=request.getContextPath()%>/service/financeMng/ClaimSettleAction/claimSettleSearch.ajax";
var settleUrl = "<%=request.getContextPath()%>/service/financeMng/ClaimSettleAction/settleUpdate.ajax";
//查询按钮响应方法
$(function(){
	$("#search").bind("click",function(){
		var $f = $("#claimSettleform");
		var sCondition = {};
    	sCondition = $f.combined() || {};
		doFormSubmit($f,searchUrl,"search",1,sCondition,"claimSettleList");		
	});
	$("#btn-reset").bind("click", function(event){
		$("#claimSettleform")[0].reset();
		$("#orgCode").attr("code","");
		$("#orgCode").val("");
	});
});
...
function doUpdate(rowobj){
	$row = $(rowobj);
	var url = settleUrl + "?settleId="+$(rowobj).attr("SETTLE_ID");
	sendPost(url,"","",settleCallBack,"true");
}
function settleCallBack(res)
{
	...
	{
		if($row) 
			$("#claimSettleList").removeResult($row);
	}catch(e)
	{
		alertMsg.error(e);
		return false;
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：财务管理&gt;结算管理&gt;索赔结算</h4>
	<div class="page">
	<div class="pageHeader">
		<form id="claimSettleform" method="post">
			<div class="searchBar" align="left">
				<table class="searchContent" id="claimSettleTable">
					<tr>
	...
	<div class="pageContent">
		<div id="claimSettle" >
			<table style="display:none;width:100%;" id="claimSettleList" name="claimSettleList" ref="claimSettle" refQuery="claimSettleTable">
				<thead>
					<tr>
						...
						<th colwidth="160" fieldname="SETTLE_NO" >结算单号</th>
						...
						<th colwidth="60" type="link"  title="[结算]" action="doUpdate">操作</th>
					</tr>
				</thead>
				<tbody>
				</tbody>
