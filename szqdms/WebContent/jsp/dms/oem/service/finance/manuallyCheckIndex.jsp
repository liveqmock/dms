...
var searchUrl = "<%=request.getContextPath()%>/service/financeMng/DealerSettleSetAction/manuallyCheckSearch.ajax";
...
function doCheck(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/oem/service/finance/manuallyCheckEdit.jsp?action=2", "oldPart", "手工帐审核修改", options,true);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：财务管理&gt;结算管理&gt;手工帐审核</h4>
		<div class="page">
				...
				<table style="display:none;width:100%;"  id="manuallyList" name="manuallyList" ref="oldPart" refQuery="oldPartTable" >
					<thead>
						<tr>
							...
							<th colwidth="85" type="link"  title="[审核]" action="doCheck">操作</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
