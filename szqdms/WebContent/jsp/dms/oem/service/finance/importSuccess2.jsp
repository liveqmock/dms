...
var searchUrl = "<%=request.getContextPath()%>/service/financeMng/PaymentAction/settleImpSearch.ajax";
...
{
	//点击确定按钮，提交后台请求
	var url =diaSaveAction+"/settleUpdateImport.ajax";
				...
				<table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
					<thead>
						<tr>
							...
							<th fieldname="PAY_DATE" >付款日期</th>
							<th fieldname="PAY_AMOUNT" align="right" refer="amountFormat">付款金额</th>
							<th fieldname="IF_PAY" >是否已付</th>
