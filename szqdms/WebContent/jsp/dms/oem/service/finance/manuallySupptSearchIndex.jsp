...
var searchUrl = "<%=request.getContextPath()%>/service/financeMng/DealerSettleSetAction/manuallyDealerSearch.ajax";
...
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：财务管理&gt;结算管理&gt;手工帐申请查询</h4>
		<div class="page">
