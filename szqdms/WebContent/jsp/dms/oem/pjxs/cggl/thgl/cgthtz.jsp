...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/thgl/cgthtzmx.jsp", "cgthtzmx", "采购退货调整", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 退货管理   &gt; 采购退货调整</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="in-thlb"  name="in-thlb"  kind="dic" src="E#1=采购退货:2=领用退货" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					    </td>
					</tr>
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th colwidth="105" type="link" title="[调整]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
