...
function doCheck(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/thgl/cgthqrmx.jsp", "cgthqrmx", "退货确认明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 退货管理   &gt; 退货确认</h4>
	<div class="page" >
