...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/htgl/htzlshmx.jsp", "htzlshmx", "合同资料审核明细", options);
}
			...
			<table style="display:none;width:100%;" id="tab-htlb" name="tablist" ref="page_htlb" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th fieldname=""  colwidth="80">企业法人</th>
							<th fieldname=""  colwidth="80">法人联系方式</th>
							<th fieldname=""  colwidth="80">业务联系人</th>
							<th fieldname=""  colwidth="80">业务联系方式</th>
							<th fieldname="" >质保金金额</th>
							<th fieldname="" >质保期</th>
							<th fieldname="" colwidth="130">挂账结算周期（天数）</th>
							<th fieldname=""  colwidth="100">厂家供货周期</th>
							<th fieldname="" >税率</th>
