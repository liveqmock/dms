			...
			<div class="tabsHeader">
				<div class="tabsHeaderContent">
					<ul>
						...
						<li><a href="javascript:void(0)"><span>审核轨迹信息</span></a></li>
  ...
  <div class="page" >
	<div class="pageContent" style="" >
		<form method="post" id="dia-fm-htwh" class="editForm" style="width:100%;">
		  <div align="left">
			  <fieldset>
			            <legend align="right"><a onclick="onTitleClick('dia-tab-htxx')">&nbsp;合同基本信息&gt;&gt;</a></legend>
      ...
      <div class="page">
           <div class="pageContent">				
			 <fieldset>	
				...
				<div id="dia-lpmx" >
						<table style="display:none;width:100%;" id="dia-tab-pjlb"  name="tablist" ref="dia-lpmx" edit="false" >
								<thead>
									<tr>
	 ...
	 <div class="page">
           <div class="pageContent">		
				 <fieldset>
					<legend align="right"><a onclick="onTitleClick('dia-shxx')">&nbsp;审核轨迹信息&gt;&gt;</a></legend>
					<div id="dia-shxx" style="overflow:hidden;">
							<table  id="dia-shgjlb" name="dia-shgjlb" layoutH="200" style="display: none;width:100%;" ref="dia-shxx" edit="false">
								<thead>
									<tr>
										<th>审核人</th>
										<th>审核时间</th>
	...
	<div class="page">
           <div class="pageContent">	
				 <fieldset>
					<legend align="right"><a onclick="onTitleClick('dia-clxx')">&nbsp;合同资料信息&gt;&gt;</a></legend>
					<div id="dia-clxx" style="overflow:hidden;">
							<table  id="dia-zllb" name="dia-zllb"  style="display: none;width:100%;" ref="dia-clxx" edit="false">
								<thead>
									<tr>
...
$(function(){
	$("button.close").click(function(){
	    ...
	    $("#dia-layout").height(document.documentElement.clientHeight-80);
		$("#dia-tab-pjlb").show();
		$("#dia-tab-pjlb").jTable();
		$("#dia-shgjlb").show();
		$("#dia-shgjlb").jTable();
