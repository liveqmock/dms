...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/htgl/htzlscmx.jsp", "htzlscmx", "合同资料上传明细", options);
}
			...
			<table style="display:none;width:100%;" id="tab-htlb" name="tablist" ref="page_htlb" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th fieldname="" >备注</th>
							<th colwidth="80" type="link" title="[上传]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>无</div></td>
							<td><div>备注</div></td>
							<td><a href="#" onclick="doUpdate()" class="op">[上传]</a><a href="#" onclick="doSubmit()" class="op">[提交]</a></td>
						</tr>
						<tr>
