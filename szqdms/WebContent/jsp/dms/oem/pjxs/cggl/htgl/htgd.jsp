			...
			<table style="display:none;width:100%;" id="tab-htlb" name="tablist" ref="page_htlb" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th fieldname="" >税率</th>
							<th fieldname="" colwidth="60">追偿条款</th>
							<th fieldname="" >备注</th>
							<th colwidth="40" type="link" title="[归档]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>无</div></td>
							<td><div>备注</div></td>
							<td><a href="#" onclick="doUpdate()" class="op">[归档]</a></td>
						</tr>
						<tr>
