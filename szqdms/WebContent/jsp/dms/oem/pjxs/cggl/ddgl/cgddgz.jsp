...
function doDetail(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/ddgl/cgddgzmx.jsp", "cgddgzmx", "采购订单查询明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购订单管理   &gt; 采购订单查询</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=已提交:2=已确认:3=已发货" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					     </td>
