...
function doDetail(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/ddgl/cgddfhcxmx.jsp", "cgddfhcxmx", "采购订单发货查询", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购订单管理   &gt; 采购订单发货查询</h4>
	<div class="page" >
