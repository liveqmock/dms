...
function doCheck(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/ddgl/zfddshmx.jsp", "zfddshmx", "直发采购订单审核明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购订单管理   &gt; 直发采购订单审核</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="">制单人</th>
							<th colwidth="105" type="link" title="[审核]"  action="doCheck" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>张三</div></td>
							<td><a href="#" class="op" onclick="doCheck()">[审核]</a></td>
						</tr>
						<tr>
