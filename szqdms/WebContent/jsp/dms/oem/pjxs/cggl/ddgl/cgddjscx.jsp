...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 采购管理  &gt; 采购订单管理   &gt; 采购订单结算查询</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td colspan="5">
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=未结算:2=已结算" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					    </td>
					</tr>
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="" colwidth="60">结算状态</th>
							<th fieldname="" colwidth="65">结算时间</th>
							<th fieldname="" colwidth="60">入库单号</th>
							<th fieldname="" colwidth="65">入库时间</th>
					...
					<tbody>
						<tr>
							...
							<td><div>已结算</div></td>
							<td><div>2014-06-01</div></td>
							<td><div>入库单号1</div></td>
							<td><div>2014-05-28</div></td>
							<td><div>供应商代码1</div></td>
							<td><div>供应商名称1</div></td>
							<td><div>40</div></td>
							<td><div align="right">14,491.60</div></td>
							<td><div>40</div></td>
							<td><div align="right">13,247.20</div></td>
						</tr>
						<tr>
							...
							<td><div>40</div></td>
							<td><div align="right">1,036.80</div></td>
							<td><div>40</div></td>
							<td><div align="right">888.40</div></td>
						</tr>
						<tr>
							...
							<td><div>40</div></td>
							<td><div align="right">14,715.60</div></td>
							<td><div>40</div></td>
							<td><div align="right">12,205.60</div></td>
						</tr>
					</tbody>
			</table>
		</div>
