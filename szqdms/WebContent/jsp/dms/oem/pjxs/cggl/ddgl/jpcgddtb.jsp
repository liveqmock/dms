...
$(function(){
	...
	$("#btn-xz").bind("click",function(event){
		...
		$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/ddgl/jpcgddwh.jsp?action=1", "cgddwh", "军品采购订单新增", options);
	});
});
//列表编辑链接
...
{
	var options = {max:true,mask:true,width:300,height:150,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cggl/ddgl/jpcgddwh.jsp?action=2", "cgddwh", "军品采购订单维护", options);
}
</script>
</head>
<body>
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=军品供应商1:2=军品供应商2:3=军品供应商3" datatype="1,is_null,30" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					...
					<tbody>
						<tr>
							...
							<td><div>月度计划</div></td>
							<td><div>采购</div></td>
							<td><div>军品供应商代码1</div></td>
							<td><div>军品供应商名称1</div></td>
						...
						<tr>
							...
							<td><div>月度计划</div></td>
							<td><div>采购</div></td>
							<td><div>军品供应商代码2</div></td>
							<td><div>军品供应商名称2</div></td>
							<td><div>2014-05-20</div></td>
							<td><div>李四</div></td>
							<td><a href="#" onclick="doReport()" class="op">[提报]</a><a href="#" onclick="doUpdate()" class="op">[编辑]</a><a href="#" class="op" onclick="doDelete()">[删除]</a></td>
						</tr>
						<tr>
							...
							<td><div>月度计划</div></td>
							<td><div>采购</div></td>
							<td><div>军品供应商代码3</div></td>
							<td><div>军品供应商名称3</div></td>
							<td><div>2014-05-20</div></td>
							<td><div>王五</div></td>
							<td><a href="#" onclick="doReport()" class="op">[提报]</a><a href="#" onclick="doUpdate()" class="op">[编辑]</a><a href="#" class="op" onclick="doDelete()">[删除]</a></td>
						</tr>
