...
function doCheck(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/xsgl/ddgl/ddshmx.jsp", "ddshmx", "订单审核", options);
}
</script>
</head>
<body>
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td><input type="text" id="in-ddbh" name="in-ddbh" kind="dic" src="QDJG" multi="true" datasource="DDBH" datatype="1,is_digit_letter,30" operation="right_like"/></td>
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="DDBH" ordertype='local' class="desc">客户名称</th>
