...
function doViewOrderDetail(orderNo)
{
	...
	//top.navTab.openTab(orderNo, webApps + "/jsp/dms/dealer/pjxs/xsgl/ddgl/ddmx.jsp", { title:orderNo, fresh:false, external:true,data:{} });
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 销售管理  &gt; 订单管理   &gt; 订单查询</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=已提报:2=审核驳回:3=审核通过:8=已取消:9=已关闭" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					    </td>
						<td><label>发运状态：</label></td>
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=未发运:2=已发运:3=已签收" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					    </td>
					    <td><label>开票状态：</label></td>
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=未开票:2=已开票" datatype="1,is_null,30" >
					    		<option value="-1" selected>--</option>
					    	</select>
					    </td>
					</tr>
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="DDBH" ordertype='local' class="desc" colwidth="115">订单编号</th>
							<th fieldname="DDLX" >订单类型</th>
							<th fieldname="DDLX" >提报单位</th>
							<th fieldname="GHPJK" >供货配件库</th>
							<th fieldname="GHPJK">是否延期</th>
							<th fieldname="TBSJ" ordertype='local' class="desc" colwidth="130">提报时间</th>
							...
							<th fieldname="ZJE" align="right">应发数量</th>
							<th fieldname="ZJE" align="right">实发数量</th>
							<th fieldname="ZJE" align="right">签收数量</th>
							<th fieldname="DDZT" >订单状态</th>
							<th fieldname="DDZT" >关闭日期</th>
							<th fieldname="DDZT" >开票状态</th>
						</tr>
					</thead>
					<tbody>
						<tr>
