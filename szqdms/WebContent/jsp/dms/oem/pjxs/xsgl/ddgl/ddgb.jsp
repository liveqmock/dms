...
{
	alertMsg.confirm("是否确定订单关闭？订单关闭后，将会扣减账户余额",{okCall:doCloseOrderOk,cancelCall:doCloseOrderCancel});
}
function doCloseOrderOk()
{
}
function doCloseOrderCancel()
{
}
</script>
</head>
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="ZJE" align="right" colwidth="75">审核金额(元)</th>
							<th fieldname="ZJE" align="right" colwidth="75">实发金额(元)</th>
							<th fieldname="ZJE" align="right">审核数量</th>
							<th fieldname="ZJE" align="right">实发数量</th>
							<th fieldname="DDZT" >订单状态</th>
							<th fieldname="DDZT" colwidth="80">关闭日期</th>
							<th fieldname="DDZT" >开票状态</th>
							<th type="link" title="[关闭]"  action="doCloseOrder" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div></div></td>
							<td><div>未开票</div></td>
							<td><a href="#" onclick="doCloseOrder()" class="op">[关闭]</a></td>
						</tr>
						<tr>
