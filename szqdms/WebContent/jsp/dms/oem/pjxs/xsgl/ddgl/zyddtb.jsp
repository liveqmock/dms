...
$(function(){
	...
	$("#btn-xz").bind("click",function(event){
		...
		$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/xsgl/ddgl/zyddwh.jsp?action=1", "ddxxwh", "订单信息新增", options);
	});
});
//列表编辑链接
...
{
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/xsgl/ddgl/zyddwh.jsp?action=2", "ddxxwh", "订单信息维护", options);
}
</script>
</head>
<body>
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td>
					    	<select type="text" id="in-ddzt"  name="in-ddzt" datasource="DDZT" kind="dic" src="E#1=已保存:2=审核驳回" datatype="1,is_null,30" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					...
					<tbody>
						<tr>
							...
							<td><div>ZY20140519002</div></td>
							<td><div>直营订单</div></td>
							<td><div>陕重汽配件公司</div></td>
