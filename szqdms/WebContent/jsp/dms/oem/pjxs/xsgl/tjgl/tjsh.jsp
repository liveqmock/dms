...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/xsgl/tjgl/tjshmx.jsp", "tjshmx", "退件审核明细", options);
}
</script>
</head>
<body>
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					...
					<tbody>
						<tr>
							...
							<td><div>配送中心代码1</div></td>
							<td><div>配送中心名称1</div></td>
						...
						<tr>
							...
							<td><div>退件单号2</div></td>
							<td><div>配件销售公司</div></td>
							<td><div>配送中心代码2</div></td>
							<td><div>配送中心名称2</div></td>
							<td><div>2014-05-20</div></td>
							<td><a href="#" onclick="doUpdate()" class="op">[审核]</a></td>
						</tr>
						<tr>
							...
							<td><div>退件单号3</div></td>
							<td><div>配件销售公司</div></td>
							<td><div>配送中心代码3</div></td>
							<td><div>配送中心名称4</div></td>
							<td><div>2014-05-20</div></td>
							<td><a href="#" onclick="doUpdate()" class="op">[审核]</a></td>
						</tr>
					</tbody>
