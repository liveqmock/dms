		...
		<form method="post" id="di-pjsbmx" class="editForm" >
			...
			<table class="editTable" id="pjsbmxT">
				<tr>
					...
					<td><input type="text" id="FM_FWSDM" name="FM_FWSDM" datatype="1,is_null,100" value="服务商代码1" readonly="readonly"/></td>
					<td><label>服务商名称：</label></td>
					<td><input type="text" id="FM_FWSMC" name="FM_FWSMC" datatype="1,is_null,100" value="服务商名称1" readonly="readonly" /></td>
			    </tr>
				<tr>
