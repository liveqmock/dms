...
function doEdit(row){
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/ccgl/zxgl/zxqdwh.jsp", "zxqdwh", "装箱清单维护", options);
}
//列表审核链接
function doDr(row)
{
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 仓储管理  &gt; 装箱管理   &gt; 装箱清单导入</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th colwidth="80" type="link" title="[装箱清单维护]"  action="doEdit">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><a href="#" onclick="doEdit()" class="op">[装箱清单维护]</a></td>
						</tr>
						<tr>
