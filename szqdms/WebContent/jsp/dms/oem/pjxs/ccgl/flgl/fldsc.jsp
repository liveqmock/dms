...
function doCheck(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/ccgl/flgl/fldscmx.jsp", "fldmx", "发料明细", options,true);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 仓储管理  &gt; 发料单管理   &gt; 打印发料单</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th colwidth="70" type="link" title="[打印发料单]"  action="doCheck">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><a href="#" onclick="doCheck()" class="op">[打印发料单]</a></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="display:none;"><div><input type="radio" name="in-xh" /></div></td>
							<td><div><a style="color:red;" onclick="doViewOrderDetail('YD20140519002');">ZD20140519002</a></div></td>
							<td><div>周度订单</div></td>
							<td><div>河南配送中心</div></td>
							<td><div>2014-05-19 8:30:26</div></td>
							<td><div>张三</div></td>
