...
<div id="dia-layout" style="width:100%;">
	<div class="page">
		...
		<div class="formBar">
			<ul>
				<li><div class="button"><div class="buttonContent"><button id="dia-print" type="button">打印发料单</button></div></div></li>
				<li><div class="button"><div class="buttonContent"><button id="dia-printJt" type="button">打印配件胶贴</button></div></div></li>
