...
$(function(){
	$("#dia-save").bind("click",function(){
		alertMsg.info("保存成功.");
		if($("#dia-pdlx").attr("code")==1){
			$("#qbpj").attr("style","display:");
			$("#dia-tab-pjlb").show();
			$("#dia-tab-pjlb").jTable();
		}
		if($("#dia-pdlx").attr("code")==2){
...
<div id="dia-layout">
	...
	<div class="pageContent" >
		...
		<div id="dia-pjmx" style="height:290px;overflow:hidden;">
			...
			<div id="bfpj" style="display:none;">
			<table style="display:none;width:100%;" id="dia-tab-pjbflb" layoutH="350" name="tablist" ref="dia-pjmx" pageRows="15" >
					<thead>
						<tr>
							<th type="single" fieldname="ROWNUMS" name="XH" style="display:" append="plus|addPjmx"></th>
							...
							<th fieldname="ZXBZSL">库位</th>
							<th fieldname="ZXBZSL">库管员</th>
							<th colwidth="70" type="link" title="[删除]"  action="doDelete" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
