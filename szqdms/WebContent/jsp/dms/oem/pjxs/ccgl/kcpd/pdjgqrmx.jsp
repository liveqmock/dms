...
<div id="dia-layout">
	...
	<div class="pageContent" >
		...
		<div class="formBar">
			<ul>
				<li><div class="buttonContent" align="left">确认意见：<input style="width:300px;" type="text" datatype="0,is_null,100"/></div></li>
				<li><div class="button"><div class="buttonContent"><button class="close" id="dia-pass" type="button">确认通过</button></div></div></li>
				<li><div class="button"><div class="buttonContent"><button class="close" id="dia-nopass" type="button">确认驳回</button></div></div></li>
