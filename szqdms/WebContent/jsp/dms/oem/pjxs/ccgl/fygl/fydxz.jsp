	...
	<div class="page">
		...
		<form method="post" id="fm-ddcx">
			<div class="searchBar" align="left" >
				<fieldset>
				<legend align="right"><a onclick="onTitleClick('tab-fydwh')">&nbsp;发运单编辑&gt;&gt;</a></legend>
				<table class="editTable" id="tab-fydwh">
					<tr>
						<td><label>发运单号：</label></td>
					    <td><input type="text" id="mx-ddbh" name="mx-ddbh" readonly datasource="DDBH" datatype="1,is_null,30" value="系统自动生成"/></td>
					    <td><label>承运单位：</label></td>
					    <td>
					    	<input type="text" id="mx_ddlx"  name="mx_ddlx" kind="dic" src="E#WL1=物流公司一:WL2=物流公司二" datasource="DDLX" datatype="1,is_null,30"  value="物流公司一"/>
					    </td>
					</tr>
					<tr>
					    <td><label>联系人：</label></td>
					    <td><input type="text" id="mx_shy" name="mx_shy" datasource="DDBH" datatype="1,is_null,30"  value="李四"/></td>
					    <td><label>联系电话：</label></td>
					    <td><input type="text" id="mx_tbdw" name="mx_tbdw" datasource="DDBH" datatype="1,is_null,30"  value="13344335566"/></td>
					</tr>
					<tr>
					    <td><label>备注：</label></td>
					    <td colspan="3"><textarea id="mx_shrq" name="mx_shrq" style="width:460px;" datasource="DDBH" datatype="1,is_null,30">请发运</textarea></td>
					</tr>
				</table>
				</fieldset>
			</div>
		...
		<div class="pageContent" >
			<div id="dia-fldmx" style="height:210px;overflow:auto;">
				...
				<thead>
					<tr>
						<th type="single" fieldname="ROWNUMS" name="XH" style="display:" append="plus|addFydmx"></th>
						<th fieldname="PJMC" freadonly="true">订单编号</th>
						...
						<th colwidth="150" type="link" title="[打印发运通知单]|[删除]"  action="doPrint|doDelete" >操作</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td><div><a href="#" onclick="doPrint()" class="op">[打印发运通知单]</a><a href="#" onclick="doDelete()" class="op">[删除]</a></div></td>
					</tr>
					<tr >
