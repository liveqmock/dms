...
function toDetail(fydh)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/ccgl/fygl/fydmx.jsp", "fldmx", "发运单信息维护", options,true);
}
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="GHPJK" >联系电话</th>
							<th fieldname="TBSJ">制单人</th>
							<th fieldname="SHY" colwidth="120">制单日期</th>
							<th fieldname="SHY" colwidth="120">出库日期</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div><a style="color:red;" onclick="toDetail('FYD20140519001');">FYD20140519001</a></div></td>
							<td><div>物流公司一</div></td>
							<td><div>王五</div></td>
							...
							<td><div>张三</div></td>
							<td><div>2014-05-20 08:30</div></td>
							<td><div>2014-05-20 12:30</div></td>
						</tr>
						<tr>
							<td class="rownums"><div>2</div></td>
							<td style="display:none;"><div><input type="radio" name="in-xh" /></div></td>
							<td><div><a style="color:red;" onclick="toDetail('FYD20140519001');">FYD20140519002</a></div></td>
							<td><div>物流公司二</div></td>
							<td><div>王五</div></td>
							<td><div>029-85850355</div></td>
							<td><div>陕A-B1234</div></td>
