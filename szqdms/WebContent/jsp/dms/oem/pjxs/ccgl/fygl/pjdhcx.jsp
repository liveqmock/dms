...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 仓储管理  &gt; 发运管理   &gt; 配件到货查询</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="TBR">提报单位</th>
							<th fieldname="DDBH" colwidth="120">发运单号</th>
							<th fieldname="DDBH">承运商</th>
							<th fieldname="DDBH">司机</th>
							<th fieldname="DDBH">联系电话</th>
							<th fieldname="DDBH" colwidth="120">发运日期</th>
							<th fieldname="ZJE">实发数量</th>
							<th fieldname="ZJE">签收数量</th>
							<th fieldname="ZJE" colwidth="120">签收日期</th>
							<th fieldname="DDZT" colwidth="120">签收回执</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>承运商一</div></td>
							<td><div>张三</div></td>
							<td><div>13325335678</div></td>
							<td><div>2014-05-30 12:50</div></td>
							<td><div>50</div></td>
							<td><div>50</div></td>
							<td><div>2014-06-02 10:25</div></td>
							<td><div>如数收到</div></td>
						</tr>
						<tr>
