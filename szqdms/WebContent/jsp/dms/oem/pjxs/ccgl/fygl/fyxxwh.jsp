...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/ccgl/fygl/fyxxmxwh.jsp", "fldmx", "发运单信息维护", options,true);
}
function doSubmit(){
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 仓储管理  &gt; 发运管理   &gt; 发运单信息维护</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-ddlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th colwidth="120" type="link" title="[承运信息维护]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><a href="#" onclick="doUpdate()" class="op">[承运信息维护]</a></td>
						</tr>
						<tr>
