...
$(function()
{
	...
	$("#dia-upload").bind("click",function(){
		alertMsg.info("上传装车照片附件.");
		return false;
	});
	$("#dia-submit").bind("click",function(){
		alertMsg.confirm("确认发运出库?",{okCall:doSave,cancelCall:doSaveCell});
		return false;
	});
	//设置高度
	...
	<div class="page">
		...
		<form method="post" id="fm-ddcx">
			<div class="searchBar" align="left" >
				...
				<fieldset>
				<legend align="right"><a onclick="onTitleClick('tab-fydwh')">&nbsp;承运信息&gt;&gt;</a></legend>
				<table class="editTable" id="tab-fydwh">
					<tr>
						<td><label>承运车辆：</label></td>
					    <td><input type="text" id="mx-ddbh" name="mx-ddbh" readonly datasource="DDBH" datatype="1,is_null,30" value="陕A-B1234"/></td>
					    <td><label>承运司机：</label></td>
					    <td><input type="text" id="mx_ddlx"  name="mx_ddlx"  readonly datasource="DDLX" datatype="1,is_null,30"  value="李四"/></td>
					    <td><label>联系电话：</label></td>
					    <td><input type="text" id="mx_ddlx"  name="mx_ddlx" readonly datasource="DDLX" datatype="1,is_null,30"  value="13636739298"/></td>
					</tr>
					<tr>
					    <td><label>承运备注：</label></td>
					    <td colspan="3"><textarea id="mx_shrq" name="mx_shrq" readonly style="width:460px;" datasource="DDBH" datatype="1,is_null,30">收到</textarea></td>
					</tr>
				</table>
				</fieldset>
			</div>
		...
		<div class="pageContent" >
			<div id="dia-fldmx" style="height:180px;overflow:auto;">
...
<div class="formBar">
	<ul>
		<li><div class="button"><div class="buttonContent"><button id="dia-print" type="button">打印运输回执</button></div></div></li>
		<li><div class="button"><div class="buttonContent"><button id="dia-upload" type="button">上传附件</button></div></div></li>
		<li><div class="button"><div class="buttonContent"><button id="dia-submit" type="button">发运出库</button></div></div></li>
