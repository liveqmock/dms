...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cwgl/gyskpgl/gyskpmx.jsp", "gyskpmx", "供应商开票明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 财务管理&gt;供应商管理&gt;供应商开票</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th colwidth="85" type="link" title="[开票]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>0</div></td>
							<td><div>14,491.60</div></td>
							<td><a href="#" onclick="doUpdate()" class="op">[开票]</a></td>
						</tr>
					</tbody>
			</table>
		</div>
