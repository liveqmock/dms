...
function doDetail(id)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cwgl/gyskpgl/kpshmx.jsp", "kpshmx", "开票明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 财务管理&gt;供应商管理&gt;开票查询</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="" colwidth="60">状态</th>
						</tr>
					</thead>
					<tbody>
						<tr>
