...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/pjxs/cwgl/flgl/fltzmx.jsp", "fltzmx", "返利调整", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：财务管理&gt;返利管理&gt;返利调整</h4>
	<div class="page">
