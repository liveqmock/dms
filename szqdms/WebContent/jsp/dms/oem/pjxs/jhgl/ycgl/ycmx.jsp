		...
		<form method="post" id="di_ycmxfm" class="editForm" >
			...
			<table class="editTable" id="di_ycmxT">
				<tr>
					...
					<td><input type="text" id="DI_PSZXDM" name="DI_PSZXDM" value="配送中心代码1" readonly="readonly"/></td>
					<td><label>配送中心名称：</label></td>
					<td><input type="text" id="DI_PSZXMC" name="DI_PSZXMC" value="配送中心名称1" readonly="readonly"/></td>
				</tr>
				<tr>	
