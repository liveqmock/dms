...
var searchUrl = "<%=request.getContextPath()%>/service/financeMng/SettleInvoicePrintAction/settleInvoicePrintSearch.ajax";
var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
//查询按钮响应方法
$(function(){
	$("#search").click(function(){
		var $f = $("#settleInvoicePrintform");
		var sCondition = {};
    	sCondition = $f.combined() || {};
		doFormSubmit($f,searchUrl,"search",1,sCondition,"settleInvoicePrintList");
	});
});
function doUpdate(rowobj){
	$("td input[type=radio]",$(rowobj)).attr("checked",true);
	window.open(webApps+"/jsp/dms/dealer/service/finance/settleInvoicePrintDetail.jsp","newwindow","scrollbars=yes,width=800,height=500,top="+(screen.availHeight-500)/2+",left="+(screen.availWidth-800)/2);
	//$.pdialog.open(webApps+"/jsp/dms/dealer/service/finance/settleInvoicePrintDetail.jsp", "printDetail", "结算发票打印", options,true);
}
//金额格式化
...
<div id="layout" style="width:100%;">
	...
	<div class="pageHeader">
		<form id="settleInvoicePrintform" method="post">
			<div class="searchBar" align="left">
				<table class="searchContent" id="settleInvoicePrintTable">
					<tr>
	...
	<div class="pageContent">
		<div id="settleInvoicePrint" >
			<table style="display:none;width:100%;" id="settleInvoicePrintList" name="settleInvoicePrintList" ref="settleInvoicePrint" refQuery="settleInvoicePrintTable">
				<thead>
					<tr>
						<th type="single" name="XH" style="display:none" ></th>
						<th fieldname="SETTLE_NO" ordertype="local" class="desc" >结算单号</th>
