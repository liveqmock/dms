...
var searchUrl = "<%=request.getContextPath()%>/service/claimmng/WorkDispatchMngAction/searchWorkOrder.ajax";
var deleteUrl = "<%=request.getContextPath()%>/service/claimmng/WorkDispatchMngAction/resetSTATUS.ajax";
//定义弹出窗口样式
...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/service/claimmng/WorkDispatchAdd.jsp?action=2", "WorkDispatch", "服务派工信息", options);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 索赔管理  &gt; 工单管理   &gt; 服务派工</h4>
	<div class="page" >
