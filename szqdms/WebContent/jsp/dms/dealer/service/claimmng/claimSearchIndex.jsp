...
var searchUrl = "<%=request.getContextPath()%>/service/claimmng/ClaimSearchAction/claimDelSearch.ajax";
//查询按钮响应方法
$(function(){
	//查询方法
	...
	$("#export").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/claimmng/ClaimSearchAction/dealerDownload.do");
		$("#exportFm").submit();
	});
});
//vin连接
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="claimSearchTable">
						<tr>
							...
							<td><select type="text" id="claimStatus" name="claimStatus" datasource="SC.CLAIM_STATUS" datatype="1,is_null,6" operation="like"  class="combox" kind="dic" src="SPDZT" filtercode="301002|301003|301004|301005|301006|301007|301009|301015">
			...
			<table style="display:none;width:100%;" layoutH="250" id="claimSearchlist" name="claimSearchlist" ref="preAuth" refQuery="claimSearchTable" >
					<thead>
						<tr>
							...
							<th fieldname="STOCK_MEET" >办事处审核</th>
