...
var searchUrl = "<%=request.getContextPath()%>/service/claimmng/ClaimReApplyAction/claimSearch.ajax";
...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/service/claimmng/claimReApplyDetail.jsp", "claimReApplyDetail", "重新提交申请", options);
}
...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 索赔管理  &gt; 索赔管理   &gt; 重新提单申请</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="claimReApplyList" name="claimReApplyList" ref="claimReApply" refQuery="claimReApplyTable" >
					<thead>
						<tr>
							...
							<th fieldname="REAPPLY_STATUS"  >重新申请状态</th>
							<th colwidth="45" type="link" title="[申请]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
