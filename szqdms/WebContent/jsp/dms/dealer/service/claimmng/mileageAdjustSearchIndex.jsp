...
var searchUrl = "<%=request.getContextPath()%>/service/claimmng/MileageAdjustSearchAction/claimSearch.ajax";
$(function(){
			...
			<table style="display:none;width:100%;" id="mileageAdjustList" name="mileageAdjustList" ref="mileageAdjust" refQuery="tab-mileageAdjust" >
				<thead>
					<tr>
						...
						<th fieldname="VIN" colwidth="130" refer="vehicleInfoLink">VIN</th>
