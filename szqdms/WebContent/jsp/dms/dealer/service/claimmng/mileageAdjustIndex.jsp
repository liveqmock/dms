...
var searchUrl = "<%=request.getContextPath()%>/service/claimmng/MileageAdjustAction/claimSearch.ajax";
$(function(){
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/service/claimmng/mileageAdjustDetail.jsp", "mileageAdjust", "里程调整申请", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 索赔管理  &gt; 索赔管理   &gt; 里程调整申请</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="mileageAdjustList" name="mileageAdjustList" ref="mileageAdjust" refQuery="tab-mileageAdjust" >
				<thead>
					<tr>
						...
						<th fieldname="MILEAGE" >里程数</th>
						<th colwidth="105" type="link" title="[申请]"  action="doUpdate" >操作</th>
					</tr>
				</thead>
				<tbody>
				</tbody>
