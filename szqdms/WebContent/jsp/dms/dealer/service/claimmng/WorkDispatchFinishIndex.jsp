...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/service/claimmng/WorkDispatchFinishAdd.jsp?action=2", "WorkDispatchFinish", "维修完成信息", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<div class="pageHeader" >
		<form id="fm-search" method="post">
			...
			<input type="hidden" id="WORK_STATUS" name="WORK_STATUS" datasource="T.WORK_STATUS" value="302202"/>
