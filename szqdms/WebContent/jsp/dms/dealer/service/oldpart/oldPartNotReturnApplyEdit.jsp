...
var diaAction = "<%=request.getContextPath()%>/service/oldpartMng/OldPartNotReturnApplyAction"; 
...
$(function(){
	...
	var Url =diaAction+"/searchOldPart.ajax?&cId="+cId;
