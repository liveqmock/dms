...
var searchUrl = "<%=request.getContextPath()%>/service/oldpartMng/OldPartSearchAction/oldPartSearch.ajax";
...
$(function(){
	...
	$("#btn-download").bind("click",function(){
		...
		$("#exportFm").attr("action","<%=request.getContextPath()%>/service/oldpartMng/OldPartSearchAction/download1.do");
		$("#exportFm").submit();
	});
});
//回运单号反回 a标签
		...
		<div class="pageHeader">
			<form id="oldPartform" method="post">
				<div class="searchBar" align="left">
					...
					<input type="hidden" id="orderStatus" name="orderStatus" datasource="RO.ORDER_STATUS" operation="in" value="302505,302506"/>
					<input type="hidden" id="orgId" name="orgId" datasource="C.ORG_ID" operation="=" value="<%=orgId%>"/>
						<tr>
				...
				<table style="display:none;width:100%;"  id="oldPartList" name="oldPartList" ref="oldPart" refQuery="oldPartTable" >
					<thead>
						<tr>
							...
							<th  fieldname="OUGHT_COUNT">件数</th>
							<th  fieldname="MISS_COUNT">未回运件数</th>
							<th  fieldname="ACTUL_COUNT">待审数量</th>
							<th  fieldname="ZFSL">作废数量</th>
							<th  fieldname="TGSL">审核通过数量</th>
