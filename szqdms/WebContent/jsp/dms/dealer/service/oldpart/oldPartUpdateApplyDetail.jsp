...
<div id="oldPartDetail" style="width:100%;">
	...
	<div class="pageContent" style="" >
		<form method="post" id="dia-Detailfm" class="editForm" >
			...
			<legend align="right"><a onclick="onTitleClick('dia-DetailTable')">&nbsp;原旧件信息&gt;&gt;</a></legend>
				<table class="editTable" id="dia-DetailTable">
					...
					<tr id="shyj" style="display:none">
						<td><label>审核意见：</label></td>
						<td colspan="5"><textarea id="dia-opinion" style="width:450px;height:40px;" name="dia-opinion" datasource="UPDATE_OPINION"  datatype="1,is_null,1000" readonly="readonly"></textarea></td>
					</tr>
				</table>
			</fieldset>
			</div>
			...
			<legend align="right"><a onclick="onTitleClick('dia-DetailUpdateTable')">&nbsp;修改旧件信息&gt;&gt;</a></legend>
				<table class="editTable" id="dia-DetailUpdateTable">
					...
					<tr>
						...
						<td colspan="3"><input type="text" id="updatePartCount" name="updatePartCount" datasource="UPDATE_PART_COUNT"  datatype="0,is_digit,10"/></td>
					</tr>
					<tr>
						<td><label>备注：</label></td>
						<td colspan="3"><textarea id="dia-remarks" style="width:450px;height:40px;" name="dia-remarks" datasource="UPDATE_REMARKS"  datatype="0,is_null,1000"></textarea></td>
					</tr>
				</table>
			</fieldset>
			</div>
		...
		<div class="formBar">
			<ul>
				<li><div class="button"><div class="buttonContent"><button type="button"  id="save">申&nbsp;&nbsp;请</button></div></div></li>
...
$(function()
{
	...
	if(selectedRows[0].attr("UPDATE_STATUS") == <%=DicConstant.JJXGSQZT_03%>){
		$("#shyj").show();	
	}
	...
	$("#save").bind("click",function(){
		...
		var updateUrl = diaSaveAction + "/claimOldPartUpdate.ajax";
