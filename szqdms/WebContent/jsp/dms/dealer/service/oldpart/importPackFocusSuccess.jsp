...
var bParams='<%=bParams%>';
var searchUrl = "<%=request.getContextPath()%>/service/oldpartMng/OldPartReturnAction/searchImport.ajax";
var diaSaveAction = "<%=request.getContextPath()%>/service/oldpartMng/OldPartReturnAction";
$(function(){
...
{
	//点击确定按钮，提交后台请求
	var url =diaSaveAction+"/oldPartPackFocusImport.ajax";
...
function importCallBack(res){
	...
	try
	{
		//parent.$("#search").trigger("click");//调用父jsp方法
