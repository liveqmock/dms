...
var searchUrl = "<%=request.getContextPath()%>/service/oldpartMng/OldPartUpdateApplyAction/oldPartUpdateSearch.ajax";
...
function doView(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/oem/service/oldpart/oldUpdateSearchDetail.jsp", "olpPartUpdate", "旧件修改查询", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 旧件管理  &gt; 旧件管理   &gt; 旧件修改查询</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="oldPartList" name="oldPartList" ref="oldPart" refQuery="tab-oldPart" >
					<thead>
						<tr>
							...
							<th fieldname="UPDATE_STATUS">申请状态</th> 
							<th colwidth="105" type="link" title="[查看]"  action="doView" >操作</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
