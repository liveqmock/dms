...
var searchUrl = "<%=request.getContextPath()%>/service/oldpartMng/OldPartUpdateApplyAction/oldPartSearch.ajax";
...
function doUpdate(rowobj)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/service/oldpart/oldPartUpdateApplyDetail.jsp", "olpPartUpdate", "旧件修改", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 旧件管理  &gt; 旧件管理   &gt; 旧件修改申请</h4>
	<div class="page" >
