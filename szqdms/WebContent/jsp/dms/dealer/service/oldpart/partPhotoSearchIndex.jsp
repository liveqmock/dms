...
function doAudit(rowobj)
{
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/service/oldpart/supplierPartPhotoSearch.jsp", "photoCheck", "配件照片审核", diaAddOptions,true);
}
			...
			<table style="display:none;width:100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-htcx" >
					<thead>
						<tr>
							...
							<th colwidth="180" type="link" title="[配件照片]"  action="doAudit" >操作</th>
						</tr>
					</thead>
			</table>
		</div>
