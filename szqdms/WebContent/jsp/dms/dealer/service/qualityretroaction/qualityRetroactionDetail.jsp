		...
		<div class="tabsContent" >
			...
			<div class="pageContent" style="" >
				<form method="post" id="dia-fm-qualityRetroactionReport" class="editForm" style="width: 99%;">
					...
					<div align="left">
					<fieldset>
					<table style="width: 99%" id="nr">
						<tr>
							<td rowspan="2" colspan="2">信息</td>
							<td><label>单位名称：</label></td>
							<td><input type="text" id="comName" name="comName" datasource="COM_NAME" value="" readonly="readonly" /></td>
							<td><label>传真：</label></td>
							<td colspan="3"><input type="text" id="dia-fax" name="dia-fax" datasource="FAX" readonly="readonly" /></td>
						</tr>
						<tr>
							<td><label>姓名：</label></td>
							<td><input type="text" id="dia-name" name="dia-name" datasource="NAME" readonly="readonly"/></td>
							<td><label>电话：</label></td>
							<td colspan="3"><input type="text" id="dia-tel" name="tel" datasource="TEL" readonly="readonly"/></td>
						</tr>
						<tr>
					...
					<table width="100%" id="clyjlb" name="clyjlb" ref="clyj"  style="display: none" >
						<thead>
							<tr>
								...
								<th fieldname="CREATE_TIME" >处理时间</th>
							</tr>
						</thead>
				</table>
				</div>
