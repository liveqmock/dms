...
$(function() 
{
	$("#layout").height(document.documentElement.clientHeight-70);
	...
	$("button.close").click(function() {
		parent.$.pdialog.close("qualityRetroactionDetail");
		return false;
	});
	//驳回
	$("#dia-reject").bind("click",function(){
		...
		//获取需要提交的form对象
		var $rejectRemark = $("#rejectRemarks").val();
		if($rejectRemark==null||$rejectRemark==""){
			alertMsg.warn("请填写驳回意见!");
			return false;
		}
		//将需要提交的内容拼接成json
		sCondition = $("#dia-fm-qualityRetroactionReport").combined(1) || {};
		var rejectUrl = diaSaveAction + "/qualityretroactionReject.ajax?fbackId="+fbackId+"";
		doNormalSubmit($f,rejectUrl,"dia-reject",sCondition,diaCallBack);
	});
	//关闭
	$("#dia-close").bind("click",function(){
		...
		var $f = $("");
		//将需要提交的内容拼接成json
		var rejectUrl = diaSaveAction + "/qualityretroactionClose.ajax?fbackId="+fbackId+"";
		doNormalSubmit($f,rejectUrl,"dia-close",diaCallBack);
	});
	//上一步
		...
		switch (parseInt($tabs.attr("currentIndex"))) 
		{
			...
			case 1: 
				if($clyjtrue){
					...
					var sCondition = {};
			    	sCondition = $f.combined() || {};
			    	var searchDealRemarksUrl =diaSaveAction+"/searchDealRemarks.ajax?&&fbackId="+$("#fbackId").val();
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li id="clyjH"><a href="javascript:void(0)"><span>处理意见</span></a></li>
				</ul>
			</div>
		</div>
		<div class="tabsContent" >
				...
				<form method="post" id="dia-fm-qualityRetroactionReport" class="editForm" style="width: 99%;">
					...
					<table class="editTable" id="nr">
						...
						<tr>
							...
							<td colspan="7"><textarea class="" rows="2" id="rejectRemarks" name="rejectRemarks" datasource="REJECT_REMARKS" style="width:100%" datatype="1,is_null,1000" ></textarea></td>
						</tr>
					</table>
					<br/>
					...
					<table width="100%" id="sbjjpjlb" name="sbjjpjlb" multivals="partDeleteVal" ref="sbjjpjl"  style="display: none"  refQuery="fm-sbjjpjTable">
						<thead>
							<tr>
								...
								<th fieldname="UNIT_PRICE"  colwidth="60" align="right">单价(元)</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
			...
			<form id="fm-clyj" method="post">
				<div class="searchBar" align="left">
					<div class="subBar">
						<ul>
							<li id="dia-close_li"><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-close">反&nbsp;馈&nbsp;关&nbsp;闭&nbsp;</button></div></div></li>
					...
					<table width="100%" id="clyjlb" name="clyjlb" ref="clyj"  style="display: none" >
						<thead>
							<tr>
								...
								<th fieldname="DEAL_REMARKS" >处理意见</th>
								<th fieldname="DEAL_DATE" >处理时间</th>
							</tr>
						</thead>
				</table>
				</div>
