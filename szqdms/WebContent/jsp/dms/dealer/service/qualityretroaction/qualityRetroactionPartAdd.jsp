    ...
    <div class="page">
        ...
        <div class="pageContent">
                ...
                <table style="display:none;width:100%;" multivals="partVals" id="tab-partList" name="tablist" ref="div-partList"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th fieldname="PART_NO">配件图号</th>
                            <th fieldname="PART_CODE">配件代码</th>
                            <th fieldname="PART_NAME">配件名称</th>
                            <th fieldname="SUPPLIER_NAME">供应商名称</th>
                            <th fieldname="SE_CLPRICE">配件金额 </th>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td>
                                ...
                                <textarea style="width:400px;height:10px; display:none" id="part-val6" name="multivals" readOnly></textarea>
                                <textarea style="width:400px;height:10px; display:none" id="part-val7" name="multivals" readOnly></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <form id="fm-partInfo">
                ...
                <input type="hidden" id="fbackIdHI" name="fbackIdHI" datasource="FBACK_ID"/>
                <input type="hidden" id="salePrice" name="salePrice" datasource="SALE_PRICE"/>
                <input type="hidden" id="supplierId" name="supplierId" datasource="SUPPLIER_ID"/>
                <input type="hidden" id="supplierCode" name="supplierCode" datasource="SUPPLIER_CODE"/>
                <input type="hidden" id="supplierName" name="supplierName" datasource="SUPPLIER_NAME"/>
            </form>
        </div>
    </div>
</div>
...
var diaSaveAction = "<%=request.getContextPath()%>/service/qualityretroaction/QualityretroactionMngAction";
    //弹出窗体
    var partSelWin = $("body").data("qualityretroactionPart");
    $(function () {
        ...
        $("#btn-searchPart").bind("click", function (event) {
            ...
            var searchUrl =diaSaveAction+"/searchPart.ajax?&fbackId="+$("#fbackId").val();
        ...
        $('#btn-confirmPart').bind('click',function(){
            ...
            if(!partIds){
                ...
                $('#supplierId').val($('#part-val3').val());
                $('#supplierCode').val($('#part-val4').val());
                $('#supplierName').val($('#part-val5').val());
                $('#quantity').val($('#part-val6').val());
                $('#salePrice').val($('#part-val7').val());
                $('#fbackIdHI').val($("#fbackId").val());
                //获取需要提交的form对象
                var $f = $("#fm-partInfo");
