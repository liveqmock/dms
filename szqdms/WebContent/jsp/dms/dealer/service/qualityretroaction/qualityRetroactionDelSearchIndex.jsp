...
var searchUrl = "<%=request.getContextPath()%>/service/qualityretroaction/QualityretroactionMngAction/qualityretroactionDelSearch.ajax";
//查询按钮响应方法
$(function(){
	//查询方法
...
function detail(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/service/qualityretroaction/qualityRetroactionDetail.jsp?", "qualityRetroactionDetail", "质量反馈明细", options,true); 
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：质量反馈管理&gt;质量反馈管理&gt;质量反馈查询</h4>
		<div class="page">
			...
			<table style="display:none;width:100%;" layoutH="250" id="qualityRetroactionlist" name="qualityRetroactionlist" ref="preAuth" refQuery="dispatchPartTable" >
					<thead>
						<tr>
							...
							<th colwidth="145" type="link" title="[明细]"  action="detail" >操作</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
