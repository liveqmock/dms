...
//变量定义
//查询提交方法
var searchUrl = "<%=request.getContextPath()%>/service/milesPolicy/MilesPolicyReportAction/milesPolicyOemSearch.ajax";
//初始化方法
$(function(){
	//查询方法
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-preAuth">
					...
					<tr>
						...
						<td><input type="text" id="orgCode" name="orgCode" datasource="TG.ORG_ID" datatype="1,is_null,100" operation="in" value="" hasBtn="true" callFunction="showOrgTree('orgCode',2)" readonly="readonly"/></td>
					</tr>
					<tr>
