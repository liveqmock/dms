	...
	<div class="pageContent" style="" >
		<form method="post" id="di-vinCh" class="editForm" >
			...
			<table class="editTable" id="di_tab_vinCh">
				...
				<input type="hidden" id="dia-di-vehicle_use_code" name="dia-di-vehicle_use_code"  datasource="VEHICLE_USE" value="" readonly="readonly" />
				<input type="hidden" id="dia-di-user_type_code" name="dia-di-user_type_code" datasource="USER_TYPE" value="" readonly="readonly" />
				...
				<tr>
					...
					<td><input type="text" id="dia-di-user_type" name="dia-di-user_type" datasource="USERNAME"  value="" readonly="readonly" /></td>
				</tr>
				<tr>
					<td><label>车辆用途：</label></td>
					<td><input type="text" id="dia-di-vehicle_use" name="dia-di-vehicle_use"  datasource="VEHICLEUSENAME" value="" readonly="readonly" /></td>
					<td><label>驱动形式：</label></td>
					<td><input type="text" id="dia-di-drive_form" name="dia-di-drive_form" datasource="DRIVENAME" value="" readonly="readonly" /></td>
...
var vinChUrl="<%=request.getContextPath()%>/service/milesPolicy/MilesPolicyReportAction/milesPolicyVinCheck.ajax";
$(function()
{	
...
function searchCallBack(res){
	try
	{
		...
		if(rows && rows.length > 0)
		{
			...
			//var a =getNodeText(rows[0].getElementsByTagName("VEHICLEUSENAME_SV").item(0));
			var a =getNodeText(rows[0].getElementsByTagName("USERNAME").item(0));
