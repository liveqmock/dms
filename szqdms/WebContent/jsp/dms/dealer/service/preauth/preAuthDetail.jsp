...
var diaOperateAction = "<%=request.getContextPath()%>/service/preauthMng/PreAuthApplyAction";
...
$(function() 
{
	var searchPreAuthUrl = diaOperateAction + "/preAuthDetailSearch.ajax?authorId="+authorId;
	sendPost(searchPreAuthUrl,"","",diaSearchPreAuthBack,"false");
...
//查询回调
function diaSearchPreAuthBack(res){
	try{
		var rows = res.getElementsByTagName("ROW");
		if(rows && rows.length > 0)
		{
			setEditValue("dia-fm-preAuthBasic",rows[0]);
			var authorType =getNodeText(rows[0].getElementsByTagName("AUTHOR_TYPE").item(0));
			if(authorType=="300301" || authorType=="300304"){
				$("#jeTr").show();
			}else if(authorType=="300302"){
				$("#gzdzL").show();
				$("#gzdzT").show();
					...
					<div align="left">
						...
						<table class="editTable" id="dia-tab-preAuthBasic">
							...
							<tr>
								...
								<td><input type="text" id="dia-author_type" name="dia-author_type" datasource="AUTHOR_TYPE" value="" readonly="readonly"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="5"><textarea id="preAuthRamarks" style="width: 450px; height: 40px;" name="preAuthRamarks" datasource="PREAUTH_REMARKS" datatype="1,is_null,1000" readonly="readonly"></textarea></td>
							</tr>
						</table>
						</fieldset>
					</div>
