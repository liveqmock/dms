...
var searchUrl = "<%=request.getContextPath()%>/service/guaranteesHurryPart/GuaranteesHurryPartAction/dispatchOemSearch.ajax";
//查询按钮响应方法
$(function(){
	//查询方法
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="dispatchPartTable">
						<tr>
							...
							<td><select type="text" id="dispatchStatus" name="dispatchStatus" datasource="DISPATCH_STATUS" datatype="1,is_null,100" operation="like"  filtercode="303402|303403"  class="combox" kind="dic" src="SBJJSQZT">
