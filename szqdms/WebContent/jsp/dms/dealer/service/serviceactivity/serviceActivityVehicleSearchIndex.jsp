...
$(function(){
	...
	$("#search").bind("click", function(event){
    	...
    	var searchVehicel = "<%=request.getContextPath()%>/service/serviceactivity/ServiceActivityScopeMngAction/searchVehicel.ajax";
				...
				<div class="searchBar" align="left">
					<table class="searchContent" id="serviceActivityVinform">
						<tr>
						    ...
						    <td colspan="5">
					    		<input kind="date" type="text" id="in-ckrq" style="width:75px;" name="in-ckrq" datasource="T.APPLY_DATE" datatype="1,is_null,30" onclick="WdatePicker()" operation = ">=" />
					    		<span style="float:left;margin-left:-50px;margin-top:5px;">至</span>
								<input kind="date" type="text" id="in-jsrq" style="width:75px;margin-left:-30px;" name="in-ckrq" datasource="T.APPLY_DATE" datatype="1,is_null,30" onclick="WdatePicker()" operation = "<=" />
					   		 </td>
                        </tr>
						<tr>
							<td><label>VIN：</label></td>
      						<td><input type="text" id="vin-id" name="vin"  datasource="VIN" operation="like"/></td>
						</tr>
					</table>
					<div class="subBar">
						<ul>
