...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：配件索赔管理&gt;索赔管理&gt;配件索赔结算查询</h4>
	<div class="page">
			...
			<div class="searchBar" align="left">
				<table class="searchContent" id="pjsbjsTable">
					...
					<tr>
						...
						<td><input type="text" id="JSRQ" name="JSRQ" datatype="1,is_null,100"  onclick="WdatePicker({isShowWeek:true,doubleCalendar:false,dateFmt:'yyyy-MM-dd'})" value="" /></td>
					</tr>
				</table>
				<div class="subBar">
					<ul>
