...
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：财务管理&gt;打款管理&gt;打款到账查询</h4>
	<div class="page">
	<div class="pageHeader">
		<form id="dkdzcxform" method="post">
			<div class="searchBar" align="left">
				<table class="searchContent" id="dkdzcxTable">
					<tr>
