			  ...
			  <fieldset>
					<table class="editTable" id="dia-tab-htxx">
						<tr><td><label>退件单号：</label></td>
						    ...
						    <td><input type="text" id="dia-cgdh"  name="dia-cgdh" value="服务站名称1" readonly="readonly"/></td>
						...
						<table style="display:none;width:99%;" id="dia-tab-pjlb" layoutH="350" name="tablist" ref="dia-lpmx"  edit="false">
								<thead>
									<tr>
										...
										<th fieldname="JHS"  ftype="input" fdatatype="0,is_null,30" colwidth="60" freadonly="true" >入库数量</th>
				...
				<div class="formBar">
					<ul>
						<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-save" onclick="doSubmit();">销售退件入库</button></div></div></li>
