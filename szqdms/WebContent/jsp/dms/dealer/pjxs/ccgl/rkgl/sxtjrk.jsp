...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/pjxs/ccgl/rkgl/sxtjrkmx.jsp", "tjshmx", "实销退件入库明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置：仓储管理  &gt; 入库管理   &gt; 实销退件入库</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td><input type="text" id="in-ddbh" name="in-ddbh" datasource="DDBH" kind="dic" src="E#1=实销出库:2=三包出库" datatype="1,is_digit_letter,30" operation="like" /></td>
				    </tr>
				    <tr>
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="">实销日期</th>
							<th colwidth="105" type="link" title="[实销退件入库]"  action="doUpdate" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><a href="#" onclick="doUpdate()" class="op">[实销退件入库]</a></td>
						</tr>
						<tr>
