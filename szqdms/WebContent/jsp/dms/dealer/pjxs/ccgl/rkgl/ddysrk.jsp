...
//查看订单详细信息
function toYsrk(orderNo)
{
	var w = document.documentElement.clientWidth-100;
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/dealer/pjxs/ccgl/rkgl/ddysrkmx.jsp", "ddmx", "订单验收入库", options, true);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 仓储管理  &gt; 入库管理   &gt; 订单验收入库</h4>
	<div class="page" >
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_ddlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="ZJE" colwidth="120">发运单号</th>
							<th fieldname="ZJE">承运商</th>
							<th fieldname="ZJE">司机</th>
							<th fieldname="ZJE">联系电话</th>
							<th fieldname="ZJE">发运日期</th>
							<th fieldname="ZJE" align="left">应发数量</th>
							<th fieldname="ZJE" align="left">实发数量</th>
							<th fieldname="ZJE" align="left" colwidth="55">实发金额</th>
							<th colwidth="80" type="link" title="[验收入库]"  action="toYsrk" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>月度订单</div></td>
							<td><div>陕重汽销售公司</div></td>
							<td><div>有</div></td>
							<td><div>2014-05-20</div></td>
							<td><div>张三</div></td>
							<td><div>FYD20140522001</div></td>
							<td><div>物流公司一</div></td>
							<td><div>李四</div></td>
							<td><div>13290881088</div></td>
							<td><div>2014-05-22</div></td>
							<td><div>50</div></td>
							<td><div>50</div></td>
							<td><div align="right">2,500.00</div></td>
							<td><div><a style="color:red;" onclick="toYsrk();">[验收入库]</a></div></td>
						</tr>
						<tr>
							...
							<td><div>2014-05-22</div></td>
							<td><div>张三</div></td>
							<td><div>FYD20140524001</div></td>
							<td><div>物流公司二</div></td>
							<td><div>王五</div></td>
							<td><div>13290181088</div></td>
