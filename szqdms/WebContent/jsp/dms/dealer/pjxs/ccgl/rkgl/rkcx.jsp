...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/pjxs/ccgl/rkgl/xstjrkmx.jsp", "tjshmx", "销售退件入库明细", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
	...
	<h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置：仓储管理  &gt; 入库管理   &gt; 入库查询</h4>
	<div class="page" >
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-ddcx">
					...
					<tr>
					    ...
					    <td><input type="text" id="in-ddbh" name="in-ddbh" kind="dic" src="E#1=订单验收入库:2=销售退件入库:3=实销退件入库" datasource="DDBH" datatype="1,is_digit_letter,30" operation="like" /></td>
			...
			<table style="display:none;width:100%;" id="tab-pjlb" name="tablist" ref="page_pjlb" refQuery="fm-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="">入库数量</th>
							<th fieldname="">入库类型</th>
							<th fieldname="">源单号码</th>
							<th fieldname="">入库日期</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>10件/包</div></td>
							<td><div>15</div></td>
							<td><div>订单验收入库</div></td>
							<td><div>YD20140509001</div></td>
						...
						<tr>
							...
							<td><div>10件/包</div></td>
							<td><div>10</div></td>
							<td><div>销售退件入库</div></td>
							<td><div>XSTJ20140509001</div></td>
							<td><div>2014-05-22</div></td>
						</tr>
						<tr>
							<td class="rownums"><div>2</div></td>
							...
							<td><div>10件/包</div></td>
							<td><div>2</div></td>
							<td><div>实销退件入库</div></td>
							<td><div>SXDH20140509001</div></td>
							<td><div>2014-05-22</div></td>
						</tr>
					</tbody>
			</table>
