			...
			<table style="display:none;width:100%;" id="tab-cx-pjlb" name="tablist" ref="page-cx-pjlb" refQuery="fm-cx-pjcx" >
					<thead>
						<tr>
							...
							<th fieldname="KC" freadonly="true" >库存</th>
					...
					<tbody>
						...
						<tr>
							...
							<td><div>800.00</div></td>
							<td><div>有</div></td>
							<td><div><select type="text" ><option selected>是</option><option>否</option></select></div></td>
							<td><div><input type="text" kind="dic" src="E#1=供应商1:2=供应商2" style="width:100px;"/></div></td>
							<td><div><input type="text" /></div></td>
						</tr>
						<tr>
