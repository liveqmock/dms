...
$(function(){
	...
	//提报
	$("#dia-sign").bind("click",function(){
		var rangeId=$("#rangeId").val();
		var reportUrl = diaSaveAction + "/noticeSign.ajax?rangeId="+rangeId+"";
		sendPost(reportUrl,"dia-sign","",diaSignCallBack,"false");
	});
	//关闭当前页面
	...
	<div class="tabs" eventType="click" id="tabs">
		...
		<div class="tabsContent" >
			...
			<div class="page">
				...
				<div class="formBar">
					<ul>
						<li id="dia_li_sign"><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-sign">签&nbsp;&nbsp;收</button></div></div></li>
						<li><div class="button"><div class="buttonContent"><button class="close" type="button">关&nbsp;&nbsp;闭</button></div></div></li>
