...
function doUpdate(){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/shfw/jsgl/jsgl/yjmx.jsp", "yjmx", "结算发票邮寄", options);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="jsdyjform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="jsdyjTable">
						<tr>
				...
				<table width="100%" id="jsdlb" name="jsdlb" style="display: none" >
					<thead>
						<tr>
							...
							<th colwidth="85" type="link"  title="[邮寄]" action="doUpdate">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td>0</td>
							<td>400</td>
							<td><a href="#" onclick="doUpdate()" class="op">[邮寄]</a></td>
						</tr>
						<tr>
							<td>2</td>
							<td>结算单号2</td>
