...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/ysqgl/ysqxz.jsp?action=2", "ysqxxwh", "预授权信息维护", options,true);
}
//列表编辑链接(删除)
...
{
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/ysqgl/ysqxz.jsp?action=1", "ysqxxwh", "预授权信息维护", options,true);
}
</script>
</head>
<body>
