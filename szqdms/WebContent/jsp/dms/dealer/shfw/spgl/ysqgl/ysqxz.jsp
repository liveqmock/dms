...
function checkVin() 
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/spgl/xzcl.jsp","xzcl", "预授权信息维护-校验车辆", options);
}
function saveTabs()
{
...
function diaCldSaveCallBack(res)
{
	var selectedIndex = $("#dia-tab-cldlb_content").getSelectedIndex();
	$("#dia-tab-cldlb_content").clearRowEdit($("#dia-tab-cldlb_content").getSelectedRows()[0],selectedIndex);
	return true;
}
//列表删除
...
function doDiaJbReport()
{
	alertMsg.info("提报成功");
	parent.$.pdialog.closeCurrent();
}
function doDiaJbSave()
{
	alertMsg.info("保存成功");
	parent.$.pdialog.closeCurrent();
}
			...
			<div class="tabsContent">
				<div class="page" id="dia-div-wxxxbj" style="overflow:auto;">
					<div class="pageContent">
								...
								<fieldset>
									...
									<table class="editTable" id="dia-tab-wxxx">
									   <tr>
											...
											<td>
												<select type="text" id="dia-in-splx" name="dia-in-splx" kind="dic" src="E#1=照顾性保修:2=跨区服务" datasource="PRETH_TYPE" datatype="0,is_null,30" value="">
														<option value="1" selected>照顾性保修</option>
												</select>
											</td>
										</tr>
										<tr>
										...
										<tr >
											...
											<td><input type="text" id="dia-in-xslc" name="dia-in-xslc" value="保修卡号1" datatype="0,is_number,30" readonly="readonly" /> </td>
										</tr>
										<tr >
											<td><label>出厂日期：</label></td>
											<td><input type="text" id="dia-in-ccrq" name="dia-in-ccrq" value="2013-01-01" datatype="0,is_null,30" readonly="readonly" /></td>
											<td><label>首保日期：</label></td>
											<td colspan="3"><input type="text" id="dia-in-sbrq" name="dia-in-xslc" value="2013-04-01" datatype="0,is_number,30" readonly="readonly" />
											</td>
										</tr>
										<tr>
						...
						<div class="formBar">
							<ul>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-save" onclick="doDiaJbSave();">保&nbsp;&nbsp;存</button></div></div></li>
								<li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-report" onclick="doDiaJbReport();">提&nbsp;&nbsp;报</button></div></div></li>
					...
					<div class="pageContent">  
						...
						<legend align="right"><a onclick="onTitleClick('dia-shgj')">&nbsp;项目信息&gt;&gt;</a></legend>
						 <div id="dia-shgj">
							...
							<thead>
								<tr>
									<th type="single" name="XH" style="display:" append="plus|addXm"></th>
									<th fieldname="XM_TYPE" ftype="input"  fkind="dic" fsrc="E#1=项目类型1:2=项目类型2">项目类型</th>
									<th fieldname="XM_CODE" ftype="input" fkind="dic" fsrc="E#项目名称1=项目代码1:项目名称2=项目代码2" >项目代码</th>
									<th fieldname="XM_NAME" freadonly="true">项目名称</th>
									<th fieldname="REMARK" colwidth="100" ftype="input" >备注</th>
