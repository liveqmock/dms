...
var action = "<%=action%>";
var spdwxxx_dialog = parent.$("body").data("comspdwxxx");
$(function() 
{
	//设置高度
	...
	{
		parent.$.pdialog.close(spdwxxx_dialog);
		return false;
	});
	$("#sudfjlb").show();
	$("#sudfjlb").jTable(); //附件
								...
								<fieldset>
									...
									<table class="editTable" id="dia-tab-wxxx">
										<tr>
											...
											<td><input type="text" id="dia-in-engineno" name="dia-in-engineno" value="发动机号" readonly="readonly" /></td>
											<td colspan="2"></td>
										</tr>
										<tr>
											...
											<td><input type="text" id="dia-in-fdjxh" name="dia-in-fdjxh" value="合格证号1" readonly="readonly" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" id="dia-in-sbfy" name="dia-in-sbfy"  value="正常保修" readonly="readonly" /></td>
											<td><label>是否预授权：</label></td>
											<td><input type="text" id="dia-in-sbfy" name="dia-in-sbfy"  value="否" readonly="readonly" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" id="dia-in-gzxxly" name="dia-in-gzxxly"  value="电话" readonly="readonly"/></td>
						      ...
						      <div class="page">
								<table class="editTable" id="dia-tab-lj1xx">
									<tr><td><label>处理措施：</label></td>
									    <td><input type="text" id="dia-in-clcs0" name="dia-in-clcs0"  value="更换" readonly="readonly"/>
									   </td> 
									...
									<tr>
									    ...
									    <td> <input type="text" id="dia-in-jjlsh0" value="旧件生产厂家1" readonly="readonly"/>
									    </td>
									</tr>
									<tr>
									    ...
									    <td> <input type="text" id="dia-in-gzlb0" value="主损" readonly="readonly" /></td>
									    <td><label>祸首件：</label></td>
									    <td><input type="text" id="dia-in-jjdm0" value="" readonly="readonly" />
									   </td> 
									</tr>
									<tr >
									   ...
									   <td><label>新件供应厂家：</label></td>
									    <td > <input type="text" id="dia-in-xjgyc0" value="新件生产厂家1" readonly="readonly" />
										</td>
									</tr>
									<tr >
									   ...
									   <td ><input type="text" id="dia-in-spdj0" value="索赔单价" readonly="readonly" /></td> 
									    ...
									    <td> 
									        <input type="text" id="dia-in-xjsl0" value="新件件数=旧件件数" readonly="readonly" />
										</td>
										<td><label>新件来源：</label></td>
									    <td><input type="text" id="dia-in-xjly0" value="站内储备1" readonly="readonly" />
									    </td>
									</tr>
									<tr>
									    ...
									    <td><input type="text" id="dia-in-qlb0" value="1类" readonly="readonly" />
									    </td>
										<td><label>桥编码：</label></td>
									    <td> 
									         <input type="text" id="dia-in-qbm"  name="dia-in-qbm"   value="桥编码1" readonly="readonly" />
										</td>
									</tr>
									<tr>
									    <td><label>故障模式：</label></td>
									    <td><input type="text" id="dia-in-qlb0" value="故障模式1" readonly="readonly" />
									    </td>
									    <td><label>严重程度：</label></td>
									    <td><input type="text" id="dia-in-qlb0" value="一般故障" readonly="readonly" />
									    </td>
									    <td ><label>作业类别：</label></td>
									    <td><input type="text" id="dia-in-qlb0" value="作业类别1" readonly="readonly" />
									    </td>									     
									</tr>
									<tr>
									     <td ><label>作业：</label></td>
									     <td><input type="text" id="dia-in-qlb0" value="作业1" readonly="readonly" />
									    </td>
									    <td><label>维修工时：</label></td>
									    <td > 
									        <input type="text" id="dia-in-xjgyc0" value="5" readonly="readonly" />
										</td>
										<td><label>工时单价：</label></td>
									    <td > 
									        <input type="text" id="dia-in-xjgyc0" value="36" readonly="readonly" />
										</td>
									</tr>
									<tr>
									    <td><label>星级单价：</label></td>
									    <td > 
									        <input type="text" id="dia-in-xjgyc0" value="4" readonly="readonly" />
										</td>
									    <td><label>激励单价：</label></td>
									    <td > 
									        <input type="text" id="dia-in-xjgyc0" value="2" readonly="readonly" />
										</td>
										<td><label>工时费：</label></td>
									    <td > 
									        <input type="text" id="dia-in-xjgyc0" value="5*(36+4+2)" readonly="readonly" />
										</td>
									</tr>
								</table>
							</div>	
							    ...
							    <div class="pageContent" id="dia-pag-lj2xx"  >
								  <table class="editTable" id="dia-tab-lj2xx">
									...
									<tr>
										...
										<td><label>故障类别：</label></td>
									    <td>
									         <input type="text" id="dia-in-gzlb0" name="dia-in-gzlb0" readonly="readonly"   value="主损"/>
									   </td>
									    <td><label>祸首件：</label></td>
									    <td><input type="text" id="dia-in-jjdm0" value="" readonly="readonly" />
									   </td> 
							     ...
							     <div class="pageContent" id="dia-pag-lj3xx"  >
								   <table class="editTable" id="dia-tab-lj3xx">
									...
									<tr>
										...
										<td><label>故障类别：</label></td>
									    <td>
									         <input type="text" id="dia-in-gzlb0" name="dia-in-gzlb0" readonly="readonly"  value="附损"/>
														
									   </td>
									    <td><label>祸首件：</label></td>
									    <td><input type="text" id="dia-in-jjdm0" value="配件代码1" readonly="readonly" />
									   </td> 
									</tr>
									<tr id="dia-xjkz1">
									   <td><label>新件代码：</label></td>
