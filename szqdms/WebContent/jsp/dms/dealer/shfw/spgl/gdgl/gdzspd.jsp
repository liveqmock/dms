...
function doReport(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/spgl/spdwxxx.jsp?action=1", "spdxxwh", "索赔单信息维护", options,true);
}
</script>
</head>
<body>
			...
			<table style="display:none;width:100%;" id="tab-spdlb" name="tablist" ref="page_spdlb" refQuery="fm-sbdcx" >
					<thead>
						<tr>
							...
							<th colwidth="105" type="link" title="[工单转索赔单]"  action="doReport" >操作</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><div>站内派工</div></td>
							<td><div>否</div></td>
							<td><a href="#" onclick="doReport()" class="op">[工单转索赔单]</a></td>
						</tr>
						<tr>
