...
function doUpdate(row)
{
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/gdgl/pgryxz.jsp?action=2", "ryxxwh", "人员信息维护", options);
}
//新增
function doAddpgyx()
{
	var options = {max:true,mask:true,width:300,height:150,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/gdgl/pgryxz.jsp?action=1", "ryxxwh", "人员信息维护", options);
}
</script>
</head>
<body>
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="tab-pgrycx">
					...
					<tr>
					    ...
					    <td ><input type="text" id="in-sjhm" name="in-ryxm" datatype="1,is_digit_letter,30" operation="like" /></td>
			...
			<table style="display:none;width:100%;" id="tab-pgrylb" name="tablist" ref="page_pgrylb" refQuery="fm-pgrycx" >
					<thead>
						<tr>
							...
							<th fieldname="" >人员姓名</th>
							<th fieldname="">手机号码</th>
							<th fieldname="" >状态</th>
							<th fieldname="" >住址</th>
							<th fieldname="" >备注</th>
