...
{
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
	$.pdialog.open(webApps + "/jsp/dms/dealer/shfw/spgl/spgl/cxtdsqmx.jsp", "cxydsqmx", "重新提交申请", options);
}
</script>
</head>
<body>
			...
			<table style="display:none;width:100%;" id="tab-spdlb" name="tablist" ref="page_spdlb" refQuery="fm-sbdcx" >
					<thead>
						<tr>
							...
							<th fieldname="CHECK_TIME" >拒绝时间</th>
							<th fieldname="" >拒绝意见</th>
					...
					<tbody>
						<tr>
							...
							<td><div>最后一次审批时不合格</div></td>
							<td><a href="#" onclick="doSq()" class="op">[申请]</a></td>
						</tr>
						<tr>
