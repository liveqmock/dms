...
function doUpdate(rowobj){
	...
	$.pdialog.open(webApps+"/jsp/dms/dealer/shfw/jjgl/jjgl/jjhyshmx.jsp", "jjhyshmx", "旧件回运审核", options,true);
}
</script>
</head>
<body>
<div id="layout" style="width:100%;">
		...
		<div class="pageHeader">
			<form id="jjhyshform" method="post">
				<div class="searchBar" align="left">
					<table class="searchContent" id="jjhyshTable">
						<tr>
		...
		<div class="pageContent">
			<div id="jjhysh">
				<table width="100%" id="jjhyshlb" name="jjhyshlb" style="display: none" >
					<thead>
						<tr>
