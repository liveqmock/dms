                        ...
                        <table style="display:none;width:100%;" id="tab-fileImportResult" name="tablist" ref="div-fileImportResult" pagerows="10">
                            <thead>
                                <tr>
                                    ...
                                    <th fieldname="PART_COUNT">配件数量</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastMngAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastMngAction/insertImport.ajax?tmpNo="+rowStrNo;
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/planMng/forecast/ForecastMngAction/expData.do?seqs="+rowStrNo);
