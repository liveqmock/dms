...
<script type="text/javascript">
    // URL
    var searchDealerUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastTotalMngAction/searchForecastByDealer.ajax";
    // 弹出窗体
    var dialogSearch = $("body").data("forecastTotalReportSearch");
    // 初始化方法
     $(function(){
         // 查询按钮绑定
        $("#dia-search").click(function(){
            ...
            var reportCheckUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastTotalMngAction/reportCheck.ajax";
        ...
        $("#dia-doTotal").click(function(){
        	$("#month").val($("#search-forcastMonth").val());
            $.pdialog.close(dialogSearch);
            var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
            $.pdialog.open(webApps+"/jsp/dms/dealer/part/plan/forecastMng/forecastTotalReportEdit.jsp", "totalEdit", "预测汇总调整", options);
        });
    ...
    function doDtl(rowobj){
        ...
        $.pdialog.open(webApps+"/jsp/dms/dealer/part/plan/forecastMng/forecastTotalReportDetail.jsp", "totalDetail", "预测明细调整", options);
    }
</script>
    ...
    <div class="pageHeader">
        <form id="fm-condition-search" method="post">
            <div class="searchBar" align="left">
                ...
                <div class="subBar">
                    <ul>
                        <li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-search">渠道商汇总查询</button></div></div></li>
            ...
            <table style="display:none;width:100%;" id="tab-grid-search" name="tablist" ref="search_page_grid" refQuery="tab-condition">
                <thead>
                    <tr>
                        ...
                        <th colwidth="85" type="link" title="[明细]"  action="doDtl">操作</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
