...
<script type="text/javascript">
    var searchUrl = "<%=request.getContextPath()%>/part/planMng/forecast/ForecastMngAction/searchForecast.ajax";
    $(function(){
    ...
    function doDetail(rowobj){
        $("td input:first",$(rowobj)).attr("checked",true);
        var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
        $.pdialog.open(webApps+"/jsp/dms/dealer/part/plan/forecastMng/forecastDetail.jsp", "forecastDetail", "预测明细", options);
    }
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：预测管理&gt;预测管理&gt;预测上报</h4>
    <div class="page">
            ...
            <div class="searchBar" align="left">
                <table class="searchContent" id="ycsbTable">
                    <tr>
                        ...
                        <td><select type="text" id="forcastStatus" name="forcastStatus" datasource="FORCAST_STATUS" datatype="1,is_null,100" class="combox" kind="dic" src=<%=DicConstant.PJYCZT %>>
