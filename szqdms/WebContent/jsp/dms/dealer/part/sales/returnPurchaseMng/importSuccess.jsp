        ...
        <div class="tabsContent" >
            <div class="page">
                <form id="fm-fileImport" method="post" >
                    <input type="hidden" id="tmpNo" name="tmpNo" datasource="A.TMP_NO" operation="not in"/>
                </form>
...
<script type="text/javascript">
    ...
    var searchUrl = "<%=request.getContextPath()%>/part/salesMng/returnPurchaseMng/ReturnPurchaseApplyMngAction/searchImport.ajax";
    $(function(){
        ...
        $("#doConfirm").click(function() {
            try{
                ...
                var insertUrl = "<%=request.getContextPath()%>/part/salesMng/returnPurchaseMng/ReturnPurchaseApplyMngAction/insertImport.ajax?tmpNo="+rowStrNo;
                sendPost(insertUrl+"&returnId="+<%=bParams%>, "", "", doConfirmCallBack, "true");
            }catch(e){}
        });
        ...
        $("#btn-importSuccessClose").click(function() {
            try{
                ...
                var url = encodeURI("<%=request.getContextPath()%>/part/salesMng/returnPurchaseMng/ReturnPurchaseApplyMngAction/expData.do?seqs="+rowStrNo);
    ...
    function doConfirmCallBack(){
    	...
    	parent.searchReturnPurchaseApplyDtl();
