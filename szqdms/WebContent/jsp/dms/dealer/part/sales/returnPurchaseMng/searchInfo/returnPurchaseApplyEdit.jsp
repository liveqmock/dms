                    ...
                    <fieldset>
                        <table class="editTable">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="dia-code-edit" name="dia-code-edit" datasource="RECEIVE_ORG_CODE" datatype="1,is_null,300" operation="like" readonly="readonly" style="width:280px;"/>
...
<!--                                 </td> -->
                            ...
                            <tr>
                                ...
                                <td colspan="5"><textarea id="dia-remarks-edit" name="dia-remarks-edit" datatype="1,is_null,100" readonly="readonly" datasource="REMARKS" style="width:450px;height:40px;"></textarea></td>
                            </tr>
                        </table>
                    </fieldset>
                </div>
