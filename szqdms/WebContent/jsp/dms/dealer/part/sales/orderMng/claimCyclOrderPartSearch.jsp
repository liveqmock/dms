            ...
            <table style="display:none;width:100%;" id="dia-tab-grid" multivals="div-selectedPart" name="tablist" ref="dia_page_grid" refQuery="tab-condition">
                <thead>
                    <tr>
                        ...
                        <th fieldname="" refer="createInputBox" colwidth="60">订购数量</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td>
                                ...
                                <textarea style="width:80%;display:none" id="val10" name="multivals" readOnly></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script type="text/javascript">
    var partSearchUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/claimCyclOrderReportMngAction/searchPart.ajax";
    // 弹出窗体
    ...
    $(function() {
        ...
        $('#btn-confirmPart').bind('click',function(){
            // 添加预测配件明细URL
            var insertPromPartUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/claimCyclOrderReportMngAction/insertSaleOrderDetail.ajax";
            var partIds = $('#val10').val();
            if (!partIds) {
                alertMsg.warn('请选择配件!');
            } else {
