...
<title>三包急件订单提报</title>
<script type="text/javascript">
    //查询提交方法
    var url = "<%=request.getContextPath()%>/part/salesMng/orderMng/claimCyclOrderReportMngAction";
    //初始化方法
    $(function(){
        ...
        $("#btn-xz").bind("click",function(event){
            ...
            $.pdialog.open(webApps + "/jsp/dms/dealer/part/sales/orderMng/claimCyclOrderReportEdit.jsp?action=1", "ddxxwh", "订单信息新增", options);
        });
    });
  ...
  //提报回调方法
    ...
    function doUpdate(rowobj) {
        ...
        var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
        $.pdialog.open(webApps + "/jsp/dms/dealer/part/sales/orderMng/claimCyclOrderReportEdit.jsp?action=2", "ddxxwh", "订单信息维护", options);
    }
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath() %>/images/default/nav.gif" />&nbsp;当前位置： 销售管理  &gt; 订单管理   &gt; 三包急件订单提报</h4>
    <div class="page" >
            ...
            <div class="searchBar" align="left" >
                <table class="searchContent" id="tab-ddcx">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="orderNo" name="orderNo" datasource="A.ORDER_NO" datatype="1,is_digit_letter,30" operation="like" /></td>
                        <td><label>订单状态：</label></td>
                        <td>
                            <select type="text" id="orderStatus"  name="orderStatus" datasource="A.ORDER_STATUS" kind="dic" src="DDZT" filtercode="202201|202204" datatype="1,is_null,30" >
                ...
                <div style="padding-left:30px;color: red;">注：三包急件发运情况，请联系中国邮政物流，联系电话：14702999324</div>
                <div class="subBar">
                    <ul>
