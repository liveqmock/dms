...
<script type="text/javascript">
    var partSearchUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportMngAction/searchPart.ajax";
    // 弹出窗体
    ...
    $(function() {
        ...
        $('#btn-confirmPart').bind('click',function(){
            // 添加预测配件明细URL
            var insertPromPartUrl = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportMngAction/insertSaleOrderDetail.ajax";
