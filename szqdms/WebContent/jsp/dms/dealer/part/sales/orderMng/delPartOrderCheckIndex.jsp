...
//变量定义
//查询提交方法
var url = "<%=request.getContextPath()%>/part/salesMng/orderMng/DelPartOrderCheckAction";
//初始化方法
$(function(){
...
{	$("td input[type=radio]", $(rowobj)).attr("checked", true);
	...
	$.pdialog.open(webApps + "/jsp/dms/dealer/part/sales/orderMng/delPartOrderCheckDetail.jsp", "orderCheck", "订单审核明细", options);
}
			...
			<div class="searchBar" align="left" >
				<table class="searchContent" id="searchTab">
					...
					<tr>
                        ...
                        <td>
                            <input type="text" id="orgCode" name="orgCode" datatype="1,is_null,10000" datasource="T.ORG_CODE" operation="like"/>
                        </td>
                        <td><label>渠道商名称：</label></td>
                        <td>
                            <input type="text" id="orgName" name="orgName" datatype="1,is_null,10000" datasource="T.ORG_NAME" operation="like" />
                        </td>
			...
			<table style="display:none;width:100%;" id="orderList" name="orderList" ref="orderListDiv" refQuery="searchTab">
					<thead>
						<tr>
							...
							<th fieldname="ORDER_NO" colwidth="155">订单编号</th>
							...
							<th fieldname="EXPECT_DATE" style="display:none">期望到货日期</th>
							...
							<th fieldname="REMARKS" maxlength="20" style="display:none">备注</th>
