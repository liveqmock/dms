...
<script type="text/javascript">
    // 查询提交方法
    var url = "<%=request.getContextPath()%>/part/salesMng/orderMng/TechnologyUpgradesOrderReportMngAction";
    // 初始化方法
    $(function(){
        ...
        $("#btn-xz").bind("click",function(event){
            ...
            $.pdialog.open(webApps + "/jsp/dms/dealer/part/sales/orderMng/technologyUpgradesOrderReportEdit.jsp?action=1", "ddxxwh", "订单信息新增", options);
        });
    });
    ...
    function doUpdate(rowobj) {
        ...
        var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
        $.pdialog.open(webApps + "/jsp/dms/dealer/part/sales/orderMng/technologyUpgradesOrderReportEdit.jsp?action=2", "ddxxwh", "订单信息维护", options);
    }
