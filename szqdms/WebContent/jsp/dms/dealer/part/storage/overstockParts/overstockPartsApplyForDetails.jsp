...
<div  style="width:100%;">
        ...
        <form method="post">
            <div class="searchBar" align="left" >
                <table class="searchContent" id="overstock_info_s">
                    ...
                    <tr id="remarkTr" style="visibility:hidden;">
                    	<td><label>备注</label></td>
                    	<td colspan="3">
                    		<textarea style="width:300px;height:50px;" id="REMARK_S" readonly="readonly"></textarea>
                    	</td>
                    </tr>
                </table>
                <div class="subBar">
    ...
    $(function(){
    	...
    	function showOverstockInfo(jsonObj){
    		...
    		var applyStatus = jsonObj["APPLY_STATUS_CODE_S"];
    		if(applyStatus == "306204"){
    			$("#REMARK_S").val(jsonObj["CONFORM_REMARK_S"]);
    			$("#remarkTr").css("visibility","visible");
    		}else if(applyStatus == "306206"){
    			$("#REMARK_S").val(jsonObj["CHECK_REMARK_S"]);
    			$("#remarkTr").css("visibility","visible");
    		}else{
    			$("#remarkTr").css("visibility","hidden");
    		}
    	}
