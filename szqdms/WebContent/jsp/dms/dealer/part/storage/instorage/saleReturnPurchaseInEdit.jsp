    ...
    <div class="page">
        ...
        <form  method="post" id="dia-fm-edit-returnId">
                ...
                <table style="display:none;width:99%;" id="dia-tab-edit" name="tablist" ref="page_edit">
                    <thead>
                        <tr>
                            ...
                            <th fieldname="" refer="creatInput">入库数量</th>
                            <th fieldname="SALE_PRICE">经销商价格</th>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td>
                                ...
                                <textarea style="width:80%;" id="val3" name="multivals" readOnly></textarea>
            ...
            <form id="fm-partInfo">
                ...
                <input type="hidden" id="inCounts" name="inCounts" datasource="INCOUNTS"/>
            ...
            <div class="formBar">
                <ul>
                    <li><div class="buttonActive"><div class="buttonContent"><button type="button" id="dia-returnPurchaseOut-edit">销售退件入库</button></div></div></li>
...
<script type="text/javascript">
    $(function(){
        ...
        // 查询退件申请明细
        var edit_searchUrl = "<%=request.getContextPath()%>/part/storageMng/stockInMng/SaleReturnPurchaseInMngAction/searchReturnPurchaseApplyDtl.ajax";
        ...
        $("#dia-returnPurchaseOut-edit").click(function(){
            var doReturnPurchaseOutUrl = "<%=request.getContextPath()%>/part/storageMng/stockInMng/SaleReturnPurchaseInMngAction/returnPurchaseIn.ajax";
            // 退件订单ID
            ...
            // 入库数量
            $('#inCounts').val($('#val1').val());
            // 配件ID
            $('#partIds').val($('#val2').val());
            // 应入数量
            $('#returnCounts').val($('#val4').val());
            // 应入数量
