...
$(function() 
{
	...
	$("#dia-report").bind("click",function(){
		...
		var reportUrl = diaSaveAction + "/OutPartReport.ajax?buyId="+buyId+"&shyj="+shyj;
	...
	$("#dia-reject").bind("click",function(){
		...
		//将需要提交的内容拼接成json
		sCondition = $("#dia-fm-hurryPartReport").combined(1) || {};
		var rejectUrl = diaSaveAction + "/OutPartReject.ajax?buyId="+buyId;
		...
		<div class="tabsContent" >
			...
			<div class="pageContent" style="" >
				<form method="post" id="dia-fm-hurryPartReport" class="editForm" style="width: 99%;">
					...
					<input type="hidden" id="dia-dia-shyj" datasource="CHECK_REMARKS"/>
					<div align="left">
						<fieldset>
						<legend align="right">
						...
						<tr>
						 ...
						 <tr>	 
			              ...
			              <tr>
				              ...
				              <td colspan="5"><textarea id="dia-shyj" style="width: 450px; height: 50px;" datasource="CHECK_REMARKS" name="shyj"></textarea></td>
				          </tr>
				          </table>
						</fieldset>
					</div>
				...
				<div class="searchBar" align="left">
					...
					<div class="subBar">
						<ul>
						    ...
						    <li id="dia-report_li"><div class="button"><div class="buttonContent"><button type="button" id="dia-report">审核通过</button></div></div></li>
