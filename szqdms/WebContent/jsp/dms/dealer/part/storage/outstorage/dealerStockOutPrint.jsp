...
<script type="text/javascript">
    ...
    function searchSaleOrder() {
        var searchUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/DealerOutPrintMngAction/outSearch.ajax";
        var $f = $("#fm-index");
        var sCondition = {};
    ...
    function doPrint(rowobj) {
       ...
       if(parseInt(type)==1){
       		...
       		queryUrl = "<%=request.getContextPath()%>/part/storageMng/stockOutMng/DealerOutPrintMngAction/printSalePdf.do?ORDER_ID="+$row.attr("ORDER_ID")+"&flag=1";
       }
