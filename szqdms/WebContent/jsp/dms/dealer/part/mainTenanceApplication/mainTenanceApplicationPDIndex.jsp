...
<body>
	<div id="layout" style="width: 100%;">
		...
		<h4 class="contentTitle" align="left">
			<img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：配件管理 &gt; 配件信息维护申请管理 &gt; 采供科审核
		</h4>
		<div class="page">
			<div class="pageHeader">
				<form method="post" id="fm-searchContract">
					<!-- 定义隐藏域条件 -->
					<!-- 此参数标示：采供科审核查询 -->
					<!-- 技术科审核查询:查询状态为技术科审核通过的 -->
					<input type="hidden" id="APPLICATION_STATUS" name="APPLICATION_STATUS" dataSource="APPLICATION_STATUS" value="<%=DicConstant.PJWHSQZT_03%>" />
					<div class="searchBar" align="left">
						<table class="searchContent">
							...
							<tr>
								...
								<td>
									<select type="text" id="APPLICATION_TYPE" name="APPLICATION_TYPE" datasource="APPLICATION_TYPE"
											kind="dic" src="PJWHSQLX" filtercode="<%=DicConstant.PJWHSQLX_01%>|<%=DicConstant.PJWHSQLX_04%>" >
					...
					<table style="display:none; width: 100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="fm-searchContract">
						<thead>
							<tr>
								...
								<th colwidth="80" type="link" title="[审核]" action="doAudit">操作</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
...
$(function(){
    ...
    $("#btn-search").click(function(){
    	var searchURL = "<%=request.getContextPath()%>/part/mainTenanceApplication/MainTenanceApplicationAction/applicationSelectByAuditForPd.ajax";
...
function doAudit(rowObj){
	...
	var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
    $.pdialog.open(webApps+"/jsp/dms/dealer/part/mainTenanceApplication/mainTenanceApplicationForPDAudit.jsp", "forDetailsPage", "申请单详情", options);
}
</script>
</html>
