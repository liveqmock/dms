	...
	<div class="pageHeader">
		...
		<table class="searchContent">
			<tr>
				...
				<td><input type="text" id="CAB_ASSEMBLY_NO" name="CAB_ASSEMBLY_NO" style="margin: 0px"/></td>
			</tr>
			<tr>
				<td><label>车辆识别码</label></td>
				<td><input type="text" id="VIN" name="VIN" style="margin: 0px"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="CAR_BODY_COLOR" name="CAR_BODY_COLOR" style="margin: 0px"/>
				</td>
			</tr>
			<tr>
