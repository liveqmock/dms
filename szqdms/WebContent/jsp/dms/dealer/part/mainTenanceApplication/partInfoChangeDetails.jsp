					...
					<table style="display:none; width: 100%;" id="tab-contract" name="tablist" ref="page_contract" refQuery="partInfoDetailsForm">
						<thead>
							<tr>
								...
								<th colwidth="150" fieldname="OLD_PART_NO">原零件编号</th>
								<th fieldname="OLD_PART_NAME">原零件名称</th>
								<th colwidth="120" fieldname="VIN">车辆识别码</th>
								<th colwidth="150" fieldname="NEW_PART_NO">更新编号</th>
								<th fieldname="NEW_PART_NAME">更新名称</th>
								<th fieldname="REMARK">更新（禁用）原因</th>
								<th fieldname="ENGINEERING_DEPARTMENT_REMARK">技术科意见</th>
								<th fieldname="PURCHASING_DEPARTMENT_REMARK">采购科意见</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
...
$(function(){
	...
	var searchURL = "<%=request.getContextPath()%>/part/mainTenanceApplication/MainTenanceApplicationAction/applicationPartInfoChangeDetails.ajax";
