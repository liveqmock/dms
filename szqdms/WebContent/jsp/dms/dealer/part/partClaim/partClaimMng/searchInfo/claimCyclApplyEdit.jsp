        ...
        <form method="post" id="fm-Edit" class="editForm" >
            ...
            <table class="editTable" id="tab-Edit">
                <tr>
                    ...
                    <td>
                        <input type="text" id="inStockOrderNo-Edit" name="inStockOrderNo-Edit" datatype="1,is_null,100" datasource="IN_ORDER_NO" readOnly />
                        <input type="hidden" id="inStockOrderId-Edit" name="inStockOrderId-Edit" datasource="IN_ORDER_ID"/>
                    </td>
                    <td><label>系统出库单：</label></td>
                    <td>
                        <input type="text" id="outStockOrderNo-Edit" name="outStockOrderNo-Edit" datatype="1,is_null,100" datasource="OUT_ORDER_NO" readOnly />
                ...
                <tr>
                    ...
                    <td><input type="text" id="linkPhone-Edit" name="linkPhone-Edit" datatype="1,is_double,100" datasource="PHONE" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td><label>配件代码：</label></td>
                    <td>
                        <input type="text" id="partCode-Edit" name="partCode-Edit" class="combox" readonly="readonly" readOnly datatype="1,is_null,100" datasource="PART_CODE"
                               src="" />
                 ...
                 <tr>
                    ...
                    <td><input type="text" id="saleCount-Edit" name="saleCount-Edit" readonly="readonly" datatype="1,is_double,100" datasource="CLAIM_COUNT" /></td>
                ...
                <tr>
                    ...
                    <td colspan="5"><textarea id="faultConditons-Edit" name="faultConditons-Edit" readonly="readonly" datasource="FAULT_CONDITONS"  style="width:450px;height:40px;" datatype="1,is_null,500" ></textarea></td>
                </tr>
                <tr>
                    <td><label>备注：</label></td>
                    <td colspan="5"><textarea id="remarks-Edit" name="remarks-Edit" datasource="REMARKS" readonly="readonly" style="width:450px;height:40px;" datatype="1,is_null,500" ></textarea></td>
                </tr>
            </table>
            </fieldset>
            </div>
