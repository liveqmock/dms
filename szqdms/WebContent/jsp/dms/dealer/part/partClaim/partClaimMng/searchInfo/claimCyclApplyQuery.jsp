...
<script type="text/javascript">
     ...
     function searchClaimCyclApply() {
         var searchclaimCyclApply = "<%=request.getContextPath()%>/part/partClaimMng/claimCycl/searchInfo/ClaimCyclApplyQueryMngAction/searchClaimCyclApply.ajax";
         var $f = $("#fm-index");
         var sCondition = {};
    ...
    function doUpdate(rowobj){
        ...
        var options = {max:true,mask:true,mixable:true,minable:true,resizable:true,drawable:true};
        $.pdialog.open(webApps+"/jsp/dms/dealer/part/partClaim/partClaimMng/searchInfo/claimCyclApplyEdit.jsp?action=2", "claimCyclApplyEdit", "配件三包申请编辑", options);
    }
...
<div id="layout" style="width:100%;">
    ...
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：配件索赔相关&gt;配件三包查询</h4>
    <div class="page">
