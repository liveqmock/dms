...
<div id="layout" style="width:100%;">
    <h4 class="contentTitle" align="left"><img src="<%=request.getContextPath()%>/images/default/nav.gif" />&nbsp;当前位置：渠道信息查询  &gt; 财务相关&gt;配件价差应补查询</h4>
    <div class="page">
    <div class="pageHeader">
        ...
        <form id="fm-condition" method="post">
        	<input type="hidden" id="orgId" name="orgId" datasource="ORG_ID" datatype="1,is_null,100" operation="=" value=""/>
            ...
            <table style="display:none;width:100%;" id="tab-grid-index" name="tablist" ref="page_grid" refQuery="tab-condition">
                <thead>
                    <tr>
                        ...
                        <th fieldname="ORG_CODE" style="display:none">渠道代码</th>
                        <th fieldname="ORG_NAME" style="display:none">渠道名称</th>
