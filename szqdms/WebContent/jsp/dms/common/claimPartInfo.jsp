	...
	<div class="pageContent" style="" >
		...
		<div id="divPartDetail" style="">
			<table style="width:100%;" id="divPartDetailList" name="divPartDetailList" ref="divPartDetail" >
				<thead>
					<tr>
						<!-- <th type="single" name="XH" style="display:" colwidth="20"></th> -->
						...
						<th fieldname="NEW_PART_CODE" >新件代码</th>
						<th fieldname="NEW_PART_NAME" >新件名称</th>
						<th fieldname="NEW_PART_COUNT" >新件数量</th>
						<th fieldname="NEW_SUPPLIER_CODE" >新件供应商代码</th>
						<th fieldname="NEW_SUPPLIER_NAME" >新件供应商名称</th>
						<th fieldname="NEW_PART_STREAM" >新件零件流水号</th>
						<th fieldname="REPAY_UPRICE" align="right" refer="amountFormat">追偿单价</th>
						<th fieldname="CLAIM_UPRICE" align="right" refer="amountFormat">索赔单价</th>
...
$(function()
{
	...
	var searchFaultPartUrl=diaOperateAction+"/searchFaultPart.ajax?claimDtlId="+claimDtlId;
