...
var claimId='<%=claimId%>';
var $fileTrue=true,patternTrue=true,$checkHisTrue=true,$claimCost=true;
var dia_dialog = parent.$("body").data("claimDetail");
var diaOperateAction = "<%=request.getContextPath()%>/service/common/ClaimDetailInfoAction";
var costUrl = "<%=request.getContextPath()%>/service/claimmng/ClaimCheckAction/claimCostsSearch.ajax";
$(function() 
{
	$("#dia-claimId").val(claimId);
	//查询索赔单信息，回显
	var searchClaimUrl = diaOperateAction + "/searchClaimInfo.ajax?claimId="+claimId;
	...
	$("button[name='btn-next']").bind("click", function(event) 
	{
		...
		switch (parseInt($tabs.attr("currentIndex"))) 
		{
			...
			case 1:
				if($claimCost){
					var url = costUrl +"?claimId="+$("#dia-claimId").val();
	...
	try{
		...
		if(rows && rows.length > 0)
		{
			...
			if(seType==301102 || seType==301103){
				//查询外出信息，回显
				var searchClaimOutUrl = diaOperateAction + "/searchClaimOutInfo.ajax?claimId="+claimId;
...
function dispatchDetail(){
	var dispatchId=$("#dia-id-dispatchId").val();
}
//附件回调方法
...
<body>
<div id="dia-layout">
<form method="post" id="dia-fm-hidden" class="editForm" style="display:none">
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li><a href="javascript:void(0)"><span>报单费用</span></a></li>
					<li><a href="javascript:void(0)"><span>附件信息</span></a></li>
					<li><a href="javascript:void(0)"><span>审核轨迹</span></a></li>
				</ul>
			</div>
		</div>
						...
						<fieldset>
							<table class="editTable" id="dia-tab-wxxx">
								<tr><td><label>派工单号：</label></td>
								    <td><input type="text" id="dia-workNo" value="" datasource="WORK_NO" readonly="readonly"/></td>
						...
						<legend align="right"><a onclick="onTitleClick('dia-tab-claiminfo')">&nbsp;维修信息&gt;&gt;</a></legend>
							<table class="editTable" id="dia-tab-claiminfo">
								<tr>
									...
									<td><input type="text" id="dia-engine_no" name="dia-engine_no" datasource="ENGINE_NO" readonly="readonly"/></td>
								</tr>
								<tr>
							...
							<table style="width:100%;" id="dia-tab-cliamPattrent" name="tablist" ref="dia-div-cliamPattrent" refQuery="dia-fm-hidden" pageRows="5000" >
								<thead>
									<tr>
										...
										<th fieldname="WORK_TIME" colwidth="60">维修工时</th>
										<th fieldname="WORK_TIME_UPRICE" colwidth="60">工时单价</th>
										<th fieldname="STAR_LEVEL_UPRICE" colwidth="60">星级单价</th>
										<th fieldname="ENCOURAGE_UPRICE" colwidth="60" >激励单价</th>
										<th fieldname="WORK_MULTIPLE" colwidth="50">工时倍数</th>
										<th fieldname="WORK_COSTS" colwidth="60" >工时费</th>
