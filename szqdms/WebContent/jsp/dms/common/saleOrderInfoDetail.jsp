...
$(function(){
	$("#div-partOrderDetaillist1").height(document.documentElement.clientHeight-100);
...
// 	divPartOrderInfo
    ...
    $("#btn-export-index").click(function(){
        var url = encodeURI(mngUrl+"/download.do?ORDER_ID="+ORDER_ID);
    ...
    try {
        ...
        if(rows && rows.length > 0)
        {
            ...
            for(var i=0;i<rows.length;i++){
                ...
                var $td5 = $("<td>"+getAttribValue(objXML, "CHECK_USER","sv", 0)+"</td>");
...
function amountFormat(obj){
    return "<span style='float:right;'>"+amountFormatNew($(obj).html())+"</span>";
}
...
<!-- 	                <input type="hidden" id="data" name="data" datasource="ORDER_ID"></input> -->
<!--                 </form> -->
                    ...
                    <div id="divPartOrderInfo" style="overflow:auto;">
                        ...
                        <table class="editTable" id="diaPartOrderInfoTab">
                            ...
                            <tr style="display:none" id="Tr_diaChassisNo">
                                ...
                                <td><input type="text" id="diaChassisNo"  name="diaChassisNo" datasource="VIN" datatype="1,is_vin,17"/></td>
                                <td><label>所属总成：</label></td>
                                <td><input type="text" id="diaBelongAssembly"  name="diaBelongAssembly" kind="dic" src="" datasource="BELONG_ASSEMBLY"  datatype="1,is_null,30" readOnly value="" />
                                </td>
                                <td><label>计生号：</label></td>
                                <td><input type="text" id="diaPlanProduceNo"  name="diaPlanProduceNo" kind="dic" src="" datasource="PLAN_PRODUCE_NO"  datatype="1,is_null,30" readOnly value="" />
                                </td>
                            </tr>
                            <tr>
                ...
                <div id="divPartOrderDetail" style="overflow:auto;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th fieldname="UNIT_PRICE" refer="amountFormat" align="right" style="text-align: right;">经销商价</th>
