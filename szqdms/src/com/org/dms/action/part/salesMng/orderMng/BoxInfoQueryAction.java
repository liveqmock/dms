...
import com.org.dms.dao.part.storageMng.search.BoxInfoQueryDao;
 ...
 *
 */
public class BoxInfoQueryAction {
	// 日志类
	private Logger logger = com.org.framework.log.log.getLogger("BoxInfoQueryAction");
	// 上下文对象
	private ActionContext atx = ActionContext.getContext();
	// 定义dao对象
	private BoxInfoQueryDao dao = BoxInfoQueryDao.getInstance(atx);
	...
	public void queryListInfo() {
		try {
			...
			atx.setOutData("bs", this.dao.queryList(pageManager, conditions, true));
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e);
			atx.setException(e);
	...
	public void exportExcel() throws Exception{
    	...
    	String orderId = hm.get("O.ORDER_ID");
        ...
        try
        {
    		...
    		hBean.setTitle("备注");
    		header.add(hBean);
    		QuerySet qs1 = dao.queryOrgName(orderId);
    		String orgName = qs1.getString(1, "ONAME");
