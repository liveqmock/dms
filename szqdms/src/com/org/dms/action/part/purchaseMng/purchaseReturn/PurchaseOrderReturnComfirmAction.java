...
import com.org.dms.dao.part.purchaseMng.purchaseReturn.PurchaseOrderReturnComfirmDao;
...
public class PurchaseOrderReturnComfirmAction {
	private Logger logger = com.org.framework.log.log.getLogger(
	        "Logger");
	    //上下文对象
	    private ActionContext atx = ActionContext.getContext();
	    //定义dao对象
	    private PurchaseOrderReturnComfirmDao dao = PurchaseOrderReturnComfirmDao.getInstance(atx);
	
	/**
	 * 
	 * @date()2014年7月26日上午10:56:49
	 ...
	 * @throws Exception
	 */
	public void purchaseOrderReturnConfirm ()throws Exception
	 {
	    RequestWrapper request = atx.getRequest();
       User user = (User) atx.getSession().get(Globals.USER_KEY);
