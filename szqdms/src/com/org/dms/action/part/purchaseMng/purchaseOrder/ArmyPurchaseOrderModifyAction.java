...
import com.org.dms.dao.part.purchaseMng.purchaseOrder.ArmyPurchaseOrderModifyDao;
...
public class ArmyPurchaseOrderModifyAction {
	private Logger logger = com.org.framework.log.log.getLogger(
	        "Logger");
	private ActionContext atx = ActionContext.getContext();
	private ArmyPurchaseOrderModifyDao dao = new ArmyPurchaseOrderModifyDao();
	...
	public void orderPartSearch() throws Exception
    {
	 ...
	 public void updateOrderSplitPart() throws Exception {
	        ...
	        try {
	            ...
	            for (int i = 1; i < PART_ID.length; i++) {
	            	...
	            	if(REMARK[i]!=null&&!"".equals(REMARK[i])){
