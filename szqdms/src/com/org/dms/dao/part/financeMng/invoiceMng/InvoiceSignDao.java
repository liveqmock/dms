 ...
 * @date : 2014-07-14
 */
public class InvoiceSignDao extends BaseDAO {
    //定义instance
    public static final InvoiceSignDao getInstance(ActionContext atx) {
        InvoiceSignDao dao = new InvoiceSignDao();
    ...
    public BaseResultSet searchSaleOrder(PageManager page, User user, String conditions) throws Exception {
        ...
        wheres += " AND B.EXPRESS_STATUS = " + DicConstant.FPYJZT_02 + "\n";
        wheres += " AND A.ORDER_ID = B.ORDER_ID\n";
        wheres += " AND A.ORG_ID =" + user.getOrgId() + "\n";
