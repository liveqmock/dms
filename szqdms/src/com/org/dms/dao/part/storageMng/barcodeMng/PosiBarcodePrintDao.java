 ...
 * @date : 2014-08-01
 */
public class PosiBarcodePrintDao extends BaseDAO {
    //定义instance
    public static final PosiBarcodePrintDao getInstance(ActionContext atx) {
        PosiBarcodePrintDao dao = new PosiBarcodePrintDao();
     ...
     * @throws Exception
     */
    public BaseResultSet searchPosition(PageManager page, User user, String conditions) throws Exception {
     ...
     * @throws Exception
     */
    public QuerySet queryPosition(String POSITION_ID) throws Exception {
        StringBuilder sql= new StringBuilder();
        sql.append("SELECT A.POSITION_ID,\n" );
        sql.append("       A.POSITION_CODE,\n" );
        sql.append("       A.POSITION_NAME\n" );
