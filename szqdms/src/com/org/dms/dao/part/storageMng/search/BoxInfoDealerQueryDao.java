 ...
 *
 */
public class BoxInfoDealerQueryDao extends BaseDAO {
	
	public static final BoxInfoDealerQueryDao getInstance(ActionContext ac){
		BoxInfoDealerQueryDao dao = new BoxInfoDealerQueryDao();
    ...
    public BaseResultSet queryList(PageManager pageManager, String conditions, User user, boolean isSub) throws Exception {
		...
		conditions += " AND O.ORG_ID = '" + user.getOrgId() + "'";
