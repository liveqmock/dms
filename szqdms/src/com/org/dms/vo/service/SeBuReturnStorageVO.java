...
public class SeBuReturnStorageVO extends BaseVO{
    public SeBuReturnStorageVO(){
    	//�����ֶ���Ϣ
    	...
    	this.addField("SUM_AMOUNT",BaseVO.OP_STRING);
    	this.addField("ORG_ID",BaseVO.OP_STRING);
    	this.addField("OEM_COMPANY_ID",BaseVO.OP_STRING);
    	this.addField("CREATE_USER",BaseVO.OP_STRING);
    	this.addField("PART_ID",BaseVO.OP_STRING);
    	this.addField("STORAGE_ID",BaseVO.OP_STRING|BaseVO.TP_PK);
    	this.addField("SURPLUS_AMOUNT",BaseVO.OP_STRING);
    	this.addField("UPDATE_USER",BaseVO.OP_STRING);
		this.bindFieldToSequence("STORAGE_ID","COMMON");
    	this.setVOTableName("SE_BU_RETURN_STORAGE");
}
	...
	public void setSumAmount(String SumAmount){
		this.setInternal("SUM_AMOUNT" ,SumAmount );
	}


	public String getSumAmount(){
		return (String)this.getInternal("SUM_AMOUNT");
	}
	...
	public void setSurplusAmount(String SurplusAmount){
		this.setInternal("SURPLUS_AMOUNT" ,SurplusAmount );
	}


	public String getSurplusAmount(){
		return (String)this.getInternal("SURPLUS_AMOUNT");
	}
