...
public class SeBaAutoCheckVO extends BaseVO{
    public SeBaAutoCheckVO(){
    	//�����ֶ���Ϣ
    	this.addField("SECRET_LEVEL",BaseVO.OP_STRING);
    	this.addField("RULE_ID",BaseVO.OP_STRING|BaseVO.TP_PK);
    	this.addField("RULE_STATUS",BaseVO.OP_STRING);
    	this.addField("RULE_TYPE",BaseVO.OP_STRING);
    	...
    	this.setVOTableName("SE_BA_AUTO_CHECK");
}
	...
	public void setRuleType(String RuleType){
		this.setInternal("RULE_TYPE" ,RuleType );
	}


	public String getRuleType(){
		return (String)this.getInternal("RULE_TYPE");
	}
