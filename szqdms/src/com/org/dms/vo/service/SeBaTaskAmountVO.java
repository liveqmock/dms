...
public class SeBaTaskAmountVO extends BaseVO{
    public SeBaTaskAmountVO(){
    	//�����ֶ���Ϣ
    	this.addField("SECRET_LEVEL",BaseVO.OP_STRING);
    	this.addField("AMOUNT_ID",BaseVO.OP_STRING|BaseVO.TP_PK);
		...
		this.bindFieldToSequence("AMOUNT_ID","COMMON");
    	this.setVOTableName("SE_BA_TASK_AMOUNT");
}
