...
public class SeBuMillionGuaranteeExtVO extends BaseVO{
    public SeBuMillionGuaranteeExtVO(){
    	//�����ֶ���Ϣ
    	...
    	this.addField("VEHICLENAME",BaseVO.OP_STRING);
    	...
    	this.addField("DRIVENAME",BaseVO.OP_STRING);
    	this.addField("ENGINE_TYPE",BaseVO.OP_STRING);
    	this.addField("USERNAME",BaseVO.OP_STRING);
}
	...
	public String getDriveForm(){
	 ...
	 public String getDriveName(){
    	return (String)this.getInternal("DRIVENAME");
    }
    public void setDriveName(String DriveName){
    	this.setInternal("DRIVENAME" ,DriveName );
    }
	...
	public void setVehicleName(String VehicleName){
		this.setInternal("VEHICLENAME" ,VehicleName );
	}
	public String getVehicleName(){
		return (String)this.getInternal("VEHICLENAME");
	}
