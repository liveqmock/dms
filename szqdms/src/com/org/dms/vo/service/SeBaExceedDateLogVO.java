...
public class SeBaExceedDateLogVO extends BaseVO{
    public SeBaExceedDateLogVO(){
    	//�����ֶ���Ϣ
	...
	public void setModifyType(String ModifyType){
		this.setInternal("MODIFY_TYPE" ,ModifyType );
	}


	public String getModifyType(){
		return (String)this.getInternal("MODIFY_TYPE");
	}
	...
	public void setExceedDays(String ExceedDays){
		this.setInternal("EXCEED_DAYS" ,ExceedDays );
	}


	public String getExceedDays(){
		return (String)this.getInternal("EXCEED_DAYS");
	}
