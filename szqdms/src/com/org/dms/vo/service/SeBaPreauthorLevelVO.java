...
public class SeBaPreauthorLevelVO extends BaseVO{
    public SeBaPreauthorLevelVO(){
    	//�����ֶ���Ϣ
    	...
    	this.addField("LEVEL_ID",BaseVO.OP_STRING|BaseVO.TP_PK);
		...
		this.bindFieldToSequence("LEVEL_ID","COMMON");
    	this.setVOTableName("SE_BA_PREAUTHOR_LEVEL");
}
