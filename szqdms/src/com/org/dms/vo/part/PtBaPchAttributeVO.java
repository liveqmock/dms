...
public class PtBaPchAttributeVO extends BaseVO{
    public PtBaPchAttributeVO(){
    	//配件采购属性VO
    	...
    	this.addField("PCHATTRIBUTE_ID",BaseVO.OP_STRING|BaseVO.TP_PK);
    	this.addField("PART_ID",BaseVO.OP_STRING);
    	this.addField("UPDATE_USER",BaseVO.OP_STRING);
		this.bindFieldToSequence("PCHATTRIBUTE_ID","COMMON");
		
		//设置字典类型定义
		this.bindFieldToDic("STATUS","YXBS");//有效标识   
    	this.setVOTableName("PT_BA_PCH_ATTRIBUTE");
}
	...
	public void setPchattributeId(String PchattributeId){
		this.setInternal("PCHATTRIBUTE_ID" ,PchattributeId );
	}


	public String getPchattributeId(){
		return (String)this.getInternal("PCHATTRIBUTE_ID");
	}
