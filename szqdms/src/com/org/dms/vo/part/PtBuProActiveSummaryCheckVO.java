...
public class PtBuProActiveSummaryCheckVO extends BaseVO{
    public PtBuProActiveSummaryCheckVO(){
    	//活动方案总结审核VO
    	...
    	this.addField("SUMMARY_ID",BaseVO.OP_STRING);
    	this.addField("UPDATE_TIME",BaseVO.OP_DATE);
		this.setFieldDateFormat("UPDATE_TIME", "yyyy-MM-dd");
    	this.addField("UPDATE_USER",BaseVO.OP_STRING);
    	this.addField("ORG_ID",BaseVO.OP_STRING);
		this.bindFieldToSequence("CHECK_ID","COMMON");
    	this.setVOTableName("PT_BU_PRO_ACTIVE_SUMMAR_CHECK");
}
