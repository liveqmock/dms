...
public class PtBuStockOutVO_Ext extends BaseVO{
    public PtBuStockOutVO_Ext(){
        ...
        this.bindFieldToDic("OUT_TYPE", DicConstant.CKLX);
        this.addField("ORG_NAME",BaseVO.OP_STRING);
        this.addField("CHECK_USER_SV",BaseVO.OP_STRING);
        this.addField("ORDER_USER_SV",BaseVO.OP_STRING);
        this.addField("SUPPLIER_NAME",BaseVO.OP_STRING);
        this.addField("DES_WAREHOUSE_ID",BaseVO.OP_STRING);
        this.addField("DES_WAREHOUSE_CODE",BaseVO.OP_STRING);
        this.addField("DES_WAREHOUSE_NAME",BaseVO.OP_STRING);
        this.addField("DES_WAREHOUSE_TYPE",BaseVO.OP_STRING);
        this.bindFieldToDic("OTHER_OUT_TYPE", DicConstant.QTCKCKLX);
}

    public void setDesWarehouseType(String DesWarehouseType){
        this.setInternal("DES_WAREHOUSE_TYPE" ,DesWarehouseType );
    }


    public String getDesWarehouseType(){
        return (String)this.getInternal("DES_WAREHOUSE_TYPE");
    }
