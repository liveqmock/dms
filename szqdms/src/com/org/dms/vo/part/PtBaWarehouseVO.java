...
public class PtBaWarehouseVO extends BaseVO{
    public PtBaWarehouseVO(){
    	//设置字段信息
    	this.bindFieldToDic("WAREHOUSE_STATUS", DicConstant.YXBS);
    	...
    	this.setVOTableName("PT_BA_WAREHOUSE");
}
