...
public class PtBaWarehousePositionVO extends BaseVO{
    public PtBaWarehousePositionVO(){
    	//设置字段信息
    	...
    	this.addField("POSITION_STATUS",BaseVO.OP_STRING);
    	this.addField("UPDATE_USER",BaseVO.OP_STRING);
		this.bindFieldToSequence("POSITION_ID","COMMON");
    	this.setVOTableName("PT_BA_WAREHOUSE_POSITION");
}
	...
	public void setPositionStatus(String PositionStatus){
		this.setInternal("POSITION_STATUS" ,PositionStatus );
	}


	public String getPositionStatus(){
		return (String)this.getInternal("POSITION_STATUS");
	}
